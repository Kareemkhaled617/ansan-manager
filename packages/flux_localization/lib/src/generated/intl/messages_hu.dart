...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Sikeresen licitált a(z) \'${name}\' termékre.";

  static String m5(state) => "A Bluetooth adapter ${state}";

  static String m6(amount) => "Vásároljon most ennyiért: ${amount}";

  static String m7(author) => "Szerző: ${author}";

  static String m8(fieldName) => "A(z) ${fieldName} nem lehet üres.";

  static String m9(fieldName) =>
      "A(z) ${fieldName} nem lehet rövidebb 3 karakternél.";

  static String m10(currency) => "Pénznem módosítva erre: ${currency}";

  static String m11(number) => "Még ${number} karakter";

  static String m12(priceRate, pointRate) => "${priceRate} = ${pointRate} pont";

  static String m13(count) => "${count} tétel";

  static String m14(count) => "${count} tétel";

  static String m15(count) => "${count} termék";

  static String m16(count) => "${count} termék";

  static String m17(country) => "${country} nem támogatott";

  static String m18(currency) => "A(z) ${currency} nem támogatott";

  static String m19(day) => "${day} napja";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Hátralévő idő: ${timeLeft}";

  static String m22(captcha) => "A megerősítéshez írja be ezt: ${captcha}";

  static String m23(message) => "Hiba: ${message}";

  static String m24(message) => "Hiba: ${message}";

  static String m25(time) => "Lejárat ideje: ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "${hour} órája";
  ...
  static String m31(size) => "Maximális fájlméret: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "A minimális rendelési összeg ${storeName} esetén ${minOrderAmount}. Kérjük, adjon hozzá még néhány terméket ebből az áruházból!";

  static String m35(amount) =>
      "Ez a kupon legalább ${amount} értékű vásárlás esetén használható fel.";

  static String m36(value) => "Minimális tranzakció: ${value}";

  static String m37(minute) => "${minute} perce";

  static String m38(month) => "${month} hónappal ezelőtt";

  static String m39(store) => "További termékek innen: ${store}";

  static String m40(number) => "${number} darabos csomagban vásárolható";

  static String m41(itemCount) => "${itemCount} termék";

  static String m42(price) => "Opciók összesen: ${price}";

  static String m43(amount) => "Fizetés: ${amount}";

  static String m44(name) => "A(z) ${name} sikeresen a kosárba került";

  static String m45(total) => "Mennyiség: ${total}";

  static String m46(name) => "Pénz érkezett tőle: ${name}";

  static String m47(count) =>
      "Eltávolít ${count} terméket a kívánságlistájáról?";

  static String m48(percent) => "${percent}% kedvezmény";

  static String m49(keyword) => "Keresési eredmények erre: \"${keyword}\"";

  static String m50(keyword, count) => "${keyword} (${count} találat)";

  static String m51(keyword, count) => "${keyword} (${count} találat)";

  static String m52(second) => "${second} másodperce";

  static String m53(totalCartQuantity) => "Kosár, ${totalCartQuantity} termék";

  static String m54(numberOfUnitsSold) => "Eladva: ${numberOfUnitsSold}";

  static String m55(fieldName) => "A(z) ${fieldName} mező kötelező";

  static String m56(total) => "${total} termék";

  static String m57(name) => "Pénz küldése neki: ${name}";

  static String m58(amount) => "Használjon ${amount} pontot";
  ...
  static String m60(time) => "Érvényes eddig: ${time}";

  static String m61(date) => "Érvényes: ${date}";

  static String m62(number) => "Verzió: ${number}";

  static String m63(balance) => "Egyenleg: ${balance}";

  static String m64(message) => "Figyelmeztetés: ${message}";
  ...
  static String m66(length) => "Találtunk ${length} terméket";

  static String m67(week) => "${week}. hét";

  static String m68(name) => "Üdvözöljük, ${name}!";

  static String m69(year) => "${year} évvel ezelőtt";

  static String m70(count) => "${count} terméket választott ki";

  static String m71(total) => "A(z) ${total} számú rendelést kapta";

  static String m72(type) => "Lejárt ${type}";

  static String m73(point) => "Jelenleg ${point} pontja van";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addOrUsePointsSuccessMsg": MessageLookupByLibrary.simpleMessage(
      "Gratulálunk! A pontokat sikeresen hozzáadta vagy beváltotta.",
    ),
    "addPoint": MessageLookupByLibrary.simpleMessage("Pont hozzáadása"),
    "addPoints": MessageLookupByLibrary.simpleMessage("Pontok hozzáadása"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Előleg összege"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Fizetési előleg"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Az összeg meghaladja a rendelkezésre álló pontokat",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Sajnáljuk, az időpontok ezen a napon nem kezdhetők meg.",
    ),
    ...
    "areYouSureCancelOrder": MessageLookupByLibrary.simpleMessage(
      "Biztosan le szeretné mondani ezt a rendelést?",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Biztosan visszatéríti ezt a rendelést?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Árverés"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Aukciós dátumok"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Az aukció véget ért"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Az aukció véget ér"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage(
      "Aukciós előzmények",
    ),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Az aukció kezdete"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "Az aukció kezdete:",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Aukció típusa"),
    ...
    "availabilityProduct": MessageLookupByLibrary.simpleMessage("Elérhetőség:"),
    "availableForTiers": MessageLookupByLibrary.simpleMessage(
      "Elérhető a következő szintekhez",
    ),
    "availablePoints": m3,
    ...
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("Legyen tulajdonos"),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Váltson másik szerepkörre",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Előnyök"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengáli"),
    "bid": MessageLookupByLibrary.simpleMessage("Licit"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Licitlépcső"),
    ...
    "bronzePriority": MessageLookupByLibrary.simpleMessage("Bronz prioritás"),
    "burmese": MessageLookupByLibrary.simpleMessage("Burmai"),
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("Azonnali vételár"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "A lemondási kérelem sikertelen volt",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "A lemondási kérelmét sikeresen elküldtük!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "A kosár nem elérhető. Kérjük, adjon hozzá néhány terméket.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "A kosara még feldolgozás alatt áll. Kérjük, várjon egy pillanatot.",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Igénylés"),
    "claimed": MessageLookupByLibrary.simpleMessage("Igényelt"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Apróhirdetések"),
    ...
    "couponsManagement": MessageLookupByLibrary.simpleMessage("Kuponkezelés"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Jelenlegi ajánlat"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ez a felhasználói szerepkör lehetővé teszi a foglalásokat, privát üzenetek küldését más felhasználóknak és hirdetések értékelését.",
    ),
    ...
    "emptyShippingMsg": MessageLookupByLibrary.simpleMessage(
      "Nincsenek elérhető szállítási lehetőségek. Kérjük, ellenőrizze, hogy helyesen adta-e meg a címét, vagy lépjen kapcsolatba velünk, ha segítségre van szüksége.",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Ossza meg további gondolatait a termékről, hogy segítse a többi vásárlót.",
    ),
    ...
    "event": MessageLookupByLibrary.simpleMessage("Esemény"),
    ...
    "gold": MessageLookupByLibrary.simpleMessage("Arany"),
    "goldPriority": MessageLookupByLibrary.simpleMessage("Arany prioritás"),
    "good": MessageLookupByLibrary.simpleMessage("Jó"),
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "A hitelesítés sikertelen. Kérjük, jelentkezzen be újra.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Hiba történt a művelet végrehajtása közben. Kérjük, ellenőrizze újra.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Érvénytelen adatot adott meg. Kérjük, ellenőrizze a bevitelt.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Kérjük, adjon meg egy teljes címet utcanévvel és házszámmal együtt",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "Kérjük, adjon meg egy érvényes városnevet",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Kérjük, adjon meg egy érvényes városnevet speciális karakterek nélkül",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("Termék állapota"),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("Új"),
    ...
    "listTile": MessageLookupByLibrary.simpleMessage("Listaelem"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("Betöltés sikertelen!"),
    ...
    "logoutFailed": MessageLookupByLibrary.simpleMessage(
      "Kijelentkezés sikertelen",
    ),
    "logoutSuccess": MessageLookupByLibrary.simpleMessage(
      "Sikeres kijelentkezés",
    ),
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("Hűségutalvány"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Kuponjaim"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Saját QR-kódom"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Mutassa meg ezt a kódot a személyzetnek",
    ),
    ...
    "networkServerError": MessageLookupByLibrary.simpleMessage(
      "Szerverhiba. Kérjük, próbálja meg később.",
    ),
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Kapcsolati időtúllépés. Kérjük, próbálja újra.",
    ),
    ...
    "noCameraPermissionIsGranted": MessageLookupByLibrary.simpleMessage(
      "Nincs kameraengedély megadva. Kérjük, engedélyezze az eszköz beállításaiban.",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Nincs kézbesítésre váró rendelés",
    ),
    ...
    "owner": MessageLookupByLibrary.simpleMessage("Tulajdonos"),
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ez a felhasználói szerepkör lehetővé teszi hirdetések és foglalási szolgáltatások hozzáadását és kezelését. A tulajdonosok nem értékelhetnek más hirdetéseket.",
    ),
    ...
    "pickVoucherToApply": MessageLookupByLibrary.simpleMessage(
      "Válasszon egy utalványt a felhasználáshoz.",
    ),
    ...
    "pleaseSelectRequiredOptions": MessageLookupByLibrary.simpleMessage(
      "Kérjük, válassza ki a szükséges opciókat!",
    ),
    "pleaseSignInBeforeUploading": MessageLookupByLibrary.simpleMessage(
      "Kérjük, jelentkezzen be fiókjába a fájlok feltöltése előtt.",
    ),
    "point": MessageLookupByLibrary.simpleMessage("Pont"),
    "pointHistory": MessageLookupByLibrary.simpleMessage("Ponttörténet"),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Húzza fel a továbbiak betöltéséhez",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Rang részletei"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Jelenleg ennek a rangnak a tagja vagy",
    ),
    ...
    "received": MessageLookupByLibrary.simpleMessage("Megkapva"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Beváltás"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Pontok beváltása"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage("Jutalmak beváltása"),
    "redeemed": MessageLookupByLibrary.simpleMessage("Beváltva"),
    "refresh": MessageLookupByLibrary.simpleMessage("Frissítés"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Frissítés befejezve",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Frissítés..."),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Bérlés"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Minimálár"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Fordított"),
    ...
    "reviewPendingApproval": MessageLookupByLibrary.simpleMessage(
      "Értékelését elküldtük, jóváhagyásra vár!",
    ),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Jutalmak"),
    ...
    "scanPoints": MessageLookupByLibrary.simpleMessage("Pontok szkennelése"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "A QR-olvasó csak termékkeresésre használható",
    ),
    ...
    "selectDate": MessageLookupByLibrary.simpleMessage("Válasszon dátumot"),
    ...
    "selectFileCancelled": MessageLookupByLibrary.simpleMessage(
      "A fájl kiválasztása megszakítva!",
    ),
    ...
    "service": MessageLookupByLibrary.simpleMessage("Szolgáltatás"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Jelentkezzen be Shopify fiókjával a rendelései, címei és egyéb adatai eléréséhez.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Bejelentkezés Shopify ügyfélfiókkal",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("Regisztráció"),
    "silver": MessageLookupByLibrary.simpleMessage("Ezüst"),
    "silverPriority": MessageLookupByLibrary.simpleMessage("Ezüst prioritás"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Költsön legalább"),
    "startExploring": MessageLookupByLibrary.simpleMessage("Fedezze fel"),
    "startPrice": MessageLookupByLibrary.simpleMessage("Kezdőár"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Irány a webáruház"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Kezdő licit"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Rendszerhiba. Kérjük, vegye fel a kapcsolatot az ügyfélszolgálattal.",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Hátralévő idő"),
    ...
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Keressen még"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "pontot a következő rang eléréséhez.",
    ),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Használt"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Nyertes licit"),
    ...
    "writeTitle": MessageLookupByLibrary.simpleMessage("Írja meg a címet"),
    "writeYourNote": MessageLookupByLibrary.simpleMessage("Írjon megjegyzést"),
    "yearsAgo": m69,
    "yes": MessageLookupByLibrary.simpleMessage("Igen"),
    "youAreOur": MessageLookupByLibrary.simpleMessage("Ön a mi"),
    "youAreSelecting": m70,
    ...
    "youHave": MessageLookupByLibrary.simpleMessage("Önnél van"),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(amount) => "أضف ${amount} نقطة";

  static String m2(attribute) => "أي ${attribute}";

  static String m3(point) => "نقاطك المتاحة: ${point}";

  static String m4(name) => "تم وضع عرض سعر بنجاح لـ \'${name}\'";

  static String m5(state) => "محول البلوتوث ${state}";

  static String m6(amount) => "اشتري الآن مقابل ${amount}";

  static String m7(author) => "الكاتب: ${author}";

  static String m8(fieldName) => "لا يمكن أن يكون ${fieldName} فارغاً";

  static String m9(fieldName) => "يجب ألا يقل طول ${fieldName} عن 3 أحرف";

  static String m10(currency) => "تم تغيير العملة إلى ${currency}";

  static String m11(number) => "متبقي ${number} حرف";

  static String m12(priceRate, pointRate) => "${priceRate} = ${pointRate} نقطة";

  static String m13(count) => "${count} عنصر";

  static String m14(count) => "${count} عنصر";

  static String m15(count) => "${count} منتج";

  static String m16(count) => "${count} منتجات";

  static String m17(country) => "البلد ${country} غير مدعوم";

  static String m18(currency) => "العملة ${currency} غير مدعومة";

  static String m19(day) => "قبل ${day} يوم";

  static String m20(total) => "~${total} كم";

  static String m21(timeLeft) => "ينتهي في ${timeLeft}";

  static String m22(captcha) => "أدخل ${captcha} للتأكيد:";

  static String m23(message) => "خطأ: ${message}";

  static String m24(message) => "خطأ: ${message}";

  static String m25(time) => "تنتهي الصلاحية في ${time}";

  static String m26(total) => "أكثر من ${total} كم";

  static String m27(hour) => "قبل ${hour} ساعة";

  static String m28(currentBalance) => "لديك فقط ${currentBalance} في محفظتك";
  ...
  static String m31(size) => "الحد الأقصى لحجم الملف: ${size} ميجابايت";
  ...
  static String m34(storeName, minOrderAmount) =>
      "الحد الأدنى لطلب ${storeName} هو ${minOrderAmount}. يُرجى إضافة بعض المنتجات الأخرى من هذا المتجر!";

  static String m35(amount) =>
      "تتطلب هذه القسيمة شراء الحد الأدنى بقيمة ${amount}.";

  static String m36(value) => "الحد الأدنى للمعاملة: ${value}";

  static String m37(minute) => "قبل ${minute} دقيقة";

  static String m38(month) => "منذ ${month} شهر";

  static String m39(store) => "المزيد من ${store}";

  static String m40(number) => "يجب الشراء بمجموعات من ${number}";

  static String m41(itemCount) => "${itemCount} عنصر";

  static String m42(price) => "إجمالي الخيارات: ${price}";

  static String m43(amount) => "ادفع ${amount}";

  static String m44(name) => "تمت إضافة ${name} إلى السلة بنجاح";

  static String m45(total) => "الكمية: ${total}";

  static String m46(name) => "استلمت مبلغاً من ${name}";

  static String m47(count) => "هل تريد إزالة ${count} عنصر من قائمة رغباتك؟";

  static String m48(percent) => "خصم ${percent}٪";

  static String m49(keyword) => "نتائج البحث عن: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} عنصر)";

  static String m51(keyword, count) => "${keyword} (${count} عنصر)";

  static String m52(second) => "قبل ${second} ثانية";

  static String m53(totalCartQuantity) =>
      "سلة التسوق، ${totalCartQuantity} عنصر";

  static String m54(numberOfUnitsSold) => "تم البيع: ${numberOfUnitsSold}";

  static String m55(fieldName) => "حقل ${fieldName} مطلوب";

  static String m56(total) => "${total} منتج";

  static String m57(name) => "تحويل مبلغ إلى ${name}";

  static String m58(amount) => "استخدم ${amount} نقطة";
  ...
  static String m60(time) => "صالحة حتى: ${time}";

  static String m61(date) => "صالح حتى ${date}";

  static String m62(number) => "الإصدار ${number}";

  static String m63(balance) => "رصيد المحفظة: ${balance}";

  static String m64(message) => "تحذير: ${message}";

  static String m65(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m66(length) => "تم العثور على ${length} منتج";

  static String m67(week) => "الأسبوع ${week}";

  static String m68(name) => "مرحباً ${name}";

  static String m69(year) => "منذ ${year} سنة";

  static String m70(count) => "أنت تختار ${count} عنصر";

  static String m71(total) => "تم تعيينك للطلب رقم ${total}";

  static String m72(type) => "لقد اجتزت ${type}";

  static String m73(point) => "لديك ${point} نقطة";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "activeFor": m0,
    "activeLongAgo": MessageLookupByLibrary.simpleMessage("نشط منذ فترة طويلة"),
    ...
    "addOrUsePointsSuccessMsg": MessageLookupByLibrary.simpleMessage(
      "مبروك! لقد تم إضافة النقاط أو استردادها بنجاح.",
    ),
    "addPoint": MessageLookupByLibrary.simpleMessage("إضافة نقطة"),
    "addPoints": MessageLookupByLibrary.simpleMessage("أضف نقاطًا"),
    ...
    "advancePayment": MessageLookupByLibrary.simpleMessage("الدفع المسبق"),
    ...
    "allBrands": MessageLookupByLibrary.simpleMessage("جميع العلامات التجارية"),
    "allDeliveryOrders": MessageLookupByLibrary.simpleMessage("جميع الطلبات"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "المبلغ يتجاوز النقاط المتاحة",
    ),
    "anyAttr": m2,
    "appTrackingRequest": MessageLookupByLibrary.simpleMessage(
      "سيتم استخدام هذا المعرف لتقديم إعلانات مخصصة لك.\nسيؤدي \"إلغاء\" إلى الحد من قدرة شبكة الإعلانات على تقديم إعلانات ذات صلة لك، لكنه لن يقلل من عدد الإعلانات التي تتلقاها.\nنظرًا لتقييد الجهاز، يتم تعطيل التتبع ولا يمكن للنظام عرض مربع حوار الطلب. \"افتح الإعدادات\" واسمح للتطبيق بتتبع نشاطك عبر تطبيقات ومواقع الويب الخاصة بشركات أخرى؟",
    ),
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "عذرا، لا يمكن بدء المواعيد في هذا اليوم.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "هل أنت متأكد أنك تريد استرداد هذا الطلب؟",
    ),
    "areYouWantToExit": MessageLookupByLibrary.simpleMessage("هل تريد الخروج؟"),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("المزاد"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("مواعيد المزاد"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("انتهى المزاد"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("ينتهي المزاد"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("تاريخ المزادات"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("يبدأ المزاد"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage("يبدأ المزاد في"),
    "auctionType": MessageLookupByLibrary.simpleMessage("نوع المزاد"),
    ...
    "bannerListType": MessageLookupByLibrary.simpleMessage("نوع قائمة البانر"),
    "bannerType": MessageLookupByLibrary.simpleMessage("نوع البانر"),
    "bannerYoutubeURL": MessageLookupByLibrary.simpleMessage(
      "رابط يوتيوب للبانر",
    ),
    "basicInformation": MessageLookupByLibrary.simpleMessage("معلومات أساسية"),
    "becomeADelivery": MessageLookupByLibrary.simpleMessage("كن أحد المندوبين"),
    "becomeAVendor": MessageLookupByLibrary.simpleMessage(
      "كن بائعاً في سوق البلد",
    ),
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("كن مالكًا"),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage("تغيير الدور"),
    "benefits": MessageLookupByLibrary.simpleMessage("فوائد"),
    "bengali": MessageLookupByLibrary.simpleMessage("البنغالية"),
    "bid": MessageLookupByLibrary.simpleMessage("مُنَاقَصَة"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("زيادة العطاء"),
    ...
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("اشتريه الآن السعر"),
    "buyNow": MessageLookupByLibrary.simpleMessage("اشترِ الآن"),
    "buyNowFor": m6,
    "by": MessageLookupByLibrary.simpleMessage("بواسطة"),
    "byAppointmentOnly": MessageLookupByLibrary.simpleMessage("بالموعد فقط"),
    "byAuthor": m7,
    ...
    "canNotLoadThisLink": MessageLookupByLibrary.simpleMessage(
      "لا يمكن تحميل هذا الرابط",
    ),
    "canNotPlayVideo": MessageLookupByLibrary.simpleMessage(
      "عذراً، لا يمكن تشغيل هذا الفيديو",
    ),
    "canNotSaveOrder": MessageLookupByLibrary.simpleMessage(
      "لا يمكن حفظ الطلب في الموقع",
    ),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "لم يتم تنفيذ طلب الإلغاء بنجاح",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "سلة التسوق غير متوفرة. يُرجى إضافة بعض المنتجات إليها.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "لا تزال سلة التسوق الخاصة بك قيد المعالجة. يُرجى الانتظار قليلاً.",
    ),
    ...
    "chatListScreen": MessageLookupByLibrary.simpleMessage("قائمة المحادثات"),
    "chatViaFacebook": MessageLookupByLibrary.simpleMessage(
      "الدردشة عبر فيسبوك ماسنجر",
    ),
    "chatViaWhatApp": MessageLookupByLibrary.simpleMessage(
      "الدردشة عبر واتساب",
    ),
    "chatWithBot": MessageLookupByLibrary.simpleMessage("الدردشة مع المساعد"),
    "chatWithStoreOwner": MessageLookupByLibrary.simpleMessage(
      "الدردشة مع صاحب المتجر",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("مطالبة"),
    "claimed": MessageLookupByLibrary.simpleMessage("تم المطالبة به"),
    "classifieds": MessageLookupByLibrary.simpleMessage("الإعلانات المبوبة"),
    ...
    "clearCartAndAddNew": MessageLookupByLibrary.simpleMessage(
      "مسح السلة وإضافة منتج جديد",
    ),
    "clearConversation": MessageLookupByLibrary.simpleMessage("مسح المحادثة"),
    ...
    "commentFailed": MessageLookupByLibrary.simpleMessage("فشل التعليق!"),
    "commentFirst": MessageLookupByLibrary.simpleMessage("يرجى كتابة تعليقك"),
    ...
    "continueToPayment": MessageLookupByLibrary.simpleMessage("متابعة للدفع"),
    "continueToReview": MessageLookupByLibrary.simpleMessage("متابعة للمراجعة"),
    "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
      "متابعة لاختيار العنصر",
    ),
    ...
    "couponsManagement": MessageLookupByLibrary.simpleMessage("إدارة القسائم"),
    "create": MessageLookupByLibrary.simpleMessage("يخلق"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("العرض الحالي"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "يتيح هذا الدور للمستخدم إجراء الحجوزات، وإرسال رسائل خاصة للمستخدمين الآخرين، وتقييم الإعلانات.",
    ),
    ...
    "dateWiseClose": MessageLookupByLibrary.simpleMessage("إغلاق حسب التاريخ"),
    "daysAgo": m19,
    ...
    "driverAssigned": MessageLookupByLibrary.simpleMessage("تم تعيين السائق"),
    ...
    "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
      "يبدو أنك لم تضف أي منتجات إلى السلة بعد. ابدأ التسوق الآن.",
    ),
    ...
    "emptyWishlistSubtitle02": MessageLookupByLibrary.simpleMessage(
      "قائمة رغباتك فارغة حالياً. ابدأ بإضافة منتجاتك المفضلة!",
    ),
    "enableForCheckout": MessageLookupByLibrary.simpleMessage("تفعيل للدفع"),
    "enableForLogin": MessageLookupByLibrary.simpleMessage(
      "تفعيل لتسجيل الدخول",
    ),
    "enableForWallet": MessageLookupByLibrary.simpleMessage("تفعيل للمحفظة"),
    ...
    "enterPoint": MessageLookupByLibrary.simpleMessage("أدخل النقطة"),
    ...
    "enterYourReview": MessageLookupByLibrary.simpleMessage("أدخل تقييمك"),
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "شارك المزيد من الأفكار حول المنتج لمساعدة المشترين الآخرين.",
    ),
    ...
    "event": MessageLookupByLibrary.simpleMessage("فعالية"),
    ...
    "getNotification": MessageLookupByLibrary.simpleMessage("تلقي الإشعارات"),
    "getNotified": MessageLookupByLibrary.simpleMessage("احصل على التنبيهات!"),
    "getPasswordLink": MessageLookupByLibrary.simpleMessage(
      "الحصول على رابط كلمة المرور",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("الأولوية الذهبية"),
    "good": MessageLookupByLibrary.simpleMessage("جيد"),
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "فشل المصادقة. يُرجى تسجيل الدخول مرة أخرى.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ أثناء محاولة تنفيذ هذا الإجراء. يُرجى إعادة التحقق.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "البيانات المدخلة غير صالحة. يُرجى التحقق من بياناتك.",
    ),
    "greaterDistance": m26,
    ...
    "historyTransaction": MessageLookupByLibrary.simpleMessage("سجل المعاملات"),
    "home": MessageLookupByLibrary.simpleMessage("الرئيسية"),
    "horizontal": MessageLookupByLibrary.simpleMessage("أفقي"),
    ...
    "informationTable": MessageLookupByLibrary.simpleMessage("جدول المعلومات"),
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "الرجاء إدخال عنوان كامل مع اسم الشارع والرقم",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "الرجاء إدخال اسم مدينة صالح",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "الرجاء إدخال اسم مدينة صالح بدون أحرف خاصة",
    ),
    ...
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "رمز الاستجابة السريعة الذي تم مسحه غير صالح. يرجى التحقق والمحاولة مرة أخرى.",
    ),
    ...
    "isEverythingSet": MessageLookupByLibrary.simpleMessage("هل كل شيء جاهز؟"),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("حالة السلعة"),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("جديد"),
    ...
    "listBannerType": MessageLookupByLibrary.simpleMessage("نوع قائمة البانر"),
    "listBannerVideo": MessageLookupByLibrary.simpleMessage(
      "قائمة فيديو البانر",
    ),
    "listMessages": MessageLookupByLibrary.simpleMessage("قائمة الإشعارات"),
    "listTile": MessageLookupByLibrary.simpleMessage("قائمة البلاط"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("فشل التحميل!"),
    "loading": MessageLookupByLibrary.simpleMessage("جارٍ التحميل"),
    "loadingLink": MessageLookupByLibrary.simpleMessage("جارٍ تحميل الرابط..."),
    ...
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("قسيمة الولاء"),
    "malay": MessageLookupByLibrary.simpleMessage("الملايو"),
    "manCollections": MessageLookupByLibrary.simpleMessage("مجموعات رجالية"),
    ...
    "mustSelectOneItem": MessageLookupByLibrary.simpleMessage(
      "يجب اختيار عنصر واحد",
    ),
    "myCart": MessageLookupByLibrary.simpleMessage("سلة التسوق"),
    "myCoupons": MessageLookupByLibrary.simpleMessage("كوبوناتي"),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "انتهى وقت الاتصال. يُرجى المحاولة مرة أخرى.",
    ),
    "newAppConfig": MessageLookupByLibrary.simpleMessage("محتوى جديد متاح!"),
    ...
    "noProduct": MessageLookupByLibrary.simpleMessage("لا توجد منتجات"),
    ...
    "noStoreNearby": MessageLookupByLibrary.simpleMessage("لا يوجد متجر قريب!"),
    ...
    "noteTransfer": MessageLookupByLibrary.simpleMessage("ملاحظة (اختياري)"),
    "notice": MessageLookupByLibrary.simpleMessage("تنبيه"),
    "notifications": MessageLookupByLibrary.simpleMessage("الإشعارات"),
    "notifyLatestOffer": MessageLookupByLibrary.simpleMessage(
      "أبلغني عن أحدث العروض وتوفر المنتجات",
    ),
    ...
    "oneEachRecipient": MessageLookupByLibrary.simpleMessage("واحد لكل مستلم"),
    ...
    "orderConfirmation": MessageLookupByLibrary.simpleMessage("تأكيد الطلب"),
    ...
    "orderIdWithoutColon": MessageLookupByLibrary.simpleMessage("رقم الطلب"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "يتيح هذا الدور للمستخدم إضافة الإعلانات وخدمات الحجز وإدارتها. لا يمكن للمالكين تقييم الإعلانات الأخرى.",
    ),
    ...
    "paymentMethodIsNotSupported": MessageLookupByLibrary.simpleMessage(
      "طريقة الدفع هذه غير مدعومة",
    ),
    "paymentMethods": MessageLookupByLibrary.simpleMessage("طرق الدفع"),
    "paymentSettings": MessageLookupByLibrary.simpleMessage("إعدادات الدفع"),
    "paymentSuccessful": MessageLookupByLibrary.simpleMessage("تم الدفع بنجاح"),
    "pending": MessageLookupByLibrary.simpleMessage("قيد الانتظار"),
    "pendingReviews": MessageLookupByLibrary.simpleMessage("التقييمات المعلقة"),
    ...
    "platinum": MessageLookupByLibrary.simpleMessage("البلاتين"),
    "platinumPriority": MessageLookupByLibrary.simpleMessage("أولوية البلاتين"),
    ...
    "pleaseFillCode": MessageLookupByLibrary.simpleMessage("يرجى إدخال الرمز"),
    ...
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "تمت إضافة النقاط إلى حساب المستخدم.",
    ),
    ...
    "pointsRedeemedMsg": MessageLookupByLibrary.simpleMessage(
      "تم استرداد النقاط من حساب المستخدم.",
    ),
    ...
    "postManagement": MessageLookupByLibrary.simpleMessage("إدارة المنشورات"),
    "postProduct": MessageLookupByLibrary.simpleMessage("نشر المنتج"),
    "postSuccessfully": MessageLookupByLibrary.simpleMessage(
      "تم إنشاء منشورك بنجاح",
    ),
    ...
    "printerSelection": MessageLookupByLibrary.simpleMessage("اختيار الطابعة"),
    "printing": MessageLookupByLibrary.simpleMessage("جارٍ الطباعة..."),
    "privacyAndTerm": MessageLookupByLibrary.simpleMessage("الخصوصية والشروط"),
    ...
    "promptPayID": MessageLookupByLibrary.simpleMessage("معرف الدفع السريع:"),
    "promptPayName": MessageLookupByLibrary.simpleMessage("اسم الدفع السريع:"),
    "promptPayType": MessageLookupByLibrary.simpleMessage("نوع الدفع السريع:"),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage("اسحب لأعلى للتحميل"),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("تفاصيل الرتبة"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "أنت حاليا عضو في هذه الرتبة",
    ),
    ...
    "redeemRewards": MessageLookupByLibrary.simpleMessage("استرداد المكافآت"),
    "redeemed": MessageLookupByLibrary.simpleMessage("مُخلّص"),
    "refresh": MessageLookupByLibrary.simpleMessage("تحديث"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage("اكتمل التحديث"),
    ...
    "registerAsVendor": MessageLookupByLibrary.simpleMessage("التسجيل كبائع"),
    ...
    "releaseToLoadMore": MessageLookupByLibrary.simpleMessage("حرر للتحميل"),
    "releaseToRefresh": MessageLookupByLibrary.simpleMessage("حرر للتحديث"),
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "المبلغ المتبقي للدفع عند التسليم",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("تأجير"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("سعر الاحتياطي"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("يعكس"),
    ...
    "selectDate": MessageLookupByLibrary.simpleMessage("حدد التاريخ"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "استخدم حساب Shopify الخاص بك لتسجيل الدخول والوصول إلى طلباتك وعناوينك والمزيد.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "تسجيل الدخول باستخدام حساب عميل Shopify",
    ),
    "shoppingCartItems": m53,
    "shortDescription": MessageLookupByLibrary.simpleMessage("وصف قصير"),
    "showAllMyOrdered": MessageLookupByLibrary.simpleMessage("عرض جميع طلباتي"),
    ...
    "silverPriority": MessageLookupByLibrary.simpleMessage("الأولوية الفضية"),
    "simple": MessageLookupByLibrary.simpleMessage("بسيط"),
    "simpleList": MessageLookupByLibrary.simpleMessage("قائمة بسيطة"),
    ...
    "speechNotAvailable": MessageLookupByLibrary.simpleMessage(
      "خاصية النطق غير متوفرة",
    ),
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("أنفق على الأقل"),
    "startExploring": MessageLookupByLibrary.simpleMessage("ابدأ الاستكشاف"),
    "startPrice": MessageLookupByLibrary.simpleMessage("سعر البداية"),
    "startShopping": MessageLookupByLibrary.simpleMessage("تسوق الآن"),
    "startingBid": MessageLookupByLibrary.simpleMessage("العرض الافتتاحي"),
    "state": MessageLookupByLibrary.simpleMessage("الولاية"),
    "stateIsRequired": MessageLookupByLibrary.simpleMessage(
      "حقل المحافظة/الولاية مطلوب",
    ),
    "stateProvince": MessageLookupByLibrary.simpleMessage("المحافظة/الولاية"),
    ...
    "thisIsVendorRole": MessageLookupByLibrary.simpleMessage("هذا دور البائع"),
    "thisItemIsSold": MessageLookupByLibrary.simpleMessage("تم بيع هذا العنصر"),
    "thisPlatformNotSupportWebview": MessageLookupByLibrary.simpleMessage(
      "هذا النظام لا يدعم عرض الويب",
    ),
    "thisProductNotSupport": MessageLookupByLibrary.simpleMessage(
      "هذا المنتج غير مدعوم",
    ),
    ...
    "titleAToZ": MessageLookupByLibrary.simpleMessage(
      "العنوان: من الألف إلى الياء",
    ),
    "titleFirst": MessageLookupByLibrary.simpleMessage("الرجاء إضافة العنوان"),
    "titleZToA": MessageLookupByLibrary.simpleMessage(
      "العنوان: من الياء إلى الألف",
    ),
    ...
    "topUpProductNotFound": MessageLookupByLibrary.simpleMessage(
      "منتج الشحن غير موجود",
    ),
    "total": MessageLookupByLibrary.simpleMessage("الإجمالي"),
    "totalAmount": MessageLookupByLibrary.simpleMessage("المبلغ الإجمالي"),
    "totalCartValue": MessageLookupByLibrary.simpleMessage(
      "يجب أن لا تقل قيمة الطلب عن",
    ),
    "totalPoints": MessageLookupByLibrary.simpleMessage("مجموع النقاط"),
    ...
    "transactionFailded": MessageLookupByLibrary.simpleMessage("فشلت العملية"),
    "transactionFailed": MessageLookupByLibrary.simpleMessage("فشلت العملية"),
    "transactionFee": MessageLookupByLibrary.simpleMessage("رسوم المعاملة"),
    "transactionResult": MessageLookupByLibrary.simpleMessage("نتيجة المعاملة"),
    "transfer": MessageLookupByLibrary.simpleMessage("تحويل"),
    "transferConfirm": MessageLookupByLibrary.simpleMessage("تأكيد التحويل"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "لقد حدث خطأ ما، ظهر خطأ غير معروف",
    ),
    "unnamedLocation": MessageLookupByLibrary.simpleMessage("موقع غير مسمى"),
    "unpaid": MessageLookupByLibrary.simpleMessage("غير مدفوع"),
    "upRankNote1": MessageLookupByLibrary.simpleMessage("اكسب المزيد"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "نقاط للصعود إلى هذه المرتبة.",
    ),
    ...
    "usePoint": MessageLookupByLibrary.simpleMessage("استخدم النقطة"),
    "useThisImage": MessageLookupByLibrary.simpleMessage("استخدم هذه الصورة"),
    ...
    "vacationMessage": MessageLookupByLibrary.simpleMessage("رسالة الإجازة"),
    ...
    "waitForLoad": MessageLookupByLibrary.simpleMessage(
      "في انتظار تحميل الصورة",
    ),
    "waitForPost": MessageLookupByLibrary.simpleMessage("في انتظار نشر المنتج"),
    ...
    "weWillSendYouNotification": MessageLookupByLibrary.simpleMessage(
      "سنرسل إليك إشعارات عند توفر منتجات جديدة أو عروض. يمكنك تغيير هذا الإعداد في أي وقت من الإعدادات.",
    ),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("العرض الفائز"),
    ...
    "womanCollections": MessageLookupByLibrary.simpleMessage("مجموعات نسائية"),
    "writeComment": MessageLookupByLibrary.simpleMessage("اكتب تعليقك"),
    "writeTitle": MessageLookupByLibrary.simpleMessage("اكتب عنوانك"),
    "writeYourNote": MessageLookupByLibrary.simpleMessage("اكتب ملاحظاتك"),
    "yearsAgo": m69,
    "yes": MessageLookupByLibrary.simpleMessage("نعم"),
    "youAreOur": MessageLookupByLibrary.simpleMessage("أنت ملكنا"),
    "youAreSelecting": m70,
    ...
    "youHaveBeenSaveAddressYourLocal": MessageLookupByLibrary.simpleMessage(
      "تم حفظ عنوانك في منطقتك",
    ),
    "youHaveNoPost": MessageLookupByLibrary.simpleMessage("ليس لديك منشورات"),
    "youHavePassed": m72,
    "youHavePoints": m73,
    ...
    "yourAddressExistYourLocal": MessageLookupByLibrary.simpleMessage(
      "عنوانك موجود في منطقتك",
    ),
    "yourAddressHasBeenSaved": MessageLookupByLibrary.simpleMessage(
      "تم حفظ العنوان في جهازك",
    ),
    "yourApplicationIsUnderReview": MessageLookupByLibrary.simpleMessage(
      "طلبك قيد المراجعة.",
    ),
    "yourBagIsEmpty": MessageLookupByLibrary.simpleMessage("سلة التسوق فارغة"),

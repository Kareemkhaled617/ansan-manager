...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(state) => "蓝牙状态：${state}";
  ...
  static String m9(fieldName) => "${fieldName} 长度不得小于 3。";

  static String m10(currency) => "货币已更改为${currency}";

  static String m11(number) => "还可输入${number}个字符";

  static String m12(priceRate, pointRate) => "${priceRate} = ${pointRate}积分";

  static String m13(count) => "${count}个商品";

  static String m14(count) => "${count}个商品";
  ...
  static String m22(captcha) => "输入${captcha}以确认：";
  ...
  static String m40(number) => "必须以${number}为一组购买";
  ...
  static String m44(name) => "${name}已添加到购物车";

  static String m45(total) => "数量：${total}";

  static String m46(name) => "已收到来自${name}的款项";

  static String m47(count) => "是否要从愿望清单中删除 ${count} 件商品？";

  static String m48(percent) => "促销 ${percent}%";

  static String m49(keyword) => "\"${keyword}\"的搜索结果";

  static String m50(keyword, count) => "${keyword}（${count}个结果）";

  static String m51(keyword, count) => "${keyword}（${count}个结果）";
  ...
  static String m56(total) => "${total}件商品";
  ...
  static String m66(length) => "我们找到了${length}件商品";
  ...
  static String m70(count) => "您正在选择 ${count} 个项目";

  static String m71(total) => "您已分配到订单#${total}";

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Se realizó una oferta exitosa para \'${name}\'";

  static String m5(state) => "El adaptador Bluetooth está ${state}";

  static String m6(amount) => "Compra ahora por ${amount}";

  static String m7(author) => "Por: ${author}";

  static String m8(fieldName) => "${fieldName} no puede estar vacío";

  static String m9(fieldName) =>
      "${fieldName} no puede tener menos de 3 caracteres";

  static String m10(currency) => "Moneda cambiada a ${currency}";
  ...
  static String m15(count) => "${count} artículo";

  static String m16(count) => "${count} artículos";

  static String m17(country) => "${country} no está soportado";

  static String m18(currency) => "${currency} no está soportado";

  static String m19(day) => "Hace ${day} días";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Termina en ${timeLeft}";

  static String m22(captcha) => "Ingresa ${captcha} para confirmar:";

  static String m23(message) => "Error: ${message}";

  static String m24(message) => "Error: ${message}";

  static String m25(time) => "Expira en ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "Hace ${hour} horas";
  ...
  static String m31(size) => "Tamaño máximo del archivo: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "El pedido mínimo para ${storeName} es de ${minOrderAmount}. ¡Añade algunos artículos más de esta tienda!";

  static String m35(amount) =>
      "Este cupón requiere una compra mínima de ${amount}.";

  static String m36(value) => "Transacción mínima: ${value}";

  static String m37(minute) => "Hace ${minute} minutos";

  static String m38(month) => "Hace ${month} meses";

  static String m39(store) => "Más de ${store}";

  static String m40(number) => "Debe comprarse en grupos de ${number}";

  static String m41(itemCount) => "${itemCount} artículos";

  static String m42(price) => "Total de opciones: ${price}";

  static String m43(amount) => "Pagar ${amount}";

  static String m44(name) => "${name} agregado al carrito";

  static String m45(total) => "Cantidad: ${total}";

  static String m46(name) => "Recibiste dinero de ${name}";

  static String m47(count) =>
      "¿Quieres eliminar ${count} artículo(s) de tu lista de deseos?";

  static String m48(percent) => "Descuento ${percent}%";

  static String m49(keyword) => "Resultados de búsqueda para: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} elemento)";

  static String m51(keyword, count) => "${keyword} (${count} elementos)";

  static String m52(second) => "Hace ${second} segundos";
  ...
  static String m55(fieldName) => "El campo ${fieldName} es obligatorio";

  static String m56(total) => "${total} productos";

  static String m57(name) => "Transferir dinero a ${name}";

  static String m58(amount) => "Utiliza ${amount} puntos";
  ...
  static String m60(time) => "Válido hasta: ${time}";

  static String m61(date) => "Válido hasta ${date}";

  static String m62(number) => "Versión ${number}";

  static String m63(balance) => "Saldo de la billetera: ${balance}";

  static String m64(message) => "Advertencia: ${message}";
  ...
  static String m66(length) => "Encontramos ${length} productos";

  static String m67(week) => "Semana ${week}";

  static String m68(name) => "Bienvenido ${name}";

  static String m69(year) => "Hace ${year} años";

  static String m70(count) => "Estás seleccionando ${count} artículo(s)";

  static String m71(total) => "Has sido asignado al pedido #${total}";

  static String m72(type) => "Has superado ${type}";

  static String m73(point) => "Tienes ${point} puntos";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Sumar puntos"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Monto del anticipo"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Anticipo"),
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Lo sentimos, las citas no pueden comenzar este día.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "¿Estás seguro de que deseas reembolsar este pedido?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Subasta"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Fechas de subasta"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Subasta finalizada"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("La subasta termina"),
    ...
    "auctionType": MessageLookupByLibrary.simpleMessage("Tipo de subasta"),
    "audioDetected": MessageLookupByLibrary.simpleMessage(
      "Se detectaron elementos de audio. ¿Deseas agregarlos al reproductor de audio?",
    ),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "La solicitud de cancelación no tuvo éxito",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "¡Tu solicitud de cancelación se ha enviado correctamente!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "El carrito no está disponible. Por favor, añade algunos artículos a tu carrito.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Tu carrito aún se está procesando. Espera un momento.",
    ),
    ...
    "classifieds": MessageLookupByLibrary.simpleMessage("Clasificados"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Este rol de usuario permite hacer reservas, enviar mensajes privados a otros usuarios y dejar reseñas en los anuncios.",
    ),
    ...
    "doesNotSupportApplePay": MessageLookupByLibrary.simpleMessage(
      "ApplePay no es compatible. Por favor, revisa tu billetera y tarjeta",
    ),
    ...
    "enterPoint": MessageLookupByLibrary.simpleMessage("Ingresa el punto"),
    ...
    "enterYourNote": MessageLookupByLibrary.simpleMessage("Introduce tu nota"),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Comparte más opiniones sobre el producto para ayudar a otros compradores.",
    ),
    ...
    "failedToLoadAppConfig": MessageLookupByLibrary.simpleMessage(
      "No se pudo cargar la configuración de la aplicación. Por favor, inténtalo de nuevo o reinicia la aplicación.",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("Prioridad de oro"),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Se produjo un error al intentar realizar esta acción. Por favor, vuelve a verificar.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Datos no válidos. Por favor, revisa tu entrada.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Introduce una dirección completa con nombre de calle y número",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "Por favor, introduce un nombre de ciudad válido",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Introduce un nombre de ciudad válido sin caracteres especiales",
    ),
    ...
    "invalidCountryCode": MessageLookupByLibrary.simpleMessage(
      "Por favor, selecciona un código de país válido",
    ),
    "invalidCountryCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Selecciona un código de país válido de la lista",
    ),
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "Introduce un formato de correo electrónico válido (por ejemplo, ejemplo@dominio.com)",
    ),
    "invalidPhone": MessageLookupByLibrary.simpleMessage(
      "Por favor, introduce un número de teléfono válido",
    ),
    "invalidPhoneFormat": MessageLookupByLibrary.simpleMessage(
      "Introduce un formato de número de teléfono válido",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Introduce un formato de código postal válido para tu país",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Por favor, introduce una provincia/estado válido",
    ),
    "invalidProvinceFormat": MessageLookupByLibrary.simpleMessage(
      "Introduce un nombre de provincia/estado válido",
    ),
    "invalidQRCode": MessageLookupByLibrary.simpleMessage(
      "Código QR no válido",
    ),
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "El código QR escaneado no es válido. Por favor, verifica e inténtalo de nuevo.",
    ),
    ...
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("nuevo"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("¡Error al cargar!"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Mis cupones"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Mi código QR"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Proporcione este código al personal para",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Por favor, comprueba tu red nuevamente.",
    ),
    ...
    "noCameraPermissionIsGranted": MessageLookupByLibrary.simpleMessage(
      "No se ha concedido permiso para la cámara. Por favor, actívalo en la configuración de tu dispositivo.",
    ),
    ...
    "openSettings": MessageLookupByLibrary.simpleMessage("Abrir configuración"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Este rol de usuario permite agregar anuncios y servicios de reserva y gestionarlos. Los propietarios no pueden dejar reseñas en otros anuncios.",
    ),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Historial de puntos"),
    ...
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "Se han añadido puntos a la cuenta del usuario.",
    ),
    ...
    "pointsRedeemedMsg": MessageLookupByLibrary.simpleMessage(
      "Los puntos se han canjeado de la cuenta del usuario.",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Detalles del rango"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Actualmente eres miembro de este rango",
    ),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Canjear"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Canjear puntos"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage(
      "Canjear recompensas",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Canjeado"),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Importe restante a pagar contra entrega",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Alquiler"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Precio de reserva"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Revertir"),
    ...
    "scanPoints": MessageLookupByLibrary.simpleMessage("Escanear puntos"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "El escáner QR solo admite la búsqueda de productos",
    ),
    ...
    "selectType": MessageLookupByLibrary.simpleMessage("Selecciona tipo"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Utiliza tu cuenta de Shopify para iniciar sesión y acceder a tus pedidos, direcciones y más.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Iniciar sesión con cuenta de cliente de Shopify",
    ),
    ...
    "silverPriority": MessageLookupByLibrary.simpleMessage("Prioridad Plata"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Gasta al menos"),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Empezar a explorar",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Precio inicial"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Error del sistema. Contacta con soporte técnico.",
    ),
    ...
    "tooManyFailedLogin": MessageLookupByLibrary.simpleMessage(
      "Demasiados intentos fallidos de inicio de sesión. Por favor, inténtalo más tarde.",
    ),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Algo salió mal, ocurrió un error desconocido",
    ),
    ...
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Gana más"),
    ...
    "usePoint": MessageLookupByLibrary.simpleMessage("Usar punto"),
    ...
    "weNeedCameraAccessTo": MessageLookupByLibrary.simpleMessage(
      "Necesitamos acceso a la cámara para escanear códigos QR o de barras.",
    ),
    "weSentAnOTPTo": MessageLookupByLibrary.simpleMessage(
      "Hemos enviado un código de autenticación a",
    ),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Oferta ganadora"),
    ...
    "writeTitle": MessageLookupByLibrary.simpleMessage("Escribe tu título"),
    "writeYourNote": MessageLookupByLibrary.simpleMessage("Escribe tu nota"),
    "yearsAgo": m69,
    "yes": MessageLookupByLibrary.simpleMessage("Sí"),
    "youAreOur": MessageLookupByLibrary.simpleMessage("Eres nuestro"),
    "youAreSelecting": m70,

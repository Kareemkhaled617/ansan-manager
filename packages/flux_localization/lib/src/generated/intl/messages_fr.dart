...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) =>
      "Une enchère a été placée avec succès pour « ${name} ».";

  static String m5(state) => "L\'adaptateur Bluetooth est ${state}";

  static String m6(amount) => "Achetez maintenant pour ${amount}";

  static String m7(author) => "Par ${author}";

  static String m8(fieldName) => "Le champ ${fieldName} ne peut pas être vide.";

  static String m9(fieldName) =>
      "La longueur de ${fieldName} ne doit pas être inférieure à 3 caractères.";

  static String m10(currency) => "Devise changée en ${currency}";

  static String m11(number) => "${number} caractères restants";
  ...
  static String m15(count) => "${count} article";

  static String m16(count) => "${count} articles";

  static String m17(country) => "${country} n\'est pas pris en charge";

  static String m18(currency) => "${currency} n\'est pas pris en charge";

  static String m19(day) => "Il y a ${day} jours";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Se termine dans ${timeLeft}";

  static String m22(captcha) => "Saisissez ${captcha} pour confirmer :";

  static String m23(message) => "Erreur : ${message}";

  static String m24(message) => "Erreur : ${message}";

  static String m25(time) => "Expire dans ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "Il y a ${hour} heures";
  ...
  static String m31(size) => "Taille maximale du fichier : ${size} Mo";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Le montant minimum de commande pour ${storeName} est de ${minOrderAmount}. Veuillez ajouter quelques articles supplémentaires de cette boutique !";

  static String m35(amount) =>
      "Ce coupon nécessite un achat minimum de ${amount}.";

  static String m36(value) => "Transaction minimale : ${value}";

  static String m37(minute) => "Il y a ${minute} minutes";

  static String m38(month) => "Il y a ${month} mois";

  static String m39(store) => "Plus de ${store}";

  static String m40(number) => "Doit être acheté par groupes de ${number}";

  static String m41(itemCount) => "${itemCount} articles";

  static String m42(price) => "Total des options : ${price}";

  static String m43(amount) => "Payer ${amount}";

  static String m44(name) => "${name} a été ajouté au panier avec succès";

  static String m45(total) => "Qté : ${total}";

  static String m46(name) => "Reçu de l\'argent de ${name}";

  static String m47(count) =>
      "Voulez-vous retirer ${count} article(s) de votre liste de souhaits ?";

  static String m48(percent) => "Remise ${percent}%";

  static String m49(keyword) => "Résultats de recherche pour : \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} article)";

  static String m51(keyword, count) => "${keyword} (${count} articles)";

  static String m52(second) => "Il y a ${second} secondes";

  static String m53(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} articles";

  static String m54(numberOfUnitsSold) => "Vendu : ${numberOfUnitsSold}";

  static String m55(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m56(total) => "${total} produits";

  static String m57(name) => "Transférer de l\'argent à ${name}";

  static String m58(amount) => "Utilisez ${amount} points";
  ...
  static String m60(time) => "Valable jusqu\'au : ${time}";

  static String m61(date) => "Valable jusqu\'au ${date}";

  static String m62(number) => "Version ${number}";

  static String m63(balance) => "Solde du portefeuille : ${balance}";

  static String m64(message) => "Attention : ${message}";
  ...
  static String m66(length) => "Nous avons trouvé ${length} produits";

  static String m67(week) => "Semaine ${week}";

  static String m68(name) => "Bienvenue ${name}";

  static String m69(year) => "Il y a ${year} ans";

  static String m70(count) => "Vous sélectionnez ${count} article(s)";

  static String m71(total) => "Vous avez été assigné à la commande n°${total}";

  static String m72(type) => "Vous avez réussi ${type}";

  static String m73(point) => "Vous avez ${point} points";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Ajouter des points"),
    ...
    "advancePayment": MessageLookupByLibrary.simpleMessage("Paiement anticipé"),
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Désolé, les rendez-vous ne peuvent pas commencer ce jour-là.",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Enchères"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Dates des enchères"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Enchères terminées"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Fin des enchères"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage(
      "Historique des enchères",
    ),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Début des enchères"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "Les enchères commencent dans",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Type d\'enchère"),
    ...
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Devenir un autre rôle",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Avantages"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengali"),
    "bid": MessageLookupByLibrary.simpleMessage("Offre"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "La demande d\'annulation a échoué",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Votre demande d\'annulation a été soumise avec succès !",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Votre panier est indisponible. Veuillez y ajouter des articles.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Votre panier est en cours de traitement. Veuillez patienter un instant.",
    ),
    ...
    "claimed": MessageLookupByLibrary.simpleMessage("Revendiqué"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Petites annonces"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Offre actuelle"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ce rôle utilisateur permet de faire des réservations, d\'envoyer des messages privés à d\'autres utilisateurs et de laisser des avis sur les annonces.",
    ),
    ...
    "enterYourNote": MessageLookupByLibrary.simpleMessage("Entrez votre note"),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Partagez plus d\'avis sur le produit pour aider les autres acheteurs.",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("Priorité Or"),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Une erreur s\'est produite lors de cette action. Veuillez vérifier.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Données non valides. Veuillez vérifier votre saisie.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez saisir une adresse complète avec le nom de la rue et le numéro",
    ),
    ...
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez saisir un nom de ville valide sans caractères spéciaux",
    ),
    ...
    "invalidCountryCode": MessageLookupByLibrary.simpleMessage(
      "Veuillez sélectionner un code pays valide",
    ),
    "invalidCountryCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez sélectionner un code pays valide dans la liste",
    ),
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez saisir un format d\'e-mail valide (par exemple, exemple@domaine.com)",
    ),
    "invalidPhone": MessageLookupByLibrary.simpleMessage(
      "S\'il vous plaît entrer un numéro de téléphone valide",
    ),
    "invalidPhoneFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez saisir un format de numéro de téléphone valide",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez saisir un format de code postal valide pour votre pays",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Veuillez entrer une province/état valide",
    ),
    "invalidProvinceFormat": MessageLookupByLibrary.simpleMessage(
      "Veuillez saisir un nom de province/état valide",
    ),
    "invalidQRCode": MessageLookupByLibrary.simpleMessage("Code QR invalide"),
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Le code QR scanné n\'est pas valide. Veuillez vérifier et réessayer.",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("État de l\'objet"),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("Nouveau"),
    ...
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("Bon de fidélité"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Mes coupons"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Mon QRCode"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Fournissez ce code au personnel pour",
    ),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ce rôle utilisateur permet d\'ajouter des annonces, de proposer des services de réservation et de les gérer. Les propriétaires ne peuvent pas évaluer d\'autres annonces.",
    ),
    ...
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "Des points ont été ajoutés au compte de l’utilisateur.",
    ),
    ...
    "pointsRedeemedMsg": MessageLookupByLibrary.simpleMessage(
      "Les points ont été échangés à partir du compte de l’utilisateur.",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Détails du rang"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Vous êtes actuellement membre de ce rang",
    ),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Racheter"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Échanger des points"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage(
      "Échanger des récompenses",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Racheté"),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Montant restant à payer à la livraison",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Location"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Prix de réserve"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Inverse"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Récompenses"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "Le scanner QR prend uniquement en charge la recherche de produits",
    ),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Utilisez votre compte Shopify pour vous connecter et accéder à vos commandes, adresses et plus encore.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Connectez-vous avec votre compte client Shopify",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("S\'inscrire"),
    "silver": MessageLookupByLibrary.simpleMessage("Argent"),
    "silverPriority": MessageLookupByLibrary.simpleMessage("Priorité Argent"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Dépensez au moins"),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Commencer à explorer",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Prix de départ"),
    "startShopping": MessageLookupByLibrary.simpleMessage(
      "Commencer les achats",
    ),
    "startingBid": MessageLookupByLibrary.simpleMessage("Enchère de départ"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Une erreur s\'est produite, une erreur inconnue est apparue",
    ),
    "unnamedLocation": MessageLookupByLibrary.simpleMessage("Lieu sans nom"),
    "unpaid": MessageLookupByLibrary.simpleMessage("Non payé"),
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Gagnez plus"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "points pour monter dans ce rang.",
    ),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Utilisé"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Offre gagnante"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Tu es notre"),
    "youAreSelecting": m70,
    ...
    "youHave": MessageLookupByLibrary.simpleMessage("Tu as"),

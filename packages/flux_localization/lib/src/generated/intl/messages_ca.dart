...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(amount) => "Afegeix ${amount} punts";

  static String m2(attribute) => "Qualsevol ${attribute}";

  static String m3(point) => "Els teus punts disponibles: ${point}";

  static String m4(name) => "Oferta realitzada amb èxit per \'${name}\'";

  static String m5(state) => "L\'adaptador Bluetooth està ${state}";

  static String m6(amount) => "Compra ara per ${amount}";

  static String m7(author) => "Autor: ${author}";

  static String m8(fieldName) => "${fieldName} no pot estar buit.";

  static String m9(fieldName) =>
      "La longitud de ${fieldName} no pot ser inferior a 3.";

  static String m10(currency) => "S\'ha canviat la moneda a ${currency}";

  static String m11(number) => " Queden${number} caràcters";
  ...
  static String m16(count) => "${count} elements";

  static String m17(country) => "El país ${country} no està suportat";

  static String m18(currency) => "${currency} no està suportat";

  static String m19(day) => "fa ${day} dies";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Acaba en ${timeLeft}";

  static String m22(captcha) => "Introdueix ${captcha} per confirmar:";

  static String m23(message) => "Error: ${message}";

  static String m24(message) => "Error: ${message}";

  static String m25(time) => "Caduca en ${time}";

  static String m26(total) => "Més de ${total} km";

  static String m27(hour) => "fa ${hour} hores";
  ...
  static String m31(size) => "Mida màxima del fitxer: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "L\'import mínim de compra a ${storeName} és ${minOrderAmount}. Afegeix alguns articles més d\'aquesta botiga!";

  static String m35(amount) =>
      "Aquest cupó requereix una compra mínima de ${amount}.";

  static String m36(value) => "Transacció mínima: ${value}";

  static String m37(minute) => "fa ${minute} minuts";

  static String m38(month) => "Fa ${month} mesos";

  static String m39(store) => "Més de ${store}";

  static String m40(number) => "s\'ha de comprar en grups de ${number}";

  static String m41(itemCount) => "${itemCount} articles";

  static String m42(price) => "Total d\'opcions: ${price}";

  static String m43(amount) => "Pagar ${amount}";

  static String m44(name) => " S\'han afegit${name} al carretó correctament";

  static String m45(total) => "Quantitat: ${total}";

  static String m46(name) => "S\'ha rebut diners de ${name}";

  static String m47(count) =>
      "Vols eliminar ${count} element(s) de la teva llista de desitjos?";

  static String m48(percent) => "${percent}% de descompte";

  static String m49(keyword) => "Resultats de la cerca per a: \"${keyword}\"";

  static String m50(keyword, count) => "${keyword} (${count} element)";

  static String m51(keyword, count) => "${keyword} (${count} elements)";

  static String m52(second) => "fa ${second} segons";

  static String m53(totalCartQuantity) =>
      "Carret de compra, ${totalCartQuantity} articles";

  static String m54(numberOfUnitsSold) => "Venut: ${numberOfUnitsSold}";

  static String m55(fieldName) => "El camp ${fieldName} és obligatori";

  static String m56(total) => "${total} productes";

  static String m57(name) => "Transfereix diners a ${name}";

  static String m58(amount) => "Utilitza ${amount} punts";
  ...
  static String m60(time) => "Vàlid fins: ${time}";

  static String m61(date) => "Vàlid fins al ${date}";

  static String m62(number) => "Versió ${number}";

  static String m63(balance) => "Saldo de Wallet: ${balance}";

  static String m64(message) => "Avís: ${message}";
  ...
  static String m66(length) => "Hem trobat ${length} productes";

  static String m67(week) => "Setmana ${week}";

  static String m68(name) => "Benvingut/da ${name}";

  static String m69(year) => "Fa ${year} anys";

  static String m70(count) => "Estàs seleccionant ${count} element(s)";

  static String m71(total) => "T\'han assignat la comanda #${total}";

  static String m72(type) => "Has superat ${type}";

  static String m73(point) => "Tens ${point} punts";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addOrUsePointsSuccessMsg": MessageLookupByLibrary.simpleMessage(
      "Enhorabona! Els punts s\'han afegit o bescanviat correctament.",
    ),
    "addPoint": MessageLookupByLibrary.simpleMessage("Afegeix punt"),
    "addPoints": MessageLookupByLibrary.simpleMessage("Afegeix punts"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Import avançat"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Pagament avançat"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "L\'import supera els punts disponibles",
    ),
    "anyAttr": m2,
    "appTrackingRequest": MessageLookupByLibrary.simpleMessage(
      "Aquest identificador s\'utilitzarà per oferir-te anuncis personalitzats. \n\"Cancel·la\" limitarà la capacitat de la xarxa de publicitat per oferir anuncis rellevants, però no reduirà el nombre d\'anuncis que reps.\nCom que el dispositiu està restringit, el seguiment està desactivat i el sistema no pot mostrar el diàleg de sol·licitud. Vols \"Obrir la configuració\" i permetre que l\'app faci seguiment de la teva activitat a altres apps i webs d\'empreses?",
    ),
    "appTrackingTransparency": MessageLookupByLibrary.simpleMessage(
      "Transparència de seguiment de l\'app",
    ),
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Ho sentim, no es poden iniciar cites aquest dia.",
    ),
    ...
    "areYouSureCancelOrder": MessageLookupByLibrary.simpleMessage(
      "Estàs segur que vols cancel·lar aquesta comanda?",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Estàs segur que vols reemborsar aquesta comanda?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Subhasta"),
    "auctionDates": MessageLookupByLibrary.simpleMessage(
      "Dates de la subhasta",
    ),
    "auctionEnded": MessageLookupByLibrary.simpleMessage(
      "Subhasta finalitzada",
    ),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("La subhasta acaba"),
    ...
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "La subhasta comença en",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Tipus de subhasta"),
    ...
    "b2bKingRegisterMsg": MessageLookupByLibrary.simpleMessage(
      "Contacta amb l\'administrador per aprovar el teu registre.",
    ),
    ...
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage(
      "Converteix-te en propietari",
    ),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Canvia a un altre rol",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Beneficis"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengalí"),
    "bid": MessageLookupByLibrary.simpleMessage("Oferta"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Increment d\'oferta"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "La sol·licitud de cancel·lació no ha tingut èxit",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "La teva sol·licitud de cancel·lació s\'ha enviat amb èxit!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "El carretó no està disponible. Afegeix alguns articles al teu carretó.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "La teva cistella encara s\'està processant. Espera un moment, si us plau.",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Reclama"),
    "claimed": MessageLookupByLibrary.simpleMessage("Reclamat"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Classificats"),
    ...
    "columns": MessageLookupByLibrary.simpleMessage("Columnes"),
    "comment": MessageLookupByLibrary.simpleMessage("Comenta"),
    "commentFailed": MessageLookupByLibrary.simpleMessage("Comentari fallit!"),
    ...
    "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
      "Continua seleccionant l\'article",
    ),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Oferta actual"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Aquest rol d\'usuari permet fer reserves, enviar missatges privats a altres usuaris i valorar anuncis.",
    ),
    ...
    "enterPoint": MessageLookupByLibrary.simpleMessage("Introdueix punts"),
    "enterPrice": MessageLookupByLibrary.simpleMessage("Introdueix el preu"),
    ...
    "enterYourReview": MessageLookupByLibrary.simpleMessage(
      "Introdueix la teva ressenya",
    ),
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Comparteix més opinions sobre el producte per ajudar altres compradors.",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("Prioritat Or"),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "S\'ha produït un error en intentar fer aquesta acció. Si us plau, comprova-ho de nou",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Dades no vàlides. Comprova la teva entrada.",
    ),
    "greaterDistance": m26,
    ...
    "horizontal": MessageLookupByLibrary.simpleMessage("Horitzontal"),
    ...
    "images": MessageLookupByLibrary.simpleMessage("Imatges"),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage(
      "Condició de l\'article",
    ),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("Nou"),
    ...
    "listTile": MessageLookupByLibrary.simpleMessage("Element de la llista"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("Error en la càrrega!"),
    ...
    "loginRequired": MessageLookupByLibrary.simpleMessage("Cal iniciar sessió"),
    ...
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("Val de fidelitat"),
    ...
    "mobileNumberIsNotRegistered": MessageLookupByLibrary.simpleMessage(
      "El número de telèfon no està registrat!",
    ),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Els meus cupons"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("El meu codi QR"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Proporciona aquest codi al personal per",
    ),
    "myRating": MessageLookupByLibrary.simpleMessage("La meva valoració"),
    "myReviews": MessageLookupByLibrary.simpleMessage("Les meves ressenyes"),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Comprova la teva connexió de xarxa",
    ),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Temps d\'espera de connexió esgotat. Torna-ho a intentar.",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "No hi ha comandes pendents de lliurament",
    ),
    ...
    "owner": MessageLookupByLibrary.simpleMessage("Propietari"),
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Aquest rol d\'usuari permet afegir anuncis i serveis de reserva i gestionar-los. Els propietaris no poden valorar altres anuncis.",
    ),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Historial de punts"),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Estira cap amunt per carregar més",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Detalls del rànquing"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Actualment ets membre d\'aquest nivell",
    ),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("bescanvia"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Bescanvia punts"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage(
      "Bescanvia recompenses",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Bescanviat"),
    ...
    "refreshing": MessageLookupByLibrary.simpleMessage("Actualitzant..."),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Import pendent de pagament en lliurament",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Lloguer"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Preu de reserva"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Inverteix"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Recompenses"),
    ...
    "scanPoints": MessageLookupByLibrary.simpleMessage("Escaneja punts"),
    "scanQRCode": MessageLookupByLibrary.simpleMessage("Escaneja el codi QR"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "El lector de QR només permet buscar productes",
    ),
    ...
    "selectDate": MessageLookupByLibrary.simpleMessage("Selecciona la data"),
    ...
    "selectItem": MessageLookupByLibrary.simpleMessage("Selecciona un article"),
    ...
    "selectType": MessageLookupByLibrary.simpleMessage("Selecciona el tipus"),
    ...
    "service": MessageLookupByLibrary.simpleMessage("Servei"),
    ...
    "shareProductData": MessageLookupByLibrary.simpleMessage(
      "Comparteix dades del producte",
    ),
    "shareProductLink": MessageLookupByLibrary.simpleMessage(
      "Comparteix l\'enllaç del producte",
    ),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Utilitza el teu compte de Shopify per iniciar sessió i accedir a les teves comandes, adreces i més.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Inicia sessió amb el compte de client de Shopify",
    ),
    ...
    "silverPriority": MessageLookupByLibrary.simpleMessage("Prioritat plata"),
    "simple": MessageLookupByLibrary.simpleMessage("Simple"),
    "simpleList": MessageLookupByLibrary.simpleMessage("Llista simple"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Gasta com a mínim"),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Comença a explorar",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Preu inicial"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Començar a comprar"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Oferta inicial"),
    ...
    "successful": MessageLookupByLibrary.simpleMessage("Amb èxit"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Error de sistema. Si us plau, contacta amb el suport.",
    ),
    ...
    "thisIsDeliveryrRole": MessageLookupByLibrary.simpleMessage(
      "Aquest és el rol de repartidor",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Temps restant"),
    ...
    "totalPoints": MessageLookupByLibrary.simpleMessage("Punts totals"),
    ...
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Guanya més"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "punts per pujar de nivell.",
    ),
    ...
    "usePoint": MessageLookupByLibrary.simpleMessage("Utilitza punt"),
    "useThisImage": MessageLookupByLibrary.simpleMessage(
      "Utilitza aquesta imatge",
    ),
    "used": MessageLookupByLibrary.simpleMessage("Usat"),
    ...
    "viewAll": MessageLookupByLibrary.simpleMessage("Veure-ho tot"),
    ...
    "waiting": MessageLookupByLibrary.simpleMessage("Esperant"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Oferta guanyadora"),
    ...
    "writeTitle": MessageLookupByLibrary.simpleMessage("Escriu el teu títol"),
    "writeYourNote": MessageLookupByLibrary.simpleMessage(
      "Escriu la teva nota",
    ),
    "yearsAgo": m69,
    "yes": MessageLookupByLibrary.simpleMessage("Sí"),
    "youAreOur": MessageLookupByLibrary.simpleMessage("Ets el nostre"),
    "youAreSelecting": m70,
    ...
    "youHave": MessageLookupByLibrary.simpleMessage("Tens"),

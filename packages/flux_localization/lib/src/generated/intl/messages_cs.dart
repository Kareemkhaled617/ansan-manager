...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Úspěšně podána nabídka na \'${name}\'";

  static String m5(state) => "Bluetooth adaptér je ${state}";

  static String m6(amount) => "Kupte nyní za ${amount}";

  static String m7(author) => "Autor: ${author}";

  static String m8(fieldName) => "Pole ${fieldName} nemůže být prázdné";

  static String m9(fieldName) =>
      "Pole ${fieldName} nesmí být kratší než 3 znaky";

  static String m10(currency) => "Měna změněna na ${currency}";

  static String m11(number) => "Zbývá znaků: ${number}";

  static String m12(priceRate, pointRate) => "${priceRate} = ${pointRate} bodů";
  ...
  static String m16(count) => "${count} položek";

  static String m17(country) => "Země ${country} není podporována";

  static String m18(currency) => "Měna ${currency} není podporována";

  static String m19(day) => "Před ${day} dny";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Končí za ${timeLeft}";

  static String m22(captcha) => "Pro potvrzení zadejte ${captcha}:";

  static String m23(message) => "Chyba: ${message}";

  static String m24(message) => "Chyba: ${message}";

  static String m25(time) => "Končí za ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "Před ${hour} hodinami";

  static String m28(currentBalance) =>
      "V peněžence máte pouze ${currentBalance}";

  static String m29(message) =>
      "Při požadavku na data došlo k problému s aplikací. Kontaktujte správce pro řešení: ${message}";

  static String m30(currency, amount) =>
      "Maximální částka pro tuto platbu je ${currency} ${amount}";

  static String m31(size) => "Maximální velikost souboru: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Minimální částka objednávky pro ${storeName} je ${minOrderAmount}. Přidejte prosím další položky z tohoto obchodu!";

  static String m35(amount) =>
      "Tento kupón vyžaduje minimální nákup v hodnotě ${amount}.";

  static String m36(value) => "Minimální transakce: ${value}";

  static String m37(minute) => "Před ${minute} minutami";

  static String m38(month) => "Před ${month} měsíci";

  static String m39(store) => "Další od ${store}";

  static String m40(number) => "Musí být zakoupeno v množství po ${number}";

  static String m41(itemCount) => "Položky: ${itemCount}";

  static String m42(price) => "Celkem možností: ${price}";

  static String m43(amount) => "Zaplatit ${amount}";

  static String m44(name) => "Produkt ${name} byl přidán do košíku";

  static String m45(total) => "Množství: ${total}";

  static String m46(name) => "Přijaty peníze od uživatele ${name}";

  static String m47(count) =>
      "Chcete odebrat položky (celkem ${count}) ze seznamu přání?";

  static String m48(percent) => "Sleva ${percent}%";

  static String m49(keyword) => "Výsledky hledání pro \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} položka)";

  static String m51(keyword, count) => "${keyword} (${count} položek)";

  static String m52(second) => "Před ${second} sekundami";

  static String m53(totalCartQuantity) =>
      "Nákupní košík, ${totalCartQuantity} položek";

  static String m54(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Pole ${fieldName} je povinné";

  static String m56(total) => "${total} produktů";

  static String m57(name) => "Převést peníze uživateli ${name}";

  static String m58(amount) => "Použijte ${amount} bodů";
  ...
  static String m62(number) => "Verze ${number}";

  static String m63(balance) => "Zůstatek v peněžence: ${balance}";

  static String m64(message) => "Upozornění: ${message}";
  ...
  static String m66(length) => "Našli jsme ${length} produktů";

  static String m67(week) => "Týden ${week}";

  static String m68(name) => "Vítejte, ${name}";

  static String m69(year) => "Před ${year} lety";

  static String m70(count) => "Vybíráte položky (celkem ${count})";

  static String m71(total) => "Přiřadili jste objednávku č. ${total}";

  static String m72(type) => "Splnili jste ${type}";

  static String m73(point) => "Máte ${point} bodů";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addListing": MessageLookupByLibrary.simpleMessage("Přidat nabídku"),
    ...
    "addOrUsePointsSuccessMsg": MessageLookupByLibrary.simpleMessage(
      "Gratulujeme! Body byly úspěšně přidány nebo uplatněny.",
    ),
    "addPoint": MessageLookupByLibrary.simpleMessage("Přidat bod"),
    "addPoints": MessageLookupByLibrary.simpleMessage("Přidat body"),
    "addProduct": MessageLookupByLibrary.simpleMessage("Nový produkt"),
    "addToCart": MessageLookupByLibrary.simpleMessage("Přidat do košíku"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Částka zálohy"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Platba předem"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Částka přesahuje dostupné body",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Omlouváme se, ale schůzky v tento den nemohou začít.",
    ),
    "approve": MessageLookupByLibrary.simpleMessage("Schválit"),
    "approved": MessageLookupByLibrary.simpleMessage("Schváleno"),
    ...
    "areYouSureCancelOrder": MessageLookupByLibrary.simpleMessage(
      "Opravdu chcete tuto objednávku zrušit?",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Opravdu chcete tuto objednávku vrátit?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Aukce"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Termíny aukcí"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Aukce ukončena"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Konec aukce"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("Historie aukcí"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Začátek aukce"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage("Aukce začíná za"),
    "auctionType": MessageLookupByLibrary.simpleMessage("Typ aukce"),
    "audioDetected": MessageLookupByLibrary.simpleMessage(
      "Byly zjištěny zvukové položky. Chcete je přidat do přehrávače?",
    ),
    ...
    "backOrder": MessageLookupByLibrary.simpleMessage("Na objednávku"),
    "backToShop": MessageLookupByLibrary.simpleMessage("Zpět do obchodu"),
    ...
    "bannerYoutubeURL": MessageLookupByLibrary.simpleMessage(
      "URL banneru na YouTube",
    ),
    "basicInformation": MessageLookupByLibrary.simpleMessage(
      "Základní informace",
    ),
    "becomeADelivery": MessageLookupByLibrary.simpleMessage(
      "Staňte se doručovatelem",
    ),
    "becomeAVendor": MessageLookupByLibrary.simpleMessage("Stát se prodejcem"),
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage(
      "Staňte se vlastníkem",
    ),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage("Změnit roli"),
    "benefits": MessageLookupByLibrary.simpleMessage("Výhody"),
    "bengali": MessageLookupByLibrary.simpleMessage("bengálština"),
    "bid": MessageLookupByLibrary.simpleMessage("Nabídka"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Přírůstek nabídky"),
    ...
    "booked": MessageLookupByLibrary.simpleMessage("Rezervováno"),
    ...
    "bookingNow": MessageLookupByLibrary.simpleMessage("Rezervovat nyní"),
    ...
    "branchChangeWarning": MessageLookupByLibrary.simpleMessage(
      "Při změně pobočky bude váš košík vyprázdněn. Pokud potřebujete pomoc, neváhejte nás kontaktovat",
    ),
    ...
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("Cena „Koupit hned“"),
    "buyNow": MessageLookupByLibrary.simpleMessage("Koupit nyní"),
    "buyNowFor": m6,
    ...
    "byTag": MessageLookupByLibrary.simpleMessage("Podle štítku"),
    "call": MessageLookupByLibrary.simpleMessage("Volat"),
    "callTo": MessageLookupByLibrary.simpleMessage("Zavolat"),
    ...
    "canNotLaunch": MessageLookupByLibrary.simpleMessage(
      "Tuto aplikaci nelze spustit, ujistěte se, že je vaše nastavení v config.dart správné",
    ),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "Žádost o zrušení nebyla úspěšná",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Vaše žádost o zrušení byla úspěšně odeslána!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Košík není k dispozici. Přidejte prosím nějaké položky do košíku.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Váš košík se stále zpracovává. Prosím, chvíli počkejte.",
    ),
    ...
    "chatWithStoreOwner": MessageLookupByLibrary.simpleMessage(
      "Chat s majitelem obchodu",
    ),
    "checkConfirmLink": MessageLookupByLibrary.simpleMessage(
      "Zkontrolujte svůj e-mail pro potvrzovací odkaz",
    ),
    "checking": MessageLookupByLibrary.simpleMessage("Kontrola..."),
    "checkout": MessageLookupByLibrary.simpleMessage("Pokladna"),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Nárokovat"),
    "claimed": MessageLookupByLibrary.simpleMessage("Nárokováno"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Inzeráty"),
    ...
    "commentSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Počkejte prosím na schválení vašeho komentáře",
    ),
    ...
    "couponsDedicatedForYou": MessageLookupByLibrary.simpleMessage(
      "Kupóny určené pro vás",
    ),
    "couponsManagement": MessageLookupByLibrary.simpleMessage("Správa kupónů"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Aktuální nabídka"),
    ...
    "currentlyWeOnlyHave": MessageLookupByLibrary.simpleMessage(
      "Momentálně máme pouze",
    ),
    "customer": MessageLookupByLibrary.simpleMessage("Zákazník"),
    "customerDetail": MessageLookupByLibrary.simpleMessage("Detaily zákazníka"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Tato uživatelská role umožňuje provádět rezervace, posílat soukromé zprávy ostatním uživatelům a hodnotit inzeráty.",
    ),
    ...
    "dataEmpty": MessageLookupByLibrary.simpleMessage("Žádná data"),
    ...
    "dateEnd": MessageLookupByLibrary.simpleMessage("Datum ukončení"),
    ...
    "dateWiseClose": MessageLookupByLibrary.simpleMessage("Zavřít podle data"),
    "daysAgo": m19,
    ...
    "displayName": MessageLookupByLibrary.simpleMessage("Zobrazované jméno"),
    "distance": m20,
    ...
    "dutch": MessageLookupByLibrary.simpleMessage("holandština"),
    "earnings": MessageLookupByLibrary.simpleMessage("Výdělek"),
    ...
    "emailDoesNotExist": MessageLookupByLibrary.simpleMessage(
      "E-mailový účet, který jste zadali, neexistuje. Zkuste to prosím znovu.",
    ),
    ...
    "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
      "Vypadá to, že jste do tašky ještě nic nepřidali. Začněte nakupovat a naplňte ji.",
    ),
    ...
    "emptySearch": MessageLookupByLibrary.simpleMessage(
      "Zatím jste nic nehledali. Začněme hned – pomůžeme vám.",
    ),
    ...
    "emptyUsername": MessageLookupByLibrary.simpleMessage(
      "Uživatelské jméno/e-mail je prázdné",
    ),
    "emptyWishlist": MessageLookupByLibrary.simpleMessage(
      "Prázdný seznam přání",
    ),
    "emptyWishlistSubtitle": MessageLookupByLibrary.simpleMessage(
      "Klepněte na srdce u oblíbeného produktu. Zde si je uložíte!",
    ),
    ...
    "enterYourReview": MessageLookupByLibrary.simpleMessage(
      "Zadejte svou recenzi",
    ),
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Podělte se o své zkušenosti s produktem a pomozte ostatním zákazníkům.",
    ),
    ...
    "event": MessageLookupByLibrary.simpleMessage("Událost"),
    ...
    "feature": MessageLookupByLibrary.simpleMessage("Funkce"),
    ...
    "generatingLink": MessageLookupByLibrary.simpleMessage("Generuji odkaz..."),
    "german": MessageLookupByLibrary.simpleMessage("němčina"),
    "getNotification": MessageLookupByLibrary.simpleMessage(
      "Dostávat upozornění",
    ),
    "getNotified": MessageLookupByLibrary.simpleMessage(
      "Dostávejte upozornění!",
    ),
    ...
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "Ověření se nezdařilo. Přihlaste se prosím znovu.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Při pokusu o provedení této akce se něco pokazilo. Zkontrolujte to prosím znovu.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Zadali jste neplatné údaje. Zkontrolujte prosím zadané údaje.",
    ),
    "greaterDistance": m26,
    "greek": MessageLookupByLibrary.simpleMessage("Řečtina"),
    "grossSales": MessageLookupByLibrary.simpleMessage("Hrubý prodej"),
    "grouped": MessageLookupByLibrary.simpleMessage("Seskupené"),
    ...
    "hideAbout": MessageLookupByLibrary.simpleMessage("Skrýt O nás"),
    ...
    "hoursAgo": m27,
    "howToEarnPoints": MessageLookupByLibrary.simpleMessage("Jak získat body?"),
    "hungarian": MessageLookupByLibrary.simpleMessage("maďarština"),
    ...
    "imageFeature": MessageLookupByLibrary.simpleMessage("Vlastnost obrázku"),
    ...
    "installDigitsPlugin": MessageLookupByLibrary.simpleMessage(
      "Nainstalujte prosím plugin DIGITS: WordPress Mobile Number Signup and Login",
    ),
    ...
    "invalidAddress": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím platnou adresu",
    ),
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím úplnou adresu s názvem ulice a číslem popisným",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím platný název města",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Zadejte platný název města bez speciálních znaků.",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím platný formát poštovního směrovacího čísla pro vaši zemi",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím platný název provincie/státu",
    ),
    ...
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Naskenovaný QR kód není platný. Zkontrolujte jej a zkuste to znovu.",
    ),
    "invalidSMSCode": MessageLookupByLibrary.simpleMessage(
      "Neplatný SMS ověřovací kód",
    ),
    ...
    "itsOrdered": MessageLookupByLibrary.simpleMessage("Objednáno!"),
    "iwantToCreateAccount": MessageLookupByLibrary.simpleMessage(
      "Chci si vytvořit účet",
    ),
    "japanese": MessageLookupByLibrary.simpleMessage("japonština"),
    "kannada": MessageLookupByLibrary.simpleMessage("Kannadština"),
    "keep": MessageLookupByLibrary.simpleMessage("Ponechat"),
    ...
    "layout": MessageLookupByLibrary.simpleMessage("Rozvržení"),
    ...
    "listBannerVideo": MessageLookupByLibrary.simpleMessage(
      "Seznam bannerových videí",
    ),
    "listMessages": MessageLookupByLibrary.simpleMessage("Upozornit na zprávy"),
    "listTile": MessageLookupByLibrary.simpleMessage("Dlaždice seznamu"),
    "listening": MessageLookupByLibrary.simpleMessage("Poslouchám..."),
    "loadFail": MessageLookupByLibrary.simpleMessage("Načítání se nezdařilo!"),
    ...
    "logoutSuccess": MessageLookupByLibrary.simpleMessage("Odhlášení úspěšné"),
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("Věrnostní poukaz"),
    "malay": MessageLookupByLibrary.simpleMessage("Malajština"),
    "manCollections": MessageLookupByLibrary.simpleMessage("Pánské kolekce"),
    "manageApiKey": MessageLookupByLibrary.simpleMessage("Správa API klíče"),
    "manageStock": MessageLookupByLibrary.simpleMessage("Spravovat zásoby"),
    ...
    "mustSelectOneItem": MessageLookupByLibrary.simpleMessage(
      "Musíte vybrat jednu položku",
    ),
    "myCart": MessageLookupByLibrary.simpleMessage("Můj košík"),
    ...
    "myProductsEmpty": MessageLookupByLibrary.simpleMessage(
      "Nemáte žádné produkty. Zkuste si nějaký vytvořit!",
    ),
    "myQRCode": MessageLookupByLibrary.simpleMessage("Můj QR kód"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Předložte tento kód personálu",
    ),
    ...
    "myWishList": MessageLookupByLibrary.simpleMessage("Můj seznam přání"),
    "nItems": m41,
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Zkontrolujte prosím své připojení k síti.",
    ),
    ...
    "niceName": MessageLookupByLibrary.simpleMessage("Uživatelské jméno"),
    ...
    "noBackHistoryItem": MessageLookupByLibrary.simpleMessage(
      "Žádná položka v historii zpět",
    ),
    "noBlog": MessageLookupByLibrary.simpleMessage(
      "Jejda, zdá se, že blog již neexistuje",
    ),
    "noCameraPermissionIsGranted": MessageLookupByLibrary.simpleMessage(
      "Není uděleno žádné oprávnění k fotoaparátu. Udělte jej prosím v nastavení vašeho zařízení.",
    ),
    ...
    "noData": MessageLookupByLibrary.simpleMessage("Žádná další data"),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Žádné čekající objednávky k doručení",
    ),
    ...
    "noPost": MessageLookupByLibrary.simpleMessage(
      "Jejda, zdá se, že tato stránka již neexistuje!",
    ),
    ...
    "noThanks": MessageLookupByLibrary.simpleMessage("Ne, děkuji"),
    ...
    "normal": MessageLookupByLibrary.simpleMessage("Normální"),
    ...
    "onSale": MessageLookupByLibrary.simpleMessage("Ve slevě"),
    ...
    "openMap": MessageLookupByLibrary.simpleMessage("Otevřít mapu"),
    "openNow": MessageLookupByLibrary.simpleMessage("Otevřeno nyní"),
    ...
    "orderDetail": MessageLookupByLibrary.simpleMessage("Detail objednávky"),
    ...
    "orderNo": MessageLookupByLibrary.simpleMessage("Objednávka č."),
    ...
    "orderStatusDenied": MessageLookupByLibrary.simpleMessage("Odmítnuto"),
    "orderStatusExpired": MessageLookupByLibrary.simpleMessage(
      "Platnost vypršela",
    ),
    "orderStatusFailed": MessageLookupByLibrary.simpleMessage("Neúspěšné"),
    ...
    "orderStatusReversed": MessageLookupByLibrary.simpleMessage("Obráceno"),
    "orderStatusShipped": MessageLookupByLibrary.simpleMessage("Odesláno"),
    "orderStatusVoided": MessageLookupByLibrary.simpleMessage("Zrušeno"),
    "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
      "Stav své objednávky můžete zkontrolovat pomocí naší funkce sledování doručení. Obdržíte e-mail s potvrzením objednávky, podrobnostmi a odkazem pro sledování jejího průběhu.",
    ),
    "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
      "Do svého účtu se můžete přihlásit pomocí dříve zadaného e-mailu a hesla. Na svém účtu můžete upravovat údaje profilu, kontrolovat historii transakcí a spravovat odběr newsletteru.",
    ),
    "orderSuccessTitle1": MessageLookupByLibrary.simpleMessage(
      "Objednávka byla úspěšně odeslána",
    ),
    "orderSuccessTitle2": MessageLookupByLibrary.simpleMessage("Váš účet"),
    "orderSummary": MessageLookupByLibrary.simpleMessage("Souhrn objednávky"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Tato uživatelská role umožňuje přidávat a spravovat inzeráty a rezervační služby. Vlastníci nemohou hodnotit jiné inzeráty.",
    ),
    ...
    "payNow": MessageLookupByLibrary.simpleMessage("Zaplatit nyní"),
    "payWithAmount": m43,
    ...
    "persian": MessageLookupByLibrary.simpleMessage("perština"),
    "phone": MessageLookupByLibrary.simpleMessage("Telefon"),
    "phoneEmpty": MessageLookupByLibrary.simpleMessage("Telefon není vyplněn"),
    ...
    "pleaseFillUpAllCellsProperly": MessageLookupByLibrary.simpleMessage(
      "*Vyplňte prosím správně všechny buňky",
    ),
    ...
    "pleaseSelectRequiredOptions": MessageLookupByLibrary.simpleMessage(
      "Vyberte prosím požadované možnosti!",
    ),
    "pleaseSignInBeforeUploading": MessageLookupByLibrary.simpleMessage(
      "Přihlaste se ke svému účtu před nahráním jakýchkoli souborů.",
    ),
    "point": MessageLookupByLibrary.simpleMessage("bod"),
    "pointHistory": MessageLookupByLibrary.simpleMessage("Historie bodů"),
    ...
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "Body byly přidány na uživatelský účet.",
    ),
    ...
    "postContent": MessageLookupByLibrary.simpleMessage("Obsah příspěvku"),
    "postFail": MessageLookupByLibrary.simpleMessage(
      "Váš příspěvek se nepodařilo vytvořit",
    ),
    "postImageFeature": MessageLookupByLibrary.simpleMessage("Funkce obrázku"),
    "postManagement": MessageLookupByLibrary.simpleMessage("Správa příspěvků"),
    "postProduct": MessageLookupByLibrary.simpleMessage("Přidat produkt"),
    ...
    "productAdded": MessageLookupByLibrary.simpleMessage("Produkt byl přidán"),
    "productCreateReview": MessageLookupByLibrary.simpleMessage(
      "Váš produkt se zobrazí po schválení.",
    ),
    ...
    "productNeedAtLeastOneVariation": MessageLookupByLibrary.simpleMessage(
      "Proměnný typ produktu potřebuje alespoň jednu variantu",
    ),
    "productNeedNameAndPrice": MessageLookupByLibrary.simpleMessage(
      "Jednoduchý typ produktu potřebuje název a běžnou cenu",
    ),
    ...
    "productRating": MessageLookupByLibrary.simpleMessage("Vaše hodnocení"),
    ...
    "pullToLoadMore": MessageLookupByLibrary.simpleMessage(
      "Tažením načtěte více",
    ),
    "pullToRefresh": MessageLookupByLibrary.simpleMessage("Tažením obnovíte"),
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Posuňte nahoru pro načtení dalšího obsahu",
    ),
    ...
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Aktuálně jste členem této hodnosti",
    ),
    "rate": MessageLookupByLibrary.simpleMessage("Ohodnotit"),
    ...
    "rateThisAppDescription": MessageLookupByLibrary.simpleMessage(
      "Pokud se vám tato aplikace líbí, věnujte chvilku její ohodnocení!\nOpravdu nám to pomůže a nezabere vám to více než minutu.",
    ),
    "rating": MessageLookupByLibrary.simpleMessage("Hodnocení"),
    "ratingFirst": MessageLookupByLibrary.simpleMessage(
      "Nejprve prosím ohodnoťte před odesláním komentáře",
    ),
    "reOrder": MessageLookupByLibrary.simpleMessage("Přeobjednat"),
    "readReviews": MessageLookupByLibrary.simpleMessage("Přečíst recenze"),
    "readyToPick": MessageLookupByLibrary.simpleMessage(
      "Připraveno k vyzvednutí",
    ),
    "received": MessageLookupByLibrary.simpleMessage("Přijato"),
    ...
    "recentSearches": MessageLookupByLibrary.simpleMessage("Nedávná hledání"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Uplatnit"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Uplatnit body"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage("Uplatnit odměny"),
    "redeemed": MessageLookupByLibrary.simpleMessage("Uplatněno"),
    "refresh": MessageLookupByLibrary.simpleMessage("Obnovit"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Obnovení dokončeno",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Obnovuji..."),
    "refund": MessageLookupByLibrary.simpleMessage("Vrácení peněz"),
    "refundOrderFailed": MessageLookupByLibrary.simpleMessage(
      "Žádost o vrácení peněz za objednávku nebyla úspěšná",
    ),
    ...
    "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
      "Účet nelze synchronizovat. Přihlaste se prosím pro pokračování",
    ),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Zbývající částka k úhradě při dodání",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Pronájem"),
    "requestBooking": MessageLookupByLibrary.simpleMessage(
      "Požádat o rezervaci",
    ),
    "requestTooMany": MessageLookupByLibrary.simpleMessage(
      "Požádali jste o příliš mnoho kódů v krátkém čase. Zkuste to prosím později.",
    ),
    "resend": MessageLookupByLibrary.simpleMessage("Znovu odeslat"),
    "reservePrice": MessageLookupByLibrary.simpleMessage("Vyvolávací cena"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Zpět"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Odměny"),
    "romanian": MessageLookupByLibrary.simpleMessage("Rumunština"),
    "russian": MessageLookupByLibrary.simpleMessage("Ruština"),
    "sale": m48,
    "salePrice": MessageLookupByLibrary.simpleMessage("Akční cena"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "QR skener podporuje pouze vyhledávání produktů",
    ),
    ...
    "seeNewAppConfig": MessageLookupByLibrary.simpleMessage(
      "Pokračujte v prohlížení nového obsahu v aplikaci",
    ),
    ...
    "selectDate": MessageLookupByLibrary.simpleMessage("Vyberte datum"),
    ...
    "selectTheSize": MessageLookupByLibrary.simpleMessage("Vyberte velikost"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Použijte svůj účet Shopify k přihlášení a přístupu ke svým objednávkám, adresám a dalším informacím.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Přihlaste se pomocí zákaznického účtu Shopify",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("Registrovat se"),
    "silver": MessageLookupByLibrary.simpleMessage("Stříbro"),
    "silverPriority": MessageLookupByLibrary.simpleMessage("Stříbrná priorita"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Utraťte alespoň"),
    "startExploring": MessageLookupByLibrary.simpleMessage("Začít objevovat"),
    "startPrice": MessageLookupByLibrary.simpleMessage("Počáteční cena"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Začít nakupovat"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Počáteční nabídka"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Systémová chyba. Kontaktujte prosím podporu.",
    ),
    ...
    "tamil": MessageLookupByLibrary.simpleMessage("tamilština"),
    "tapSelectLocation": MessageLookupByLibrary.simpleMessage(
      "Klepnutím vyberte toto místo",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Zbývající čas"),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Použito"),
    ...
    "variation": MessageLookupByLibrary.simpleMessage("Varianta"),
    ...
    "welcomeRegister": MessageLookupByLibrary.simpleMessage(
      "Začněte s námi svou nákupní cestu",
    ),
    "welcomeUser": m68,
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Vítězná nabídka"),
    ...
    "writeTitle": MessageLookupByLibrary.simpleMessage("Napište svůj titulek"),
    "writeYourNote": MessageLookupByLibrary.simpleMessage(
      "Napište svou poznámku",
    ),
    "yearsAgo": m69,
    "yes": MessageLookupByLibrary.simpleMessage("Ano"),
    "youAreOur": MessageLookupByLibrary.simpleMessage("Jste náš/naše"),
    "youAreSelecting": m70,

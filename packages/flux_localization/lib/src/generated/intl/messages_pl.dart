...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Pomyślnie złożono ofertę na \'${name}\'";

  static String m5(state) => "Adapter Bluetooth jest ${state}";

  static String m6(amount) => "Kup teraz za ${amount}";

  static String m7(author) => "Autor: ${author}";

  static String m8(fieldName) => "Pole ${fieldName} nie może być puste";

  static String m9(fieldName) =>
      "Pole ${fieldName} nie może być krótsze niż 3 znaki";

  static String m10(currency) => "Zmieniono walutę na ${currency}";

  static String m11(number) => "Pozostało znaków: ${number}";
  ...
  static String m14(count) => "${count} elementów";

  static String m15(count) => "${count} produkt";

  static String m16(count) => "${count} produktów";

  static String m17(country) => "Kraj ${country} nie jest obsługiwany";

  static String m18(currency) => "${currency} nie jest obsługiwana";

  static String m19(day) => "${day} dni temu";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Kończy się za ${timeLeft}";

  static String m22(captcha) => "Wpisz ${captcha}, aby potwierdzić:";

  static String m23(message) => "Błąd: ${message}";

  static String m24(message) => "Błąd: ${message}";

  static String m25(time) => "Wygasa za ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "${hour} godz. temu";
  ...
  static String m31(size) => "Maksymalny rozmiar pliku: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Minimalna kwota zamówienia dla ${storeName} wynosi ${minOrderAmount}. Proszę dodać jeszcze kilka pozycji z tego sklepu!";

  static String m35(amount) =>
      "Ten kupon wymaga zakupu za minimalną kwotę ${amount}.";

  static String m36(value) => "Minimalna transakcja: ${value}";

  static String m37(minute) => "${minute} min temu";

  static String m38(month) => "${month} miesięcy temu";

  static String m39(store) => "Więcej od ${store}";

  static String m40(number) => "Musi być kupowane w grupach po ${number}";

  static String m41(itemCount) => "${itemCount} elementów";

  static String m42(price) => "Suma opcji: ${price}";

  static String m43(amount) => "Zapłać ${amount}";

  static String m44(name) => "Produkt ${name} został dodany do koszyka";

  static String m45(total) => "Ilość: ${total}";

  static String m46(name) => "Otrzymano środki od ${name}";

  static String m47(count) =>
      "Czy chcesz usunąć ${count} pozycji z listy życzeń?";

  static String m48(percent) => "Wyprzedaż ${percent}%";

  static String m49(keyword) => "Wyniki wyszukiwania dla: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} element)";

  static String m51(keyword, count) => "${keyword} (${count} elementów)";

  static String m52(second) => "${second} sekund temu";

  static String m53(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycji";

  static String m54(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m56(total) => "${total} produktów";

  static String m57(name) => "Przelej pieniądze do ${name}";

  static String m58(amount) => "Użyj ${amount} punktów";
  ...
  static String m60(time) => "Ważne do: ${time}";

  static String m61(date) => "Ważne do ${date}";

  static String m62(number) => "Wersja ${number}";

  static String m63(balance) => "Saldo portfela: ${balance}";

  static String m64(message) => "Ostrzeżenie: ${message}";
  ...
  static String m66(length) => "Znaleźliśmy ${length} produktów";

  static String m67(week) => "Tydzień ${week}";

  static String m68(name) => "Witaj ${name}";

  static String m69(year) => "${year} lat temu";

  static String m70(count) => "Wybierasz ${count} produktów";

  static String m71(total) => "Przypisano do zamówienia nr ${total}";

  static String m72(type) => "Zdałeś ${type}";

  static String m73(point) => "Masz ${point} punktów";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "add": MessageLookupByLibrary.simpleMessage("Dodać"),
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Dodaj punkty"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Kwota zaliczki"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Zapłata z góry"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Kwota przekracza dostępne punkty",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Przepraszamy, wizyty nie mogą rozpocząć się w tym dniu.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Czy na pewno chcesz zwrócić to zamówienie?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Aukcja"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Daty aukcji"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Aukcja zakończona"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Aukcja zakończona"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("Historia aukcji"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Rozpoczęcie aukcji"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "Aukcja rozpoczyna się za",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Typ aukcji"),
    ...
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage("Zmień rolę"),
    "benefits": MessageLookupByLibrary.simpleMessage("Korzyści"),
    "bengali": MessageLookupByLibrary.simpleMessage("bengalski"),
    "bid": MessageLookupByLibrary.simpleMessage("Oferta"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Podwyżka oferty"),
    ...
    "bronze": MessageLookupByLibrary.simpleMessage("Brązowy"),
    "bronzePriority": MessageLookupByLibrary.simpleMessage("Priorytet brązowy"),
    "burmese": MessageLookupByLibrary.simpleMessage("Birmański"),
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("Kup teraz cena"),
    ...
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Twoja prośba o anulowanie została pomyślnie wysłana!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Koszyk jest niedostępny. Proszę dodać kilka pozycji do koszyka.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Twój koszyk jest nadal przetwarzany. Proszę chwilę poczekać.",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Prawo"),
    "claimed": MessageLookupByLibrary.simpleMessage("Przejęte"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Ogłoszenia"),
    ...
    "couponsDedicatedForYou": MessageLookupByLibrary.simpleMessage(
      "Kupony dedykowane dla Ciebie",
    ),
    "couponsManagement": MessageLookupByLibrary.simpleMessage(
      "Zarządzanie kuponami",
    ),
    "create": MessageLookupByLibrary.simpleMessage("Tworzyć"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Obecna oferta"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ta rola użytkownika pozwala dokonywać rezerwacji, wysyłać prywatne wiadomości do innych użytkowników oraz oceniać ogłoszenia.",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Podziel się swoimi przemyśleniami o produkcie, aby pomóc innym kupującym.",
    ),
    ...
    "gold": MessageLookupByLibrary.simpleMessage("Złoto"),
    "goldPriority": MessageLookupByLibrary.simpleMessage("Złoty priorytet"),
    "good": MessageLookupByLibrary.simpleMessage("Dobry"),
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "Uwierzytelnienie nie powiodło się. Zaloguj się ponownie.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Coś poszło nie tak podczas próby wykonania tej czynności. Sprawdź jeszcze raz",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Podano nieprawidłowe dane. Sprawdź swoje dane wejściowe.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddress": MessageLookupByLibrary.simpleMessage(
      "Proszę wpisać prawidłowy adres",
    ),
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Proszę wpisać pełny adres z nazwą ulicy i numerem domu",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "Proszę wpisać prawidłową nazwę miasta",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Proszę wpisać prawidłową nazwę miasta bez znaków specjalnych",
    ),
    ...
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Zeskanowany kod QR jest nieprawidłowy. Sprawdź i spróbuj ponownie.",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("Stan przedmiotu"),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("nowy"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Moje kupony"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Mój kod QR"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Podaj ten kod personelowi, aby",
    ),
    ...
    "noNotification": MessageLookupByLibrary.simpleMessage("Brak powiadomień"),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Brak oczekujących zamówień do dostarczenia",
    ),
    ...
    "normal": MessageLookupByLibrary.simpleMessage("Normalna"),
    ...
    "noteOptional": MessageLookupByLibrary.simpleMessage("Uwaga (opcjonalnie)"),
    ...
    "owner": MessageLookupByLibrary.simpleMessage("Właściciel"),
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ta rola użytkownika pozwala dodawać ogłoszenia i usługi rezerwacyjne oraz nimi zarządzać. Właściciele nie mogą oceniać innych ogłoszeń.",
    ),
    ...
    "pickVoucherToApply": MessageLookupByLibrary.simpleMessage(
      "Wybierz kupon, który chcesz zastosować.",
    ),
    ...
    "platinum": MessageLookupByLibrary.simpleMessage("Platyna"),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Historia punktów"),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Pociągnij w górę, aby załadować więcej",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Szczegóły rangi"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Aktualnie jesteś członkiem tej rangi",
    ),
    ...
    "received": MessageLookupByLibrary.simpleMessage("Otrzymane"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("odkupić"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Wymień punkty"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage("Odbierz nagrody"),
    "redeemed": MessageLookupByLibrary.simpleMessage("Odkupiony"),
    "refresh": MessageLookupByLibrary.simpleMessage("Odśwież"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Odświeżanie zakończone",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Orzeźwiający..."),
    ...
    "releaseToRefresh": MessageLookupByLibrary.simpleMessage(
      "Zwolnij, aby odświeżyć",
    ),
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Pozostała kwota do zapłaty przy odbiorze",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Wynajem"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Cena rezerwowa"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Odwracać"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Nagrody"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "Skaner QR obsługuje tylko wyszukiwanie produktów",
    ),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Użyj swojego konta Shopify, aby zalogować się i uzyskać dostęp do swoich zamówień, adresów itp.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Zaloguj się za pomocą konta klienta Shopify",
    ),
    ...
    "silverPriority": MessageLookupByLibrary.simpleMessage("Priorytet Srebrny"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Wydaj co najmniej"),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Rozpocznij przeglądanie",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Cena początkowa"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Rozpocznij zakupy"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Oferta wywoławcza"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Błąd systemu. Skontaktuj się z pomocą techniczną.",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Pozostały czas"),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Używany"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Wygrywająca oferta"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Jesteś naszym"),
    "youAreSelecting": m70,

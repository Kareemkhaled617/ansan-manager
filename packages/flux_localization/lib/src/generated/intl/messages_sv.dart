...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Lyckades lägga ett bud på \'${name}\'";

  static String m5(state) => "Bluetooth-adapter är ${state}";

  static String m6(amount) => "Köp nu för ${amount}";

  static String m7(author) => "Av: ${author}";

  static String m8(fieldName) => "${fieldName} får inte vara tomt.";

  static String m9(fieldName) =>
      "${fieldName} får inte vara kortare än 3 tecken.";

  static String m10(currency) => "Ändrade valuta till ${currency}";

  static String m11(number) => "${number} tecken kvar";
  ...
  static String m16(count) => "${count} artiklar";

  static String m17(country) => "${country} stöds inte";

  static String m18(currency) => "${currency} stöds inte";

  static String m19(day) => "${day} dagar sedan";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Slutar om ${timeLeft}";

  static String m22(captcha) => "Ange ${captcha} för att bekräfta:";

  static String m23(message) => "Fel: ${message}";

  static String m24(message) => "Fel: ${message}";

  static String m25(time) => "Går ut om ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "${hour} timmar sedan";
  ...
  static String m31(size) => "Maximal filstorlek: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Minsta orderbelopp för ${storeName} är ${minOrderAmount}. Vänligen lägg till några fler varor från den här butiken!";

  static String m35(amount) =>
      "Denna kupong kräver ett köp på minst ${amount}.";

  static String m36(value) => "Minsta transaktion: ${value}";

  static String m37(minute) => "För ${minute} minuter sedan";

  static String m38(month) => "För ${month} månader sedan";

  static String m39(store) => "Mer från ${store}";

  static String m40(number) => "Måste köpas i grupper om ${number}";

  static String m41(itemCount) => "${itemCount} artiklar";

  static String m42(price) => "Totalt antal alternativ: ${price}";

  static String m43(amount) => "Betala ${amount}";

  static String m44(name) => "${name} har lagts till i kundvagnen";

  static String m45(total) => "Antal: ${total}";

  static String m46(name) => "Tog emot pengar från ${name}";

  static String m47(count) =>
      "Vill du ta bort ${count} artikel/artiklar från din önskelista?";

  static String m48(percent) => "Rea ${percent}%";

  static String m49(keyword) => "Sökresultat för: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} objekt)";

  static String m51(keyword, count) => "${keyword} (${count} objekt)";

  static String m52(second) => "För ${second} sekunder sedan";

  static String m53(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m54(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m56(total) => "${total} produkter";

  static String m57(name) => "Överför pengar till ${name}";

  static String m58(amount) => "Använd ${amount} poäng";
  ...
  static String m60(time) => "Giltig till: ${time}";

  static String m61(date) => "Giltig till ${date}";

  static String m62(number) => "Version ${number}";

  static String m63(balance) => "Plånbokssaldo: ${balance}";

  static String m64(message) => "Varning: ${message}";
  ...
  static String m66(length) => "Vi hittade ${length} produkter";

  static String m67(week) => "Vecka ${week}";

  static String m68(name) => "Välkommen ${name}";

  static String m69(year) => "För ${year} år sedan";

  static String m70(count) => "Du väljer ${count} artikel/artiklar";

  static String m71(total) => "Du har tilldelats order nr${total}";

  static String m72(type) => "Du har klarat ${type}";

  static String m73(point) => "Du har ${point} poäng";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Lägg till poäng"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Förskottsbelopp"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Beloppet överstiger tillgängliga poäng",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Tyvärr kan inte möten starta denna dag.",
    ),
    ...
    "areYouSureCancelOrder": MessageLookupByLibrary.simpleMessage(
      "Är du säker på att du vill avboka denna beställning?",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Är du säker på att du vill återbetala denna beställning?",
    ),
    ...
    "auctionDates": MessageLookupByLibrary.simpleMessage("Auktionsdatum"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Auktionen avslutad"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Auktionen avslutas"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("Auktionshistorik"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Auktionen börjar"),
    ...
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("Bli en ägare"),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Byt till en annan roll",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Fördelar"),
    "bengali": MessageLookupByLibrary.simpleMessage("bengali"),
    "bid": MessageLookupByLibrary.simpleMessage("Bud"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Budökning"),
    ...
    "bronze": MessageLookupByLibrary.simpleMessage("Brons"),
    "bronzePriority": MessageLookupByLibrary.simpleMessage("Bronsprioritet"),
    "burmese": MessageLookupByLibrary.simpleMessage("Burmesiska"),
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("Köp det nu pris"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "Avbokningsförfrågan misslyckades",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Din avbokningsförfrågan har skickats in!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Varukorgen är inte tillgänglig. Lägg till några varor i din varukorg.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Din varukorg bearbetas fortfarande. Vänta en stund.",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Krav"),
    "claimed": MessageLookupByLibrary.simpleMessage("Påstod"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Annonser"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Nuvarande bud"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Denna användarroll tillåter att göra bokningar, skicka privata meddelanden till andra användare och recensera annonser.",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Dela fler tankar om produkten för att hjälpa andra köpare.",
    ),
    ...
    "event": MessageLookupByLibrary.simpleMessage("Evenemang"),
    ...
    "feature": MessageLookupByLibrary.simpleMessage("Särdrag"),
    ...
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "Autentiseringen misslyckades. Vänligen logga in igen.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Något gick fel när jag försökte utföra den här åtgärden. Kontrollera noga.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Ogiltig data har angetts. Kontrollera dina inmatningar.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Ange en fullständig adress med gatunamn och nummer",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt stadsnamn",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt stadsnamn utan specialtecken",
    ),
    ...
    "invalidCountryCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Välj en giltig landskod från listan",
    ),
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt e-postadressformat (t.ex. exempel@domän.com)",
    ),
    "invalidPhone": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt telefonnummer",
    ),
    "invalidPhoneFormat": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt telefonnummerformat",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt postnummerformat för ditt land",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Ange en giltig provins/delstat",
    ),
    "invalidProvinceFormat": MessageLookupByLibrary.simpleMessage(
      "Ange ett giltigt provins-/delstatsnamn",
    ),
    "invalidQRCode": MessageLookupByLibrary.simpleMessage("Ogiltig QR-kod"),
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Den skannade QR-koden är ogiltig. Kontrollera och försök igen.",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("Artikelns skick"),
    ...
    "logoutSuccess": MessageLookupByLibrary.simpleMessage("Logga ut"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Mina kuponger"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Min QR-kod"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Ge denna kod till personalen",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Kontrollera ditt nätverk noggrant",
    ),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Anslutningstiden över. Försök igen.",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Inga väntande beställningar att leverera",
    ),
    ...
    "normal": MessageLookupByLibrary.simpleMessage("Vanligt"),
    ...
    "noteOptional": MessageLookupByLibrary.simpleMessage("Obs (valfritt)"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Denna användarroll tillåter att lägga till annonser och bokningstjänster samt hantera dem. Ägare kan inte recensera andra annonser.",
    ),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Poänghistorik"),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Rankdetaljer"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Du är för närvarande medlem i denna rangordning",
    ),
    ...
    "received": MessageLookupByLibrary.simpleMessage("Mottagen"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("återlösa"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Lös in poäng"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage("Lös in belöningar"),
    "redeemed": MessageLookupByLibrary.simpleMessage("Inlöst"),
    "refresh": MessageLookupByLibrary.simpleMessage("Uppdatera"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Uppdatering klar",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Uppfriskande..."),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Återstående belopp att betala vid leverans",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Uthyrning"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Reserveringspris"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Motsatt"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Belöningar"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "QR-skannern stöder endast produktsökning",
    ),
    ...
    "service": MessageLookupByLibrary.simpleMessage("Tjänst"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Använd ditt Shopify-konto för att logga in och komma åt dina beställningar, adresser och mer.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Logga in med Shopify-kundkonto",
    ),
    ...
    "silverPriority": MessageLookupByLibrary.simpleMessage("Silverprioritet"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Spendera minst"),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Tid kvar"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Något gick fel, ett okänt fel har uppstått",
    ),
    "unnamedLocation": MessageLookupByLibrary.simpleMessage("Namnlös plats"),
    "unpaid": MessageLookupByLibrary.simpleMessage("Obetald"),
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Tjäna mer"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "poäng för att klättra upp i den här rankningen.",
    ),
    ...
    "updateUserFailed": MessageLookupByLibrary.simpleMessage(
      "Uppdatering av användare misslyckades",
    ),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Begagnade"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Vinnande budgivning"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Du är vår"),
    "youAreSelecting": m70,

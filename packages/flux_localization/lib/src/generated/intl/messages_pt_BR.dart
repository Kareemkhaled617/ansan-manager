...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(point) => "Seus pontos disponíveis: ${point}";

  static String m4(name) => "Lance realizado com sucesso para \'${name}\'";

  static String m5(state) => "Adaptador Bluetooth: ${state}";

  static String m6(amount) => "Compre agora por ${amount}";

  static String m7(author) => "Por: ${author}";

  static String m8(fieldName) => "${fieldName} não pode ficar vazio";
  ...
  static String m22(captcha) => "Digite ${captcha} para confirmar:";

  static String m23(message) => "Erro: ${message}";

  static String m24(message) => "Erro: ${message}";

  static String m25(time) => "Expira em ${time}";
  ...
  static String m31(size) => "Tamanho máximo do arquivo: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "It appears that the text to be translated is missing. Please provide the text you would like translated to Portuguese (Brazil).";

  static String m35(amount) =>
      "Claro! No entanto, você não incluiu nenhum texto entre aspas para ser traduzido. Por favor, envie o texto que deseja traduzir.";

  static String m36(value) =>
      "It appears you haven\'t included any text to be translated. Please provide the text you want translated to Portuguese (Brazil).";
  ...
  static String m42(price) => "Total de opções: ${price}";
  ...
  static String m48(percent) => "${percent}% de desconto";
  ...
  static String m58(amount) => "Usar ${amount} pontos";
  ...
  static String m66(length) => "Encontramos ${length} produtos";

  static String m67(week) => "Semana ${week}";

  static String m68(name) => "Bem-vindo(a), ${name}";

  static String m69(year) => "${year} anos atrás";

  static String m70(count) => "Você está selecionando ${count} item(ns)";

  static String m71(total) => "Você foi atribuído ao pedido #${total}";

  static String m72(type) =>
      "It appears you did not include any text to translate. Please provide the text you would like translated to Portuguese (Brazil).";

  static String m73(point) => "Você tem ${point} pontos";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addNewPost": MessageLookupByLibrary.simpleMessage("Criar nova postagem"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Valor antecipado"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "O valor excede os pontos disponíveis",
    ),
    "anyAttr": m2,
    "appTrackingRequest": MessageLookupByLibrary.simpleMessage(
      "Este identificador será usado para entregar anúncios personalizados para você.  \n\"Cancelar\" limitará a capacidade da rede de anúncios de fornecer anúncios relevantes para você, mas não reduzirá a quantidade de anúncios que você recebe.  \nComo o dispositivo está restrito, o rastreamento está desabilitado e o sistema não pode exibir uma caixa de diálogo de solicitação. Que tal tocar em \"Abrir configurações\" e permitir que o aplicativo rastreie sua atividade em aplicativos e sites de outras empresas?",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Tem certeza de que deseja reembolsar este pedido?",
    ),
    ...
    "availablePoints": m3,
    "averageRating": MessageLookupByLibrary.simpleMessage("Avaliação média"),
    ...
    "branchChangeWarning": MessageLookupByLibrary.simpleMessage(
      "Desculpe, o carrinho será esvaziado devido à mudança de região. Ficaremos felizes em ajudá-lo caso precise de assistência.",
    ),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "A solicitação de cancelamento não foi bem-sucedida",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "O carrinho não está disponível. Adicione alguns itens ao seu carrinho.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Seu carrinho ainda está sendo processado. Por favor, aguarde um momento.",
    ),
    ...
    "chooseStaff": MessageLookupByLibrary.simpleMessage("Escolher funcionário"),
    ...
    "classifieds": MessageLookupByLibrary.simpleMessage("Classificados"),
    ...
    "commentFailed": MessageLookupByLibrary.simpleMessage("Falha ao comentar!"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Esta função permite fazer reservas, enviar mensagens privadas para outros usuários e avaliar anúncios.",
    ),
    ...
    "doYouWantToLogout": MessageLookupByLibrary.simpleMessage("Deseja sair?"),
    ...
    "downloadApp": MessageLookupByLibrary.simpleMessage("Baixar aplicativo"),
    ...
    "enableForLogin": MessageLookupByLibrary.simpleMessage("Ativar para login"),
    ...
    "enterAmount": MessageLookupByLibrary.simpleMessage("Insira o valor"),
    "enterCaptcha": m22,
    ...
    "enterYourNote": MessageLookupByLibrary.simpleMessage("Insira sua nota"),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Compartilhe mais opiniões sobre o produto para ajudar outros compradores.",
    ),
    ...
    "errorOnGettingPost": MessageLookupByLibrary.simpleMessage(
      "Erro ao recuperar a publicação!",
    ),
    ...
    "extraServices": MessageLookupByLibrary.simpleMessage("Serviços extras"),
    "failToAssign": MessageLookupByLibrary.simpleMessage(
      "Falha ao atribuir usuário",
    ),
    ...
    "feature": MessageLookupByLibrary.simpleMessage("recurso"),
    ...
    "generatingLink": MessageLookupByLibrary.simpleMessage("Gerando link..."),
    "german": MessageLookupByLibrary.simpleMessage("Alemão"),
    "getNotification": MessageLookupByLibrary.simpleMessage(
      "Receber notificações",
    ),
    "getNotified": MessageLookupByLibrary.simpleMessage("Receba notificações!"),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Algo deu errado ao tentar executar esta ação. Por favor, verifique novamente.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Dados fornecidos inválidos. Verifique sua entrada.",
    ),
    "greaterDistance": m26,
    ...
    "imageFeature": MessageLookupByLibrary.simpleMessage("Imagem em destaque"),
    ...
    "installDigitsPlugin": MessageLookupByLibrary.simpleMessage(
      "Por favor, instale o plugin DIGITS: Cadastro e Login com Número de Celular no WordPress",
    ),
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira um endereço completo com nome da rua e número",
    ),
    ...
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira um nome de cidade válido sem caracteres especiais",
    ),
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "Insira um formato de e-mail válido (por exemplo, example@domain.com)",
    ),
    "invalidPhone": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira um número de telefone válido",
    ),
    "invalidPhoneFormat": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira um formato de número de telefone válido",
    ),
    ...
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "It appears you haven\'t provided any text to translate. Please provide the text you\'d like translated, and I\'ll be happy to help!",
    ),
    ...
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "O código QR escaneado não é válido. Por favor, verifique e tente novamente.",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre as aspas para ser traduzido. Por favor, envie o texto que deseja traduzir e ficarei feliz em ajudar!",
    ),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage(
      "It appears that there is no text between the quotation marks for me to translate. Please provide the text you would like translated, and I’ll be happy to assist!",
    ),
    "loading": MessageLookupByLibrary.simpleMessage("Carregando..."),
    "loadingLink": MessageLookupByLibrary.simpleMessage("Carregando link..."),
    ...
    "loginCanceled": MessageLookupByLibrary.simpleMessage("Login cancelado"),
    ...
    "loginRequired": MessageLookupByLibrary.simpleMessage("Login necessário"),
    ...
    "logoutSuccess": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre aspas para ser traduzido. Por favor, forneça o texto que deseja traduzir.",
    ),
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre aspas para ser traduzido. Por favor, envie o texto que deseja traduzir.",
    ),
    "malay": MessageLookupByLibrary.simpleMessage("Malaio"),
    "manCollections": MessageLookupByLibrary.simpleMessage("Coleção Masculina"),
    "manageApiKey": MessageLookupByLibrary.simpleMessage("Gerenciar chave API"),
    ...
    "mobileNumberIsNotRegistered": MessageLookupByLibrary.simpleMessage(
      "O número de telefone não está cadastrado!",
    ),
    ...
    "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
        MessageLookupByLibrary.simpleMessage(
          "Você está tentando adicionar um produto de um novo vendedor ao seu carrinho. Lembre-se de que só é possível comprar de um vendedor por vez.",
        ),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre as aspas para ser traduzido. Por favor, envie o texto que deseja traduzir.",
    ),
    ...
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não inseriu nenhum texto entre aspas para ser traduzido. Por favor, envie o texto que deseja traduzir.",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "It appears that the text to be translated is missing. Please provide the text you would like me to translate.",
    ),
    "networkServerError": MessageLookupByLibrary.simpleMessage(
      "It appears that you did not include any text to be translated. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre aspas para traduzir. Por favor, forneça o texto que deseja traduzir.",
    ),
    ...
    "noteOptional": MessageLookupByLibrary.simpleMessage(
      "Claro! Porém, você não incluiu nenhum texto entre as aspas para eu traduzir. Por favor, envie o texto que deseja traduzir.",
    ),
    ...
    "orderNotes": MessageLookupByLibrary.simpleMessage("Observações do pedido"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Esta função permite adicionar anúncios, serviços de reserva e gerenciá-los. Proprietários não podem avaliar outros anúncios.",
    ),
    "pageView": MessageLookupByLibrary.simpleMessage("Visualização de página"),
    "paid": MessageLookupByLibrary.simpleMessage("Pago"),
    "paidStatus": MessageLookupByLibrary.simpleMessage("Status do pagamento"),
    ...
    "platinum": MessageLookupByLibrary.simpleMessage(
      "It appears you did not include any text to be translated. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    ...
    "pleaseFillCode": MessageLookupByLibrary.simpleMessage("Digite seu código"),
    ...
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "It appears you haven\'t provided any text to be translated. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    ...
    "pointsRedeemedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre as aspas para ser traduzido. Por favor, forneça o texto que deseja traduzir.",
    ),
    ...
    "promptPayType": MessageLookupByLibrary.simpleMessage("Tipo do PromptPay:"),
    ...
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre as aspas. Por favor, forneça o texto que deseja traduzir.",
    ),
    "rate": MessageLookupByLibrary.simpleMessage("Avaliar"),
    "rateProduct": MessageLookupByLibrary.simpleMessage("Avaliar produto"),
    "rateTheApp": MessageLookupByLibrary.simpleMessage("Avaliar o aplicativo"),
    ...
    "readyToPick": MessageLookupByLibrary.simpleMessage("Pronto para retirada"),
    ...
    "recentView": MessageLookupByLibrary.simpleMessage("Vistos recentemente"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre aspas para ser traduzido. Por favor, forneça o texto que deseja traduzir para o português (Brasil).",
    ),
    ...
    "redeemed": MessageLookupByLibrary.simpleMessage(
      "It appears you haven\'t provided any text to translate. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    "refresh": MessageLookupByLibrary.simpleMessage("Atualizar"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre as aspas para ser traduzido. Por favor, envie o texto que deseja traduzir e terei prazer em ajudar!",
    ),
    ...
    "registerFailed": MessageLookupByLibrary.simpleMessage("Falha no registro"),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "It appears that you haven\'t provided any text to translate. Please provide the text you want translated, and I\'ll be happy to help!",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Aluguel"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage(
      "It appears that you haven\'t provided any text to translate. Please provide the text you\'d like translated into Portuguese (Brazil).",
    ),
    ...
    "saveForLater": MessageLookupByLibrary.simpleMessage("Salvar para depois"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "O Leitor de QR suporta apenas a busca de produtos",
    ),
    ...
    "selectVoucher": MessageLookupByLibrary.simpleMessage("Selecionar cupom"),
    ...
    "shortDescription": MessageLookupByLibrary.simpleMessage("Descrição curta"),
    ...
    "silver": MessageLookupByLibrary.simpleMessage(
      "Claro! No entanto, você não incluiu nenhum texto entre as aspas para eu traduzir. Por favor, envie o texto que deseja traduzir para o português (Brasil).",
    ),
    ...
    "sortCode": MessageLookupByLibrary.simpleMessage("Código de classificação"),
    ...
    "startShopping": MessageLookupByLibrary.simpleMessage("Começar a comprar"),
    ...
    "totalAmount": MessageLookupByLibrary.simpleMessage(
      "It appears that there is no text between the quotation marks for me to translate. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    ...
    "unblockUser": MessageLookupByLibrary.simpleMessage("Desbloquear usuário"),
    "undo": MessageLookupByLibrary.simpleMessage("Desfazer"),
    "unexpectedError": MessageLookupByLibrary.simpleMessage(
      "It appears that the text to be translated is missing. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "It appears that you did not provide any text to be translated. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    ...
    "upRankNote1": MessageLookupByLibrary.simpleMessage(
      "It appears that the text to be translated is missing. Please provide the text you would like translated.",
    ),
    ...
    "updateInfo": MessageLookupByLibrary.simpleMessage("Atualizar informações"),
    "updatePassword": MessageLookupByLibrary.simpleMessage("Atualizar senha"),
    "updateStatus": MessageLookupByLibrary.simpleMessage("Atualizar status"),
    "updateSuccess": MessageLookupByLibrary.simpleMessage(
      "Atualização realizada com sucesso!",
    ),
    "updateUserFailed": MessageLookupByLibrary.simpleMessage(
      "It appears that your message does not contain any text to translate. Please provide the text you would like translated to Portuguese (Brazil).",
    ),
    ...
    "website": MessageLookupByLibrary.simpleMessage("Site"),
    ...
    "withdrawAmount": MessageLookupByLibrary.simpleMessage("Valor do saque"),
    ...
    "yourProductIsUnderReview": MessageLookupByLibrary.simpleMessage(
      "Seu produto está em análise",
    ),
    "yourUsernameEmail": MessageLookupByLibrary.simpleMessage(
      "Seu usuário ou e-mail",
    ),

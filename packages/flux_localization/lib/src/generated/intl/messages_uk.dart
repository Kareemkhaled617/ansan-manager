...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Ставку на \'${name}\' успішно зроблено";
  ...
  static String m10(currency) => "Валюта змінена на ${currency}";
  ...
  static String m29(message) =>
      "Виникла проблема з додатком під час запиту даних. Зверніться до адміністратора для вирішення проблеми: ${message}";

  static String m30(currency, amount) =>
      "Максимальна сума для цього способу оплати — ${currency} ${amount}";
  ...
  static String m33(currency, amount) =>
      "Мінімальна сума для цього способу оплати — ${currency} ${amount}";
  ...
  static String m55(fieldName) => "Поле ${fieldName} є обов\'язковим";

  static String m56(total) => "${total} товарів";

  static String m57(name) => "Переказати кошти ${name}";

  static String m58(amount) => "Використати ${amount} балів";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addOrUsePointsSuccessMsg": MessageLookupByLibrary.simpleMessage(
      "Щиро вітаємо! Бали успішно додано або використано.",
    ),
    ...
    "appTrackingTransparency": MessageLookupByLibrary.simpleMessage(
      "Прозорість відстеження додатків",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Ви впевнені, що хочете повернути кошти за це замовлення?",
    ),
    ...
    "becomeADelivery": MessageLookupByLibrary.simpleMessage("Стати кур\'єром"),
    "becomeAVendor": MessageLookupByLibrary.simpleMessage("Стати продавцем"),
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("Стати власником"),
    ...
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Крок ставки"),
    ...
    "canNotGetPayments": MessageLookupByLibrary.simpleMessage(
      "Не вдалося отримати способи оплати",
    ),
    "canNotGetShipping": MessageLookupByLibrary.simpleMessage(
      "Не вдалося отримати способи доставки",
    ),
    "canNotGetToken": MessageLookupByLibrary.simpleMessage(
      "Не вдалося отримати інформацію про токен",
    ),
    ...
    "canNotSaveOrder": MessageLookupByLibrary.simpleMessage(
      "Не вдалося зберегти замовлення на веб-сайті",
    ),
    "canNotUpdateInfo": MessageLookupByLibrary.simpleMessage(
      "Не вдалося оновити інформацію користувача",
    ),
    ...
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Ваш запит на скасування успішно надіслано!",
    ),
    ...
    "classifieds": MessageLookupByLibrary.simpleMessage("Оголошення"),
    ...
    "createReviewSuccessMsg": MessageLookupByLibrary.simpleMessage(
      "Щиро вдячні за ваш відгук і цінуємо ваш внесок у покращення нашого сервісу",
    ),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ця роль дозволяє бронювати, надсилати приватні повідомлення іншим користувачам і залишати відгуки про оголошення.",
    ),
    ...
    "doesNotSupportApplePay": MessageLookupByLibrary.simpleMessage(
      "ApplePay не підтримується. Перевірте свій гаманець і картку",
    ),
    ...
    "driverAssigned": MessageLookupByLibrary.simpleMessage("Водія призначено"),
    ...
    "emptyShippingMsg": MessageLookupByLibrary.simpleMessage(
      "Варіанти доставки відсутні. Переконайтеся, що вашу адресу введено правильно, або зв\'яжіться з нами, якщо потрібна допомога",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Поділіться своїми враженнями про продукт, щоб допомогти іншим покупцям.",
    ),
    ...
    "event": MessageLookupByLibrary.simpleMessage("Подія"),
    ...
    "expiringInTime": m25,
    "exploreNow": MessageLookupByLibrary.simpleMessage("Досліджуйте зараз"),
    ...
    "failedToLoadAppConfig": MessageLookupByLibrary.simpleMessage(
      "Не вдалося завантажити конфігурацію додатку. Спробуйте ще раз або перезапустіть додаток",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Щось пішло не так під час виконання цієї дії. Будь ласка, перевірте ще раз.",
    ),
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, введіть дійсний формат електронної пошти (наприклад, example@domain.com)",
    ),
    ...
    "invalidQRCode": MessageLookupByLibrary.simpleMessage("Недійсний QR-код"),
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Відсканований QR-код недійсний. Перевірте його та спробуйте ще раз.",
    ),
    ...
    "manageStock": MessageLookupByLibrary.simpleMessage("Керування запасами"),
    ...
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Покажіть цей код співробітникам, щоб",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, перевірте своє підключення до мережі ще раз",
    ),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Час очікування з’єднання вичерпано. Спробуйте ще раз.",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Немає замовлень, що очікують на доставку",
    ),
    "noPermissionForCurrentRole": MessageLookupByLibrary.simpleMessage(
      "На жаль, цей товар недоступний для вашої поточної ролі",
    ),
    "noPermissionToViewProduct": MessageLookupByLibrary.simpleMessage(
      "Цей товар доступний лише для користувачів із певними ролями. Увійдіть з відповідними обліковими даними для доступу до цього товару або зв\'яжіться з нами для додаткової інформації",
    ),
    "noPermissionToViewProductMsg": MessageLookupByLibrary.simpleMessage(
      "Увійдіть з відповідними обліковими даними для доступу до цього товару або зв\'яжіться з нами для додаткової інформації",
    ),
    ...
    "normal": MessageLookupByLibrary.simpleMessage("звичайний"),
    ...
    "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
      "Ви можете перевірити стан свого замовлення за допомогою нашої функції відстеження доставки. Ви отримаєте електронного листа з підтвердженням замовлення, деталями та посиланням для відстеження виконання.",
    ),
    "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
      "Ви можете увійти до свого облікового запису, використовуючи електронну пошту та пароль, які були вказані раніше. У своєму профілі ви можете редагувати дані, переглядати історію транзакцій, змінювати підписку на розсилку.",
    ),
    ...
    "owner": MessageLookupByLibrary.simpleMessage("Власник"),
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ця роль дозволяє додавати оголошення та послуги з бронювання й керувати ними. Власники не можуть залишати відгуки про інші оголошення.",
    ),
    ...
    "placeMyOrder": MessageLookupByLibrary.simpleMessage("Оформити замовлення"),
    ...
    "pleaseIncreaseOrDecreaseTheQuantity": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, збільшіть або зменшіть кількість, щоб продовжити",
    ),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Історія балів"),
    ...
    "pointRewardMessage": MessageLookupByLibrary.simpleMessage(
      "Є правило знижки для використання балів у кошику",
    ),
    "points": MessageLookupByLibrary.simpleMessage("Бали"),
    ...
    "pointsRedeemedMsg": MessageLookupByLibrary.simpleMessage(
      "Бали списано з облікового запису користувача.",
    ),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Потягніть вгору, щоб завантажити більше",
    ),
    ...
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Зараз ви є учасником цього рангу",
    ),
    ...
    "rateThisApp": MessageLookupByLibrary.simpleMessage("Оцініть цей додаток"),
    "rateThisAppDescription": MessageLookupByLibrary.simpleMessage(
      "Якщо вам подобається цей додаток, будь ласка, оцініть його!\nЦе дійсно допоможе нам і не займе більше хвилини.",
    ),
    "rating": MessageLookupByLibrary.simpleMessage("Рейтинг"),
    "ratingFirst": MessageLookupByLibrary.simpleMessage(
      "Оцініть перед тим, як залишити коментар",
    ),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Використати"),
    ...
    "redeemed": MessageLookupByLibrary.simpleMessage("Використано"),
    "refresh": MessageLookupByLibrary.simpleMessage("Оновити"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Оновлення завершено",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Оновлення..."),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Оренда"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("ЗВОРОТНІЙ"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Винагороди"),
    ...
    "scanPoints": MessageLookupByLibrary.simpleMessage("Сканувати точки"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "QR-сканер підтримує лише пошук товарів",
    ),
    ...
    "seeNewAppConfig": MessageLookupByLibrary.simpleMessage(
      "Продовжуйте переглядати новий вміст у своєму додатку",
    ),
    ...
    "selectStore": MessageLookupByLibrary.simpleMessage("Оберіть магазин"),
    "selectTheColor": MessageLookupByLibrary.simpleMessage("Виберіть колір"),
    "selectTheFile": MessageLookupByLibrary.simpleMessage("Оберіть файл"),
    ...
    "selectVoucher": MessageLookupByLibrary.simpleMessage("Оберіть ваучер"),
    ...
    "sessionExpired": MessageLookupByLibrary.simpleMessage("Сеанс завершено"),
    ...
    "shopOrders": MessageLookupByLibrary.simpleMessage("Замовлення магазину"),
    ...
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Увійти через обліковий запис клієнта Shopify",
    ),
    ...
    "smsCodeExpired": MessageLookupByLibrary.simpleMessage(
      "Термін дії SMS-коду закінчився. Надішліть код підтвердження ще раз, щоб повторити спробу",
    ),
    "sold": m54,
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Залишилося часу"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Щось пішло не так, сталася невідома помилка",
    ),
    ...
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "балів, щоб піднятися на цьому ранзі.",
    ),
    ...
    "usePoint": MessageLookupByLibrary.simpleMessage("Використати точку"),
    ...
    "wholesaleRegisterMsg": MessageLookupByLibrary.simpleMessage(
      "Зверніться до адміністратора для підтвердження вашої реєстрації",
    ),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Ви наш"),
    "youAreSelecting": m70,
    ...
    "youHave": MessageLookupByLibrary.simpleMessage("У вас є"),
    ...
    "yourAccountIsUnderReview": MessageLookupByLibrary.simpleMessage(
      "Ваш обліковий запис перевіряється. Зверніться до адміністратора, якщо потрібна допомога",
    ),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Met succes een bod geplaatst op \'${name}\'";

  static String m5(state) => "Bluetooth-adapter is ${state}";

  static String m6(amount) => "Koop nu voor ${amount}";

  static String m7(author) => "Door: ${author}";

  static String m8(fieldName) => "${fieldName} mag niet leeg zijn.";

  static String m9(fieldName) =>
      "${fieldName} mag niet korter zijn dan 3 tekens.";

  static String m10(currency) => "Valuta gewijzigd naar ${currency}";

  static String m11(number) => "${number} tekens resterend";
  ...
  static String m16(count) => "${count} artikelen";

  static String m17(country) => "${country} wordt niet ondersteund";

  static String m18(currency) => "${currency} wordt niet ondersteund";

  static String m19(day) => "${day} dagen geleden";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Eindigt over ${timeLeft}";

  static String m22(captcha) => "Voer ${captcha} in om te bevestigen:";

  static String m23(message) => "Fout: ${message}";

  static String m24(message) => "Fout: ${message}";

  static String m25(time) => "Verloopt over ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "${hour} uur geleden";
  ...
  static String m31(size) => "Maximale bestandsgrootte: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Het minimale bestelbedrag voor ${storeName} is ${minOrderAmount}. Voeg nog een paar artikelen uit deze winkel toe!";

  static String m35(amount) =>
      "Voor deze coupon is een minimale aankoop van ${amount}vereist.";

  static String m36(value) => "Minimale transactie: ${value}";

  static String m37(minute) => "${minute} minuten geleden";

  static String m38(month) => "${month} maanden geleden";

  static String m39(store) => "Meer van ${store}";

  static String m40(number) => "Moet worden gekocht in groepen van ${number}";

  static String m41(itemCount) => "${itemCount} items";

  static String m42(price) => "Opties totaal: ${price}";

  static String m43(amount) => "Betaal ${amount}";

  static String m44(name) =>
      "${name} is succesvol aan de winkelwagen toegevoegd";

  static String m45(total) => "Aantal: ${total}";

  static String m46(name) => "Geld ontvangen van ${name}";

  static String m47(count) =>
      "Wilt u ${count} item(s) van uw verlanglijst verwijderen?";

  static String m48(percent) => "Aanbieding ${percent}%";

  static String m49(keyword) => "Zoekresultaten voor: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} artikel)";

  static String m51(keyword, count) => "${keyword} (${count} artikelen)";

  static String m52(second) => "${second} seconden geleden";

  static String m53(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} items";

  static String m54(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m56(total) => "${total} producten";

  static String m57(name) => "Geld overmaken naar ${name}";

  static String m58(amount) => "Gebruik ${amount} punten";
  ...
  static String m60(time) => "Geldig tot: ${time}";

  static String m61(date) => "Geldig tot ${date}";

  static String m62(number) => "Versie ${number}";

  static String m63(balance) => "Saldo portemonnee: ${balance}";

  static String m64(message) => "Waarschuwing: ${message}";
  ...
  static String m66(length) => "We hebben ${length} producten gevonden";

  static String m67(week) => "Week ${week}";

  static String m68(name) => "Welkom ${name}";

  static String m69(year) => "${year} jaar geleden";

  static String m70(count) => "U selecteert ${count} item(s)";

  static String m71(total) => "U bent toegewezen aan bestelling #${total}";

  static String m72(type) => "Je bent geslaagd voor ${type}";

  static String m73(point) => "Je hebt ${point} punten";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Punten toevoegen"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Voorschotbedrag"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Vooruitbetaling"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Bedrag overschrijdt het beschikbare aantal punten",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Helaas, afspraken kunnen op deze dag niet starten.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Weet je zeker dat je deze bestelling wilt terugbetalen?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Veiling"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Veilingdata"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Veiling beëindigd"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Veiling eindigt"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage(
      "Veilinggeschiedenis",
    ),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Veiling start"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "Veiling start over",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Veilingtype"),
    ...
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("Word een eigenaar"),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Word een andere rol",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Voordelen"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengaals"),
    "bid": MessageLookupByLibrary.simpleMessage("bod"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Bodverhoging"),
    ...
    "bronze": MessageLookupByLibrary.simpleMessage("Bronzen"),
    "bronzePriority": MessageLookupByLibrary.simpleMessage(
      "Bronzen prioriteit",
    ),
    "burmese": MessageLookupByLibrary.simpleMessage("Birmees"),
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("Nu kopen prijs"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "Het annuleringsverzoek is mislukt",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Je annuleringsverzoek is succesvol ingediend!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Winkelwagen is niet beschikbaar. Voeg enkele artikelen toe aan uw winkelwagen.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Uw winkelwagen wordt nog verwerkt. Een ogenblik geduld.",
    ),
    ...
    "classifieds": MessageLookupByLibrary.simpleMessage("Advertenties"),
    ...
    "commentFailed": MessageLookupByLibrary.simpleMessage("Reactie mislukt!"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Huidig bod"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Met deze gebruikersrol kun je boekingen maken, privéberichten sturen naar andere gebruikers en advertenties beoordelen.",
    ),
    ...
    "enterYourNote": MessageLookupByLibrary.simpleMessage("Voer uw notitie in"),
    ...
    "enterYourReview": MessageLookupByLibrary.simpleMessage(
      "Voer je beoordeling in",
    ),
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Deel meer gedachten over het product om andere kopers te helpen.",
    ),
    ...
    "gold": MessageLookupByLibrary.simpleMessage("Goud"),
    "goldPriority": MessageLookupByLibrary.simpleMessage("Goudprioriteit"),
    "good": MessageLookupByLibrary.simpleMessage("Goed"),
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "Authenticatie mislukt. Meld u opnieuw aan.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Er is iets misgegaan bij het uitvoeren van deze actie. Controleer dit nogmaals.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Ongeldige gegevens ingevoerd. Controleer uw invoer.",
    ),
    "greaterDistance": m26,
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "Voer een geldig e-mailadres in (bijv. voorbeeld@domein.com)",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Voer een geldige postcode in voor uw land",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Voer een geldige provincie/staat in",
    ),
    "invalidProvinceFormat": MessageLookupByLibrary.simpleMessage(
      "Voer een geldige provincie-/staatnaam in",
    ),
    "invalidQRCode": MessageLookupByLibrary.simpleMessage("Ongeldige QR-code"),
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "De gescande QR-code is niet geldig. Controleer en probeer het opnieuw.",
    ),
    ...
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("Nieuw"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("Laden mislukt!"),
    ...
    "logoutFailed": MessageLookupByLibrary.simpleMessage("Uitloggen mislukt"),
    "logoutSuccess": MessageLookupByLibrary.simpleMessage("Succesvol afgemeld"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Mijn kortingsbonnen"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Mijn QRCode"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Geef deze code aan het personeel om",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Controleer uw netwerk nogmaals",
    ),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Verbindingstime-out. Probeer het opnieuw.",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Geen openstaande bestellingen om te leveren",
    ),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Met deze gebruikersrol kun je advertenties en boekingsdiensten toevoegen en beheren. Eigenaren kunnen geen beoordelingen geven op andere advertenties.",
    ),
    ...
    "pickVoucherToApply": MessageLookupByLibrary.simpleMessage(
      "Kies een voucher om te gebruiken.",
    ),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Puntgeschiedenis"),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Omhoog trekken om meer te laden",
    ),
    ...
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Je bent momenteel lid van deze rang",
    ),
    ...
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Punten inwisselen"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage(
      "Beloningen inwisselen",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Ingewisseld"),
    ...
    "refreshing": MessageLookupByLibrary.simpleMessage("Verfrissend..."),
    ...
    "releaseToRefresh": MessageLookupByLibrary.simpleMessage(
      "Laat los om te verversen",
    ),
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Resterend bedrag te betalen bij levering",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Verhuur"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Reserveprijs"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Achteruit"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Beloningen"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "QR-scanner ondersteunt alleen het zoeken naar producten",
    ),
    ...
    "selectDate": MessageLookupByLibrary.simpleMessage("Selecteer een datum"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Gebruik uw Shopify-account om in te loggen en toegang te krijgen tot uw bestellingen, adressen en meer.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Inloggen met Shopify-klantaccount",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("Registreren"),
    "silver": MessageLookupByLibrary.simpleMessage("Zilver"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Besteed minstens"),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Begin met verkennen",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Startprijs"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Begin met winkelen"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Startbod"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Systeemfout. Neem contact op met de ondersteuning.",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Tijd over"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Er is iets misgegaan, er is een onbekende fout opgetreden",
    ),
    "unnamedLocation": MessageLookupByLibrary.simpleMessage("Naamloze locatie"),
    "unpaid": MessageLookupByLibrary.simpleMessage("Onbetaald"),
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Verdien meer"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "punten om een hogere rang te krijgen.",
    ),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Gebruikt"),
    ...
    "viewPointHistory": MessageLookupByLibrary.simpleMessage(
      "Geschiedenis van het uitkijkpunt",
    ),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Winnende bod"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Jij bent onze"),
    "youAreSelecting": m70,

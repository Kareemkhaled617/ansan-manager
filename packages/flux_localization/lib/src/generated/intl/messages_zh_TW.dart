...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "已成功競標“${name}”";

  static String m5(state) => "藍牙狀態為 ${state}";

  static String m6(amount) => "立即購買，價格為 ${amount}";

  static String m7(author) => "作者：${author}";

  static String m8(fieldName) => "${fieldName} 不能為空。";

  static String m9(fieldName) => "${fieldName} 長度不得小於3。";

  static String m10(currency) => "已將貨幣更改為${currency}";

  static String m11(number) => "剩餘${number}個字元";

  static String m12(priceRate, pointRate) => "${priceRate} = ${pointRate}點";

  static String m13(count) => "${count}項";

  static String m14(count) => "${count}項";

  static String m15(count) => "${count}項";

  static String m16(count) => "${count}項";

  static String m17(country) => "不支援${country}";

  static String m18(currency) => "不支援${currency}";

  static String m19(day) => "${day} 天前";

  static String m20(total) => "~${total} 公里";

  static String m21(timeLeft) => "結束於 ${timeLeft}";

  static String m22(captcha) => "輸入${captcha}以確認：";

  static String m23(message) => "錯誤：${message}";

  static String m24(message) => "錯誤：${message}";

  static String m25(time) => "將於 ${time} 到期";

  static String m26(total) => ">${total} 公里";

  static String m27(hour) => "${hour} 小時前";

  static String m28(currentBalance) => "您的錢包餘額僅剩${currentBalance}";

  static String m29(message) => "請求資料時應用程式發生問題，請聯絡管理員解決問題：${message}";

  static String m30(currency, amount) => "使用此付款方式的最高金額為${currency} ${amount}";

  static String m31(size) => "最大檔案大小：${size} MB";

  static String m32(name, formattedPrice) => "${name}： ${formattedPrice}";

  static String m33(currency, amount) => "使用此付款方式的最低金額為${currency} ${amount}";

  static String m34(storeName, minOrderAmount) =>
      " ${storeName} 的最低訂單金額為 ${minOrderAmount}。請從該商店添加更多商品！";

  static String m35(amount) => "此優惠券要求最低購買金額為 ${amount}。";

  static String m36(value) => "最低交易次數： ${value}";

  static String m37(minute) => "${minute} 分鐘前";

  static String m38(month) => "${month} 個月前";

  static String m39(store) => "${store}的更多商品";

  static String m40(number) => "必須以${number}為一組購買";

  static String m41(itemCount) => "${itemCount} 個項目";

  static String m42(price) => "選項總計：${price}";

  static String m43(amount) => "支付${amount}";

  static String m44(name) => "${name}已成功加入購物車";

  static String m45(total) => "數量：${total}";

  static String m46(name) => "收到來自${name}的款項";

  static String m47(count) => "您想從心願清單中刪除 ${count} 件商品嗎？";

  static String m48(percent) => "特價 ${percent}%";

  static String m49(keyword) => "「${keyword}」的搜尋結果";

  static String m50(keyword, count) => "${keyword}（${count}項）";

  static String m51(keyword, count) => "${keyword}（${count}項）";

  static String m52(second) => "${second}秒前";

  static String m53(totalCartQuantity) => "購物車，${totalCartQuantity}件商品";

  static String m54(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m55(fieldName) => "${fieldName}為必填欄位";

  static String m56(total) => "${total}項商品";

  static String m57(name) => "轉帳給${name}";

  static String m58(amount) => "使用 ${amount} 積分";

  static String m59(maxPointDiscount, maxPriceDiscount) =>
      "使用最多${maxPointDiscount}點積分可獲得此訂單${maxPriceDiscount}的折扣！";

  static String m60(time) => "有效期限至： ${time}";

  static String m61(date) => "有效期至 ${date}";

  static String m62(number) => "版本 ${number}";

  static String m63(balance) => "錢包餘額：${balance}";

  static String m64(message) => "警告：${message}";

  static String m65(defaultCurrency) => "目前選擇的貨幣不適用於錢包功能，請改為${defaultCurrency}";

  static String m66(length) => "我們找到了${length}項商品";

  static String m67(week) => "第${week}週";

  static String m68(name) => "歡迎${name}";

  static String m69(year) => "${year}年前";

  static String m70(count) => "您正在選擇 ${count} 項";

  static String m71(total) => "您已指派至訂單#${total}";

  static String m72(type) => "您已通過 ${type}";

  static String m73(point) => "您有${point}點積分";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "continueWithShopify": MessageLookupByLibrary.simpleMessage("繼續使用 Shopify"),
    ...
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage("身份驗證失敗。請重新登入。"),
    "graphqlAuthzError": MessageLookupByLibrary.simpleMessage("您無權執行此操作。"),
    ...
    "logoutFailed": MessageLookupByLibrary.simpleMessage("註銷失敗"),
    "logoutSuccess": MessageLookupByLibrary.simpleMessage("成功註銷"),
    ...
    "networkServerError": MessageLookupByLibrary.simpleMessage("伺服器錯誤。請稍後重試。"),
    "networkTimeout": MessageLookupByLibrary.simpleMessage("連接逾時。請重試。"),
    ...
    "shopifyCustomerAccountLoginDescription":
        MessageLookupByLibrary.simpleMessage("使用您的 Shopify 帳戶登入並存取您的訂單、地址等。"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage("系統錯誤。請聯絡支援人員。"),

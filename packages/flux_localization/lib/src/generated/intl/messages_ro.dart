...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) =>
      "O ofertă a fost plasată cu succes pentru „${name}”";

  static String m5(state) => "Adaptorul Bluetooth este ${state}";

  static String m6(amount) => "Cumpără acum pentru ${amount}";

  static String m7(author) => "Autor: ${author}";

  static String m8(fieldName) => "${fieldName} nu poate fi gol.";

  static String m9(fieldName) =>
      "Lungimea ${fieldName} nu poate fi mai mică de 3.";

  static String m10(currency) => "Moneda a fost schimbată în ${currency}";

  static String m11(number) => "${number} caractere rămase";

  static String m12(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} puncte";

  static String m13(count) => "${count} articol";

  static String m14(count) => "${count} articole";

  static String m15(count) => "${count} produs";

  static String m16(count) => "${count} produse";

  static String m17(country) => "Țara ${country} nu este acceptată";

  static String m18(currency) => "${currency} nu este acceptată";

  static String m19(day) => "acum ${day} zile";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Se termină în ${timeLeft}";

  static String m22(captcha) => "Introdu ${captcha} pentru a confirma:";

  static String m23(message) => "Eroare: ${message}";

  static String m24(message) => "Eroare: ${message}";

  static String m25(time) => "Expiră în ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "acum ${hour} ore";
  ...
  static String m31(size) => "Dimensiune maximă fișier: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Suma minimă a comenzii pentru ${storeName} este ${minOrderAmount}. Vă rugăm să adăugați încă câteva articole din acest magazin!";

  static String m35(amount) =>
      "Acest cupon necesită o achiziție minimă de ${amount}.";

  static String m36(value) => "Tranzacție minimă: ${value}";

  static String m37(minute) => "acum ${minute} minute";

  static String m38(month) => "acum ${month} luni";

  static String m39(store) => "Mai multe de la ${store}";

  static String m40(number) => "Trebuie cumpărat în grupuri de ${number}";

  static String m41(itemCount) => "${itemCount} articole";

  static String m42(price) => "Total opțiuni: ${price}";

  static String m43(amount) => "Plătește ${amount}";

  static String m44(name) => "${name} a fost adăugat în coș cu succes";

  static String m45(total) => "Cantitate: ${total}";

  static String m46(name) => "A primit bani de la ${name}";

  static String m47(count) =>
      "Vrei să elimini ${count} produs(e) din lista ta de dorințe?";

  static String m48(percent) => "Reducere ${percent}%";

  static String m49(keyword) => "Rezultatele căutării pentru: „${keyword}";

  static String m50(keyword, count) => "${keyword} (${count} articol)";

  static String m51(keyword, count) => "${keyword} (${count} articole)";

  static String m52(second) => "acum ${second} secunde";

  static String m53(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m54(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m56(total) => "${total} produse";

  static String m57(name) => "Transferă bani către ${name}";

  static String m58(amount) => "Folosiți ${amount} puncte";
  ...
  static String m60(time) => "Valabil până la: ${time}";

  static String m61(date) => "Valabil până la ${date}";

  static String m62(number) => "Versiunea ${number}";

  static String m63(balance) => "Sold portofel: ${balance}";

  static String m64(message) => "Atenție: ${message}";
  ...
  static String m66(length) => "Am găsit ${length} produse";

  static String m67(week) => "Săptămâna ${week}";

  static String m68(name) => "Bun venit, ${name}";

  static String m69(year) => "acum ${year} ani";

  static String m70(count) => "Selectezi ${count} produs(e)";

  static String m71(total) => "Ai fost atribuit comenzii #${total}";

  static String m72(type) => "Ai trecut de ${type}";

  static String m73(point) => "Ai ${point} puncte";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Adăugați puncte"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Sumă în avans"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Plată în avans"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Suma depășește punctele disponibile",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Ne pare rău, programările nu pot începe în această zi.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Ești sigur că vrei să rambursezi această comandă?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Licitație"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Datele licitației"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage(
      "Licitația s-a încheiat",
    ),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Licitația se încheie"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("Istoric licitații"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Începe licitația"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "Licitația începe în",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Tipul licitației"),
    ...
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("Devino proprietar"),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Devino alt rol",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Beneficii"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengaleză"),
    "bid": MessageLookupByLibrary.simpleMessage("Licitație"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Increment ofertă"),
    ...
    "bronzePriority": MessageLookupByLibrary.simpleMessage("Prioritate Bronz"),
    "burmese": MessageLookupByLibrary.simpleMessage("Birmaneză"),
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("Preț cumpără acum"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "Cererea de anulare nu a fost efectuată cu succes",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Cererea ta de anulare a fost trimisă cu succes!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Coșul nu este disponibil. Vă rugăm să adăugați câteva articole în coș.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Coșul dvs. este încă în curs de procesare. Vă rugăm să așteptați un moment.",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Revendică"),
    "claimed": MessageLookupByLibrary.simpleMessage("Revendicat"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Anunțuri"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Oferta curentă"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Acest rol de utilizator permite efectuarea de rezervări, trimiterea de mesaje private către alți utilizatori și recenzia anunțurilor.",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Împărtășește mai multe gânduri despre produs pentru a ajuta alți cumpărători.",
    ),
    ...
    "event": MessageLookupByLibrary.simpleMessage("Eveniment"),
    ...
    "gold": MessageLookupByLibrary.simpleMessage("Aur"),
    "goldPriority": MessageLookupByLibrary.simpleMessage("Prioritate Aur"),
    "good": MessageLookupByLibrary.simpleMessage("Bun"),
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "Autentificarea a eșuat. Vă rugăm să vă conectați din nou.",
    ),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Ceva nu a mers bine la încercarea de a face această acțiune. Vă rugăm să verificați din nou.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Datele furnizate sunt nevalide. Vă rugăm să verificați datele introduse.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să introduceți o adresă completă, inclusiv numele străzii și numărul.",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să introduceți un nume de oraș valid",
    ),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să introduceți un nume de oraș valid, fără caractere speciale.",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să introduceți un format de cod poștal valid pentru țara dvs.",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să introduceți o provincie/un stat valid",
    ),
    "invalidProvinceFormat": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să introduceți un nume valid de provincie/stat",
    ),
    "invalidQRCode": MessageLookupByLibrary.simpleMessage("Cod QR invalid"),
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Codul QR scanat nu este valid. Vă rugăm să verificați și să încercați din nou.",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("Starea articolului"),
    ...
    "listTile": MessageLookupByLibrary.simpleMessage("Listă tip plăcuță"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("Încărcarea a eșuat!"),
    ...
    "logoutFailed": MessageLookupByLibrary.simpleMessage("Deconectare eșuată"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Cupoanele mele"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Codul meu QR"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Prezentați acest cod personalului pentru a",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să verificați conexiunea la rețea",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Nu există comenzi în așteptare pentru livrare",
    ),
    ...
    "noteOptional": MessageLookupByLibrary.simpleMessage("Notă (opțional)"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Acest rol de utilizator permite adăugarea și gestionarea anunțurilor și serviciilor de rezervare. Proprietarii nu pot lăsa recenzii la alte anunțuri.",
    ),
    ...
    "pickVoucherToApply": MessageLookupByLibrary.simpleMessage(
      "Alegeți un voucher pentru a-l aplica.",
    ),
    ...
    "platinum": MessageLookupByLibrary.simpleMessage("Platină"),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Istoric puncte"),
    ...
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "Punctele au fost adăugate în contul utilizatorului.",
    ),
    "pointsAddedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Punctele au fost adăugate cu succes",
    ),
    "pointsRedeemedMsg": MessageLookupByLibrary.simpleMessage(
      "Punctele au fost răscumpărate din contul utilizatorului.",
    ),
    "pointsRedeemedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Punctele au fost răscumpărate cu succes",
    ),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Trageți în sus pentru a încărca mai multe",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Detalii rang"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Ești în prezent membru al acestui rang",
    ),
    ...
    "received": MessageLookupByLibrary.simpleMessage("Primit"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Răscumpără"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Răscumpără puncte"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage(
      "Răscumpără recompense",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Răscumpărat"),
    "refresh": MessageLookupByLibrary.simpleMessage("Reîmprospătează"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Reîmprospătare finalizată",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Se reîmprospătează..."),
    ...
    "releaseToRefresh": MessageLookupByLibrary.simpleMessage(
      "Eliberați pentru a reîmprospăta",
    ),
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Sumă rămasă de plătit la livrare",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Închiriere"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Preț de rezervă"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Verso"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Recompense"),
    ...
    "scanPoints": MessageLookupByLibrary.simpleMessage("Scanați puncte"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "Scannerul QR suportă doar căutarea de produse",
    ),
    ...
    "selectDate": MessageLookupByLibrary.simpleMessage("Selectați data"),
    ...
    "selectType": MessageLookupByLibrary.simpleMessage("Selectați tipul"),
    ...
    "service": MessageLookupByLibrary.simpleMessage("Serviciu"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Folosește-ți contul Shopify pentru a te autentifica și a accesa comenzile, adresele și multe altele.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Autentificare cu contul de client Shopify",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("Înregistrare"),
    "silver": MessageLookupByLibrary.simpleMessage("Argint"),
    "silverPriority": MessageLookupByLibrary.simpleMessage("Prioritate Argint"),
    "simple": MessageLookupByLibrary.simpleMessage("Simplu"),
    "simpleList": MessageLookupByLibrary.simpleMessage("Listă simplă"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage(
      "Cheltuiește cel puțin",
    ),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Începe să explorezi",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Preț de pornire"),
    "startShopping": MessageLookupByLibrary.simpleMessage(
      "Începe cumpărăturile",
    ),
    "startingBid": MessageLookupByLibrary.simpleMessage("Ofertă inițială"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Eroare de sistem. Vă rugăm să contactați asistența.",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Timp rămas"),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Folosit"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Ofertă câștigătoare"),
    ...
    "writeTitle": MessageLookupByLibrary.simpleMessage("Scrieți titlul"),
    "writeYourNote": MessageLookupByLibrary.simpleMessage("Scrie nota"),
    "yearsAgo": m69,
    "yes": MessageLookupByLibrary.simpleMessage("Da"),
    "youAreOur": MessageLookupByLibrary.simpleMessage("Ești al nostru"),
    "youAreSelecting": m70,

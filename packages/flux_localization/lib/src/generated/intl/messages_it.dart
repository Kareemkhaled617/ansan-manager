...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Offerta piazzata con successo per \'${name}\'";

  static String m5(state) => "L\'adattatore Bluetooth è ${state}";

  static String m6(amount) => "Acquista ora per ${amount}";

  static String m7(author) => "Di ${author}";

  static String m8(fieldName) => "${fieldName} obbligatorio";

  static String m9(fieldName) =>
      "${fieldName} deve contenere almeno 3 caratteri";

  static String m10(currency) => "Valuta modificata in ${currency}";

  static String m11(number) => "Caratteri rimanenti: ${number}";

  static String m12(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} punti";

  static String m13(count) => "${count} articolo";

  static String m14(count) => "${count} articoli";

  static String m15(count) => "${count} prodotto";

  static String m16(count) => "${count} prodotti";

  static String m17(country) => "${country} non è supportato";

  static String m18(currency) => "${currency} non è supportata";

  static String m19(day) => "${day} giorni fa";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Termina tra ${timeLeft}";

  static String m22(captcha) => "Inserisci ${captcha} per confermare:";

  static String m23(message) => "Errore: ${message}";

  static String m24(message) => "Errore: ${message}";

  static String m25(time) => "Scade tra ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "${hour} ore fa";

  static String m28(currentBalance) =>
      "Hai solo ${currentBalance} nel portafoglio";
  ...
  static String m31(size) => "Dimensione massima file: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "L\'importo minimo dell\'ordine per ${storeName} è ${minOrderAmount}. Aggiungi altri articoli da questo negozio!";

  static String m35(amount) =>
      "Questo coupon richiede un acquisto minimo di ${amount}.";

  static String m36(value) => "Transazione minima: ${value}";

  static String m37(minute) => "${minute} minuti fa";

  static String m38(month) => "${month} mesi fa";

  static String m39(store) => "Altri prodotti da ${store}";

  static String m40(number) => "Deve essere acquistato in gruppi di ${number}";

  static String m41(itemCount) => "${itemCount} articoli";

  static String m42(price) => "Totale opzioni: ${price}";

  static String m43(amount) => "Paga ${amount}";

  static String m44(name) => "${name} aggiunto al carrello";

  static String m45(total) => "Qtà: ${total}";

  static String m46(name) => "Ricevuto denaro da ${name}";

  static String m47(count) => "Vuoi rimuovere ${count} articoli dai preferiti?";

  static String m48(percent) => "Sconto ${percent}%";

  static String m49(keyword) => "Risultati per: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} risultato)";

  static String m51(keyword, count) => "${keyword} (${count} risultati)";

  static String m52(second) => "${second} secondi fa";

  static String m53(totalCartQuantity) =>
      "Carrello, ${totalCartQuantity} articoli";

  static String m54(numberOfUnitsSold) => "Venduto: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m56(total) => "${total} prodotti";

  static String m57(name) => "Trasferisci denaro a ${name}";

  static String m58(amount) => "Usa ${amount} punti";
  ...
  static String m60(time) => "Valido fino al: ${time}";

  static String m61(date) => "Valido fino al ${date}";

  static String m62(number) => "Versione ${number}";

  static String m63(balance) => "Saldo portafoglio: ${balance}";

  static String m64(message) => "Attenzione: ${message}";
  ...
  static String m66(length) => "Abbiamo trovato ${length} prodotti";

  static String m67(week) => "Settimana ${week}";

  static String m68(name) => "Benvenuto ${name}";

  static String m69(year) => "${year} anni fa";

  static String m70(count) => "Stai selezionando ${count} articoli";

  static String m71(total) => "Hai assegnato l\'ordine n. ${total}";

  static String m72(type) => "Hai superato ${type}";

  static String m73(point) => "Hai ${point} punti";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Aggiungi punti"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Importo anticipato"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "L\'importo supera i punti disponibili",
    ),
    "anyAttr": m2,
    "appTrackingRequest": MessageLookupByLibrary.simpleMessage(
      "Questo identificatore verrà utilizzato per fornirti annunci pubblicitari personalizzati.\n\"Annulla\" limiterà la capacità di Advertisement Network di mostrarti annunci pertinenti, ma non ridurrà il numero di annunci che ricevi.\nPoiché il dispositivo è limitato, il tracciamento è disabilitato e il sistema non può mostrare una finestra di richiesta. \"Apri Impostazioni\" e consenti all\'app di tracciare la tua attività su app e siti web di altre aziende?",
    ),
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Siamo spiacenti, gli appuntamenti non possono iniziare in questo giorno.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Sei sicuro di voler rimborsare questo ordine?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Asta"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Date delle aste"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Asta terminata"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("L\'asta termina"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("Cronologia aste"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("L\'asta inizia"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "L\'asta inizia tra",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Tipo di asta"),
    ...
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage(
      "Diventa un ruolo diverso",
    ),
    "benefits": MessageLookupByLibrary.simpleMessage("Benefici"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengalese"),
    "bid": MessageLookupByLibrary.simpleMessage("Offerta"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Incremento offerta"),
    ...
    "bronze": MessageLookupByLibrary.simpleMessage("Bronzo"),
    "bronzePriority": MessageLookupByLibrary.simpleMessage("Priorità Bronzo"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "La richiesta di cancellazione non è andata a buon fine",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Il carrello non è disponibile. Aggiungi alcuni articoli al carrello.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Il tuo carrello è ancora in fase di elaborazione. Attendi un attimo.",
    ),
    ...
    "claimed": MessageLookupByLibrary.simpleMessage("Reclamato"),
    "classifieds": MessageLookupByLibrary.simpleMessage("Annunci"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Offerta attuale"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Questo ruolo utente consente di effettuare prenotazioni, inviare messaggi privati ad altri utenti e recensire gli annunci.",
    ),
    ...
    "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
      "Sembra che tu non abbia ancora aggiunto articoli al carrello. Inizia a fare shopping per riempirlo.",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Condividi altre opinioni sul prodotto per aiutare gli altri acquirenti.",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("Priorità Oro"),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Si è verificato un errore durante il tentativo di eseguire questa azione. Si prega di ricontrollare.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Dati forniti non validi. Si prega di controllare i dati inseriti.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Inserisci un indirizzo completo con nome della via e numero civico",
    ),
    ...
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "Inserisci un nome di città valido senza caratteri speciali",
    ),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "Inserisci un formato di codice postale valido per il tuo Paese",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage(
      "Inserisci una provincia/stato valido",
    ),
    "invalidProvinceFormat": MessageLookupByLibrary.simpleMessage(
      "Inserisci un nome di provincia/stato valido",
    ),
    ...
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "Il codice QR scansionato non è valido. Controlla e riprova.",
    ),
    ...
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("nuovo"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("Caricamento fallito!"),
    ...
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("Buono fedeltà"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("I miei coupon"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Il mio codice QR"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Fornisci questo codice al personale per",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Si prega di ricontrollare la rete",
    ),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Timeout della connessione. Riprova.",
    ),
    ...
    "noteOptional": MessageLookupByLibrary.simpleMessage("Nota (facoltativa)"),
    ...
    "orderDetail": MessageLookupByLibrary.simpleMessage("Dettagli Ordine"),
    ...
    "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
      "Puoi accedere al tuo account usando l\'email e la password definite in precedenza. Dal tuo account puoi modificare i dati del profilo, controllare la cronologia delle transazioni, modificare l\'iscrizione alla newsletter.",
    ),
    ...
    "owner": MessageLookupByLibrary.simpleMessage("Proprietario"),
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Questo ruolo utente consente di aggiungere annunci e servizi di prenotazione e di gestirli. I proprietari non possono recensire altri annunci.",
    ),
    ...
    "paymentDetailsChangedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Dettagli di pagamento modificati con successo",
    ),
    ...
    "pickVoucherToApply": MessageLookupByLibrary.simpleMessage(
      "Seleziona un buono da applicare.",
    ),
    ...
    "platinum": MessageLookupByLibrary.simpleMessage("Platino"),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Cronologia punti"),
    ...
    "pointRewardMessage": MessageLookupByLibrary.simpleMessage(
      "C\'è una regola di sconto per applicare i tuoi punti al carrello",
    ),
    "points": MessageLookupByLibrary.simpleMessage("Punti"),
    "pointsAddedMsg": MessageLookupByLibrary.simpleMessage(
      "I punti sono stati aggiunti all’account dell’utente.",
    ),
    ...
    "pointsRedeemedMsg": MessageLookupByLibrary.simpleMessage(
      "I punti sono stati riscattati dall\'account dell\'utente.",
    ),
    "pointsRedeemedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Punti riscattati con successo",
    ),
    ...
    "productAdded": MessageLookupByLibrary.simpleMessage("Prodotto aggiunto"),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Dettagli grado"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Attualmente sei un membro di questo grado",
    ),
    ...
    "received": MessageLookupByLibrary.simpleMessage("Ricevuto"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("Riscatta"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Riscatta punti"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage("Riscatta premi"),
    "redeemed": MessageLookupByLibrary.simpleMessage("Riscattato"),
    "refresh": MessageLookupByLibrary.simpleMessage("Aggiorna"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Aggiornamento completato",
    ),
    "refreshing": MessageLookupByLibrary.simpleMessage("Aggiornamento..."),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Importo rimanente da pagare alla consegna",
    ),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("Noleggio"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Prezzo di riserva"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Inverti"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Premi"),
    ...
    "scanPoints": MessageLookupByLibrary.simpleMessage("Scansiona punti"),
    ...
    "scannerOnlyForProduct": MessageLookupByLibrary.simpleMessage(
      "Il lettore QR supporta solo la ricerca di prodotti",
    ),
    ...
    "service": MessageLookupByLibrary.simpleMessage("Servizio"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Utilizza il tuo account Shopify per accedere e visualizzare i tuoi ordini, indirizzi e altro ancora.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Accedi con account cliente Shopify",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("Registrati"),
    "silver": MessageLookupByLibrary.simpleMessage("Argento"),
    "silverPriority": MessageLookupByLibrary.simpleMessage("Priorità Argento"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Spendi almeno"),
    "startExploring": MessageLookupByLibrary.simpleMessage(
      "Inizia a esplorare",
    ),
    "startPrice": MessageLookupByLibrary.simpleMessage("Prezzo di partenza"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Inizia lo Shopping"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Offerta iniziale"),
    ...
    "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
      "Grazie per il tuo ordine. Lo stiamo elaborando e riceverai presto un\'email di conferma",
    ),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Errore di sistema. Contatta l\'assistenza.",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Tempo rimasto"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Qualcosa è andato storto, si è verificato un errore sconosciuto",
    ),
    "unnamedLocation": MessageLookupByLibrary.simpleMessage(
      "Posizione senza nome",
    ),
    "unpaid": MessageLookupByLibrary.simpleMessage("Non pagato"),
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Guadagna altri"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "punti per salire di grado.",
    ),
    ...
    "usePoint": MessageLookupByLibrary.simpleMessage("Usa punto"),
    "useThisImage": MessageLookupByLibrary.simpleMessage("Usa questa immagine"),
    "used": MessageLookupByLibrary.simpleMessage("Usato"),
    ...
    "waitForPost": MessageLookupByLibrary.simpleMessage(
      "In attesa della pubblicazione del prodotto",
    ),
    ...
    "welcomeRegister": MessageLookupByLibrary.simpleMessage(
      "Benvenuto! Inizia a fare shopping con noi",
    ),
    "welcomeUser": m68,
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Offerta vincente"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Sei il nostro"),
    "youAreSelecting": m70,
    ...
    "yourEarningsThisMonth": MessageLookupByLibrary.simpleMessage(
      "I tuoi guadagni di questo mese",
    ),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "「${name}」への入札が完了しました";

  static String m5(state) => "Bluetoothアダプターは${state}です";

  static String m6(amount) => "今すぐ購入 ${amount}";

  static String m7(author) => "作者：${author}";

  static String m8(fieldName) => "${fieldName}は必須です";

  static String m9(fieldName) => "${fieldName}は3文字以上で入力してください";

  static String m10(currency) => "通貨を${currency}に変更しました";

  static String m11(number) => "残り${number}文字";

  static String m12(priceRate, pointRate) => "${priceRate} = ${pointRate}ポイント";

  static String m13(count) => "${count}個のアイテム";

  static String m14(count) => "${count}個のアイテム";

  static String m15(count) => "${count}個の商品";

  static String m16(count) => "${count}個の商品";

  static String m17(country) => "${country}はサポートされていません";

  static String m18(currency) => "${currency}はサポートされていません";

  static String m19(day) => "${day}日前";

  static String m20(total) => "${total}km";

  static String m21(timeLeft) => "残り${timeLeft}";

  static String m22(captcha) => "${captcha}を入力して確認してください";

  static String m23(message) => "エラー：${message}";

  static String m24(message) => "エラー：${message}";

  static String m25(time) => "有効期限：${time}";

  static String m26(total) => "${total}km以上";

  static String m27(hour) => "${hour}時間前";

  static String m28(currentBalance) => "ウォレット残高が不足しています（残高：${currentBalance}）";

  static String m29(message) => "データの取得中に問題が発生しました。管理者に連絡してください：${message}";

  static String m30(currency, amount) => "この支払いの上限額は${currency} ${amount}です";

  static String m31(size) => "最大ファイルサイズ：${size} MB";

  static String m32(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m33(currency, amount) => "この支払いの最低額は${currency} ${amount}です";

  static String m34(storeName, minOrderAmount) =>
      " ${storeName} の最低注文金額は ${minOrderAmount}です。このストアからさらに商品を追加してください。";

  static String m35(amount) => "このクーポンは最低 ${amount}の購入が必要です。";

  static String m36(value) => "最小取引: ${value}";

  static String m37(minute) => "${minute}分前";

  static String m38(month) => "${month}ヶ月前";

  static String m39(store) => "${store}の他の商品";

  static String m40(number) => "${number}個単位で購入する必要があります";

  static String m41(itemCount) => "${itemCount}点";

  static String m42(price) => "オプション合計：${price}";

  static String m43(amount) => "${amount}を支払う";

  static String m44(name) => "${name}をカートに追加しました";

  static String m45(total) => "数量：${total}";

  static String m46(name) => "${name}から入金がありました";

  static String m47(count) => "${count}個の商品をお気に入りから削除しますか？";

  static String m48(percent) => "セール ${percent}%オフ";

  static String m49(keyword) => "「${keyword}」の検索結果";

  static String m50(keyword, count) => "${keyword}（${count}件）";

  static String m51(keyword, count) => "${keyword}（${count}件）";

  static String m52(second) => "${second}秒前";

  static String m53(totalCartQuantity) => "カート内の商品：${totalCartQuantity}点";

  static String m54(numberOfUnitsSold) => "売れた数：${numberOfUnitsSold}";

  static String m55(fieldName) => "${fieldName}は必須項目です";

  static String m56(total) => "商品数：${total}";

  static String m57(name) => "${name}に送金";

  static String m58(amount) => " ${amount} ポイントを使用する";

  static String m59(maxPointDiscount, maxPriceDiscount) =>
      "この注文で最大${maxPointDiscount}ポイントを使用すると、${maxPriceDiscount}の割引が適用されます。";

  static String m60(time) => "有効期限: ${time}";

  static String m61(date) => "${date}まで有効";

  static String m62(number) => "バージョン ${number}";

  static String m63(balance) => "ウォレット残高：${balance}";

  static String m64(message) => "警告：${message}";

  static String m65(defaultCurrency) =>
      "現在選択されている通貨はウォレット機能では利用できません。${defaultCurrency}に変更してください";

  static String m66(length) => "${length}件の商品が見つかりました";

  static String m67(week) => "週 ${week}";

  static String m68(name) => "ようこそ、${name}さん";

  static String m69(year) => "${year}年前";

  static String m70(count) => "${count}個の商品を選択中";

  static String m71(total) => "注文番号${total}に割り当てられました";

  static String m72(type) => " ${type}に合格しました";

  static String m73(point) => "${point}ポイントあります";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("ポイントを追加"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("前払金額"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("前払い"),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("オークション"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("オークション日程"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("オークション終了"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("オークション終了"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("オークション履歴"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("オークション開始"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage("オークション開始"),
    "auctionType": MessageLookupByLibrary.simpleMessage("オークションの種類"),
    ...
    "availableForTiers": MessageLookupByLibrary.simpleMessage("利用可能なティア"),
    "availablePoints": m3,
    ...
    "becomeAnOwner": MessageLookupByLibrary.simpleMessage("オーナーになる"),
    "becomeDifferentRole": MessageLookupByLibrary.simpleMessage("別の役割になる"),
    "benefits": MessageLookupByLibrary.simpleMessage("利点"),
    "bengali": MessageLookupByLibrary.simpleMessage("ベンガル語"),
    "bid": MessageLookupByLibrary.simpleMessage("入札"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("入札額の増加"),
    ...
    "bronze": MessageLookupByLibrary.simpleMessage("ブロンズ"),
    "bronzePriority": MessageLookupByLibrary.simpleMessage("ブロンズ優先"),
    "burmese": MessageLookupByLibrary.simpleMessage("ビルマ語"),
    "buyItNowPrice": MessageLookupByLibrary.simpleMessage("今すぐ購入価格"),
    ...
    "claimed": MessageLookupByLibrary.simpleMessage("主張"),
    "classifieds": MessageLookupByLibrary.simpleMessage("クラシファイド"),
    ...
    "commentFailed": MessageLookupByLibrary.simpleMessage("コメントに失敗しました！"),
    ...
    "continueWithShopify": MessageLookupByLibrary.simpleMessage("Shopifyを続ける"),
    ...
    "couponsManagement": MessageLookupByLibrary.simpleMessage("クーポン管理"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("現在の入札"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "このユーザー役割では、予約、他ユーザーへのプライベートメッセージ送信、リスティングのレビューができます。",
    ),
    ...
    "enterYourNote": MessageLookupByLibrary.simpleMessage("メモを入力してください"),
    ...
    "enterYourReview": MessageLookupByLibrary.simpleMessage("レビューを入力してください"),
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "他の購入者の参考になるよう、商品の感想を詳しく共有してください。",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("ゴールドプライオリティ"),
    ...
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "この操作を実行しようとしたときに問題が発生しました。もう一度ご確認ください。",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "無効なデータが指定されました。入力内容を確認してください。",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddress": MessageLookupByLibrary.simpleMessage("有効な住所を入力してください"),
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "通り名と番地を含む完全な住所を入力してください",
    ),
    "invalidCity": MessageLookupByLibrary.simpleMessage("有効な都市名を入力してください"),
    "invalidCityFormat": MessageLookupByLibrary.simpleMessage(
      "特殊文字を含まない有効な都市名を入力してください",
    ),
    "invalidCountry": MessageLookupByLibrary.simpleMessage("有効な国を選択してください"),
    "invalidCountryCode": MessageLookupByLibrary.simpleMessage(
      "有効な国コードを選択してください",
    ),
    "invalidCountryCodeFormat": MessageLookupByLibrary.simpleMessage(
      "リストから有効な国コードを選択してください",
    ),
    ...
    "invalidEmailFormat": MessageLookupByLibrary.simpleMessage(
      "有効なメール形式を入力してください（例：example@domain.com）",
    ),
    "invalidPhone": MessageLookupByLibrary.simpleMessage("有効な電話番号を入力して下さい"),
    ...
    "invalidPostalCodeFormat": MessageLookupByLibrary.simpleMessage(
      "あなたの国の有効な郵便番号の形式を入力してください",
    ),
    "invalidProvince": MessageLookupByLibrary.simpleMessage("有効な都道府県を入力してください"),
    ...
    "invalidQRCodeMsg": MessageLookupByLibrary.simpleMessage(
      "スキャンしたQRコードは無効です。ご確認の上、再度お試しください。",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("商品の状態"),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("新しい"),
    ...
    "loadFailed": MessageLookupByLibrary.simpleMessage("読み込みに失敗しました!"),
    ...
    "logoutSuccess": MessageLookupByLibrary.simpleMessage("ログアウトに成功しました"),
    "loyaltyVoucher": MessageLookupByLibrary.simpleMessage("ロイヤルティバウチャー"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("私のクーポン"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("私のQRコード"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage("このコードをスタッフに提供して"),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage("ネットワークを再確認してください"),
    ...
    "noNotification": MessageLookupByLibrary.simpleMessage("まだ通知はありません"),
    ...
    "noteOptional": MessageLookupByLibrary.simpleMessage("メモ（任意）"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "このユーザー役割では、リスティングや予約サービスの追加・管理ができます。オーナーは他のリスティングをレビューできません。",
    ),
    ...
    "platinumPriority": MessageLookupByLibrary.simpleMessage("プラチナプライオリティ"),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("ポイント履歴"),
    ...
    "pullToRefresh": MessageLookupByLibrary.simpleMessage("引いて更新"),
    "pullUpLoad": MessageLookupByLibrary.simpleMessage("さらに読み込むには上に引っ張ってください"),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("ランクの詳細"),
    ...
    "received": MessageLookupByLibrary.simpleMessage("受け取った"),
    ...
    "redeemPoints": MessageLookupByLibrary.simpleMessage("ポイントを利用する"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage("報酬を引き換える"),
    "redeemed": MessageLookupByLibrary.simpleMessage("償還済み"),
    "refresh": MessageLookupByLibrary.simpleMessage("更新"),
    "refreshCompleted": MessageLookupByLibrary.simpleMessage("更新が完了しました"),
    "refreshing": MessageLookupByLibrary.simpleMessage("爽やか…"),
    ...
    "releaseToRefresh": MessageLookupByLibrary.simpleMessage("リリースしてリフレッシュ"),
    ...
    "rental": MessageLookupByLibrary.simpleMessage("レンタル"),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("最低価格"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("逆行する"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("報酬"),
    ...
    "shopifyCustomerAccountLoginDescription":
        MessageLookupByLibrary.simpleMessage(
          "Shopify アカウントを使用してログインし、注文、住所などにアクセスします。",
        ),
    ...
    "silverPriority": MessageLookupByLibrary.simpleMessage("シルバープライオリティ"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("最低購入額"),
    "startExploring": MessageLookupByLibrary.simpleMessage("探索を開始"),
    "startPrice": MessageLookupByLibrary.simpleMessage("開始価格"),
    "startShopping": MessageLookupByLibrary.simpleMessage("ショッピングを開始"),
    "startingBid": MessageLookupByLibrary.simpleMessage("開始入札"),
    ...
    "thisItemIsSold": MessageLookupByLibrary.simpleMessage("この商品は販売済みです"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "問題が発生しました。不明なエラーが発生しました。",
    ),
    "unnamedLocation": MessageLookupByLibrary.simpleMessage("名称未設定の場所"),
    "unpaid": MessageLookupByLibrary.simpleMessage("未払い"),
    "upRankNote1": MessageLookupByLibrary.simpleMessage("もっと稼ぐ"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "このランクを上げるにはポイントが必要です。",
    ),
    ...
    "updateUserFailed": MessageLookupByLibrary.simpleMessage("ユーザーの更新に失敗しました"),
    ...
    "used": MessageLookupByLibrary.simpleMessage("使用済み"),
    ...
    "viewPointHistory": MessageLookupByLibrary.simpleMessage("ポイント履歴を表示"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("落札価格"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("あなたは私たちの"),
    "youAreSelecting": m70,
    ...
    "youHave": MessageLookupByLibrary.simpleMessage("あなたが持っている"),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(name) => "Uspješno postavljena ponuda za \'${name}\'";

  static String m5(state) => "Bluetooth adapter je ${state}";

  static String m6(amount) => "Kupite sada za ${amount}";

  static String m7(author) => "Autor: ${author}";

  static String m8(fieldName) => "${fieldName} ne može biti prazan.";

  static String m9(fieldName) =>
      " Dužina${fieldName} ne smije biti manja od 3.";

  static String m10(currency) => "Valuta promijenjena u ${currency}";

  static String m11(number) => " Preostalo znakova:${number} ";
  ...
  static String m15(count) => "${count} stavka";

  static String m16(count) => "${count} stavki";

  static String m17(country) => "${country} zemlja nije podržana";

  static String m18(currency) => "${currency} nije podržana";

  static String m19(day) => "prije ${day} dana";

  static String m20(total) => "~${total} km";

  static String m21(timeLeft) => "Završava za ${timeLeft}";

  static String m22(captcha) => "Unesite ${captcha} za potvrdu:";

  static String m23(message) => "Greška: ${message}";

  static String m24(message) => "Greška: ${message}";

  static String m25(time) => "Ističe za ${time}";

  static String m26(total) => ">${total} km";

  static String m27(hour) => "prije ${hour} sati";
  ...
  static String m31(size) => "Maksimalna veličina datoteke: ${size} MB";
  ...
  static String m34(storeName, minOrderAmount) =>
      "Minimalni iznos narudžbe za ${storeName} je ${minOrderAmount}. Molimo vas da dodate još nekoliko artikala iz ove trgovine!";

  static String m35(amount) =>
      "Ovaj kupon zahtijeva minimalnu kupovinu od ${amount}.";

  static String m36(value) => "Minimalna transakcija: ${value}";

  static String m37(minute) => "prije ${minute} minuta";

  static String m38(month) => "prije ${month} mjeseci";

  static String m39(store) => "Više od ${store}";

  static String m40(number) => "mora se kupiti u grupama od ${number}";

  static String m41(itemCount) => "${itemCount} artikala";

  static String m42(price) => "Ukupno opcija: ${price}";

  static String m43(amount) => "Plati ${amount}";

  static String m44(name) => "${name} su uspješno dodani u korpu";

  static String m45(total) => "Količina: ${total}";

  static String m46(name) => "Primljen novac od ${name}";

  static String m47(count) =>
      "Želite li ukloniti sljedeći broj stavki: ${count} sa svoje liste želja?";

  static String m48(percent) => "Sniženje ${percent}%";

  static String m49(keyword) => "Rezultati pretrage za: \'${keyword}\'";

  static String m50(keyword, count) => "${keyword} (${count} stavka)";

  static String m51(keyword, count) => "${keyword} (${count} stavki)";

  static String m52(second) => "prije ${second} sekundi";

  static String m53(totalCartQuantity) =>
      "Korpa, ${totalCartQuantity} artikala";

  static String m54(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m55(fieldName) => "Polje ${fieldName} je obavezno";

  static String m56(total) => "${total} proizvoda";

  static String m57(name) => "Prenesite novac na ${name}";

  static String m58(amount) => "Iskoristite ${amount} poena";
  ...
  static String m60(time) => "Vrijedi do: ${time}";

  static String m61(date) => "Važi do ${date}";

  static String m62(number) => "Verzija ${number}";

  static String m63(balance) => "Stanje novčanika: ${balance}";

  static String m64(message) => "Upozorenje: ${message}";
  ...
  static String m66(length) => "Pronašli smo ${length} proizvoda";

  static String m67(week) => "Sedmica ${week}";

  static String m68(name) => "Dobro došli ${name}";

  static String m69(year) => "prije ${year} godina";

  static String m70(count) => "Odabirete sljedeći broj stavki: ${count} ";

  static String m71(total) => "Dodijeljeni ste narudžbi #${total}";

  static String m72(type) => "Prošli ste ${type}";

  static String m73(point) => "Imate ${point} bodova";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "add": MessageLookupByLibrary.simpleMessage("Dodati"),
    ...
    "addPoints": MessageLookupByLibrary.simpleMessage("Dodaj bodove"),
    ...
    "advanceAmount": MessageLookupByLibrary.simpleMessage("Iznos avansa"),
    "advancePayment": MessageLookupByLibrary.simpleMessage("Avansno plaćanje"),
    ...
    "amountExceedsAvailablePoints": MessageLookupByLibrary.simpleMessage(
      "Iznos prelazi raspoložive bodove",
    ),
    "anyAttr": m2,
    ...
    "appointmentStartInvalidDay": MessageLookupByLibrary.simpleMessage(
      "Žao nam je, termini ne mogu početi na ovaj dan.",
    ),
    ...
    "areYouSureRefundOrder": MessageLookupByLibrary.simpleMessage(
      "Jeste li sigurni da želite vratiti ovu narudžbu?",
    ),
    ...
    "auction": MessageLookupByLibrary.simpleMessage("Aukcija"),
    "auctionDates": MessageLookupByLibrary.simpleMessage("Datumi aukcija"),
    "auctionEnded": MessageLookupByLibrary.simpleMessage("Aukcija je završena"),
    "auctionEnds": MessageLookupByLibrary.simpleMessage("Aukcija završava"),
    "auctionHistory": MessageLookupByLibrary.simpleMessage("Historija aukcija"),
    "auctionStarts": MessageLookupByLibrary.simpleMessage("Počinje aukcija"),
    "auctionStartsIn": MessageLookupByLibrary.simpleMessage(
      "Aukcija počinje za",
    ),
    "auctionType": MessageLookupByLibrary.simpleMessage("Vrsta aukcije"),
    ...
    "benefits": MessageLookupByLibrary.simpleMessage("Prednosti"),
    "bengali": MessageLookupByLibrary.simpleMessage("Bengalski"),
    "bid": MessageLookupByLibrary.simpleMessage("Ponuda"),
    "bidIncrement": MessageLookupByLibrary.simpleMessage("Povećanje ponude"),
    ...
    "cancelOrderFailed": MessageLookupByLibrary.simpleMessage(
      "Zahtjev za otkazivanje nije uspio",
    ),
    "cancelOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "Vaš zahtjev za otkazivanje je uspješno poslan!",
    ),
    ...
    "cartNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Korpa nije dostupna. Molimo vas da dodate neke artikle u korpu.",
    ),
    "cartNotReadyForCheckout": MessageLookupByLibrary.simpleMessage(
      "Vaša korpa se još uvijek obrađuje. Molimo pričekajte trenutak.",
    ),
    ...
    "claim": MessageLookupByLibrary.simpleMessage("Zahtjev"),
    "claimed": MessageLookupByLibrary.simpleMessage("Zahtjevano"),
    ...
    "currentBid": MessageLookupByLibrary.simpleMessage("Trenutna ponuda"),
    ...
    "customerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ova korisnička uloga omogućava rezervacije, slanje privatnih poruka drugim korisnicima i recenziranje oglasa.",
    ),
    ...
    "enterYourReviewHint": MessageLookupByLibrary.simpleMessage(
      "Podijelite više mišljenja o proizvodu kako biste pomogli drugim kupcima.",
    ),
    ...
    "goldPriority": MessageLookupByLibrary.simpleMessage("Zlatni prioritet"),
    "good": MessageLookupByLibrary.simpleMessage("Dobro"),
    "graphqlAuthError": MessageLookupByLibrary.simpleMessage(
      "Autentifikacija nije uspjela. Molimo vas da se ponovo prijavite.",
    ),
    "graphqlAuthzError": MessageLookupByLibrary.simpleMessage(
      "Nemate dozvolu za izvršavanje ove radnje.",
    ),
    "graphqlError": MessageLookupByLibrary.simpleMessage(
      "Došlo je do greške prilikom pokušaja izvršavanja ove radnje. Molimo vas da provjerite još jednom.",
    ),
    "graphqlValidationError": MessageLookupByLibrary.simpleMessage(
      "Uneseni podaci su nevažeći. Molimo provjerite unos.",
    ),
    "greaterDistance": m26,
    ...
    "invalidAddressFormat": MessageLookupByLibrary.simpleMessage(
      "Molimo unesite potpunu adresu s nazivom ulice i brojem",
    ),
    ...
    "itemCondition": MessageLookupByLibrary.simpleMessage("Stanje artikla"),
    "itemConditionNew": MessageLookupByLibrary.simpleMessage("Novo"),
    ...
    "logoutFailed": MessageLookupByLibrary.simpleMessage("Odjava nije uspjela"),
    ...
    "myCoupons": MessageLookupByLibrary.simpleMessage("Moji kuponi"),
    ...
    "myQRCode": MessageLookupByLibrary.simpleMessage("Moj QR kod"),
    "myQRCodeNote": MessageLookupByLibrary.simpleMessage(
      "Dostavite ovaj kod osoblju",
    ),
    ...
    "networkError": MessageLookupByLibrary.simpleMessage(
      "Molimo vas da dvaput provjerite svoju mrežu",
    ),
    ...
    "networkTimeout": MessageLookupByLibrary.simpleMessage(
      "Vremensko ograničenje veze je isteklo. Pokušajte ponovo.",
    ),
    ...
    "noPendingDeliveryOrder": MessageLookupByLibrary.simpleMessage(
      "Nema narudžbi na čekanju za isporuku",
    ),
    ...
    "normal": MessageLookupByLibrary.simpleMessage("Normalno"),
    ...
    "ownerRoleDescription": MessageLookupByLibrary.simpleMessage(
      "Ova korisnička uloga omogućava dodavanje oglasa i rezervaciju usluga te njihovo upravljanje. Vlasnici ne mogu recenzirati druge oglase.",
    ),
    ...
    "pointHistory": MessageLookupByLibrary.simpleMessage("Historija bodova"),
    ...
    "pullUpLoad": MessageLookupByLibrary.simpleMessage(
      "Povucite prema gore da biste utovarili još",
    ),
    ...
    "rankDetails": MessageLookupByLibrary.simpleMessage("Detalji ranga"),
    "rankDetailsMsg": MessageLookupByLibrary.simpleMessage(
      "Trenutno ste član ovog ranga",
    ),
    ...
    "received": MessageLookupByLibrary.simpleMessage("Primljeno"),
    ...
    "redeem": MessageLookupByLibrary.simpleMessage("otkupiti"),
    "redeemPoints": MessageLookupByLibrary.simpleMessage("Iskoristite bodove"),
    "redeemRewards": MessageLookupByLibrary.simpleMessage(
      "Iskoristite nagrade",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Otkupljeno"),
    ...
    "refreshing": MessageLookupByLibrary.simpleMessage("Osvježavanje..."),
    ...
    "remainingAmountCod": MessageLookupByLibrary.simpleMessage(
      "Preostali iznos za plaćanje prilikom isporuke",
    ),
    ...
    "reservePrice": MessageLookupByLibrary.simpleMessage("Rezervna cijena"),
    ...
    "reverse": MessageLookupByLibrary.simpleMessage("Obrnuto"),
    ...
    "rewards": MessageLookupByLibrary.simpleMessage("Nagrade"),
    ...
    "shopifyCustomerAccountLoginDescription": MessageLookupByLibrary.simpleMessage(
      "Koristite svoj Shopify račun za prijavu i pristup narudžbama, adresama i još mnogo čemu.",
    ),
    "shopifyCustomerAccountLoginTitle": MessageLookupByLibrary.simpleMessage(
      "Prijava s Shopify korisničkim računom",
    ),
    ...
    "signup": MessageLookupByLibrary.simpleMessage("Registruj se"),
    "silver": MessageLookupByLibrary.simpleMessage("Srebro"),
    "silverPriority": MessageLookupByLibrary.simpleMessage("Srebrni prioritet"),
    ...
    "spendAtLeast": MessageLookupByLibrary.simpleMessage("Potrošite najmanje"),
    "startExploring": MessageLookupByLibrary.simpleMessage("Počni istraživati"),
    "startPrice": MessageLookupByLibrary.simpleMessage("Početna cijena"),
    "startShopping": MessageLookupByLibrary.simpleMessage("Započni kupovinu"),
    "startingBid": MessageLookupByLibrary.simpleMessage("Početna ponuda"),
    ...
    "systemError": MessageLookupByLibrary.simpleMessage(
      "Sistemska greška. Molimo kontaktirajte podršku.",
    ),
    ...
    "timeLeft": MessageLookupByLibrary.simpleMessage("Preostalo vrijeme"),
    ...
    "unknownError": MessageLookupByLibrary.simpleMessage(
      "Nešto je pošlo po zlu, pojavila se nepoznata greška",
    ),
    ...
    "upRankNote1": MessageLookupByLibrary.simpleMessage("Zaradite više"),
    "upRankNote2": MessageLookupByLibrary.simpleMessage(
      "bodova za napredovanje na ovom rangu.",
    ),
    ...
    "used": MessageLookupByLibrary.simpleMessage("Korišteno"),
    ...
    "winningBid": MessageLookupByLibrary.simpleMessage("Pobjednička ponuda"),
    ...
    "youAreOur": MessageLookupByLibrary.simpleMessage("Ti si naš/naša"),
    "youAreSelecting": m70,

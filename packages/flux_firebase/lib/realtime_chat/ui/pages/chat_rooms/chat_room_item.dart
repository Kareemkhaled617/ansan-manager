...
class _ChatRoomItemState extends State<ChatRoomItem> {
  ...
  String get sender => context.read<ChatViewModel>().sender;

  List<ChatUser> get otherUsers => chatRoom.getOtherUsers(sender);

  ChatUser? get receiverUser => chatRoom.getReceiverUser(sender);

  ChatUser? get senderUser => chatRoom.getSenderUser(sender);
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelectedRoom || isHovered
                ? Theme.of(context).primaryColor.withValueOpacity(0.1)

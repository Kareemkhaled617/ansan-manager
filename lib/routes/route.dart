...
import 'package:inspireui/inspireui.dart' show AutoHideKeyboard, ErrorPage;
...
class Routes {
  ...
  static final Map<String, WidgetBuilder> _routes = {
    ...
    RouteList.multiSiteSelection: (context) =>
        MultiSiteFactory.instance.multiSiteSelectionScreen(context),
  ...
  static Route getRouteGenerate(RouteSettings settings) {
    ...
    switch (routingData.route) {
      case RouteList.notificationRequest:
        ...
        void Function(BuildContext)? onFinish;
        if (arguments is Map && arguments['onFinish'] != null) {
          onFinish = arguments['onFinish'];
        }

        return _buildRoute(
          settings,
          (ct) => NotificationRequestScreen(onFinish: onFinish),
        );

      case RouteList.privacyTerms:
        final arguments = settings.arguments;
        void Function(BuildContext)? onFinish;
        if (arguments is Map && arguments['onFinish'] != null) {
          onFinish = arguments['onFinish'];
        ...
        return _buildRoute(
          settings,
          (ct) => PrivacyTermScreen(onFinish: onFinish),
        );
        ...
        if (arguments is BackDropArguments) {
          ...
          return _buildRoute(routeSetting, (context) {
            ...
            final allowFilterMultipleCategory =
                arguments.allowFilterMultipleCategory;
            final categoryMenuStyle = arguments.categoryMenuStyle;
            ...
            try {
              ...
              AnimatedItemListConfig? animatedConfig;
              final animationConfig = config?['productListAnimationConfig'];
              if (animationConfig != null && animationConfig is Map) {
                animatedConfig =
                    AnimatedItemListConfig.tryParse(animationConfig);
              }
              ...
              var productConfig = configValue
                ..category = categoryId
                ..brandIds = brandIds
                ..animationConfig = animatedConfig
                ..tag = tagId
                ..name =
      ...
      case RouteList.delivery:
        ...
        if (data is User) {
          return _buildRoute(settings,
              (context) => Services().widget.renderDelivery(context, data));
        }
        return _errorRoute();
      ...
      case RouteList.products:
        ...
        return _buildRoute(
          ...
          (context) => ProductsScreen(
            ...
            categoryMenuStyle: argument?['categoryMenuStyle'],
            allowFilterMultipleCategory:
                bool.tryParse('${argument?['allowFilterMultipleCategory']}'),
          ),
        );
      ...
      case RouteList.videos:
        ...
        if (data is TabBarMenuConfig) {
          styleVersions = data.jsonData['styleVersions'] is List
              ? (data.jsonData['styleVersions'] as List)
                  .map((e) => e.toString())
                  .toList()
              : styleVersions;
        }
          ...
          return _buildRoute(
            ...
            (context) {
              return MultiProvider(
                providers: [
                  ChangeNotifierProvider<ListApprovedRatingModel>(
                    create: (context) =>
                        ListApprovedRatingModel(user: arguments),
                  ),
                  ChangeNotifierProvider<ListHoldRatingModel>(
                    create: (context) => ListHoldRatingModel(user: arguments),
                  ),
                ],

...
class CartItemStyle01Widget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final infosWidget = [
      ...
      if (stateUI.cartItemMetaData?.selectedYithOptions?.isNotEmpty ?? false)
        Services().widget.renderYithAddonsOptionsCartItem(
            context, stateUI.cartItemMetaData?.selectedYithOptions),
      ...
      if (stateUI.isOnBackorder && kAdvanceConfig.showStockStatus)
        Text(

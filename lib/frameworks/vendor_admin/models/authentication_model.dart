...
class VendorAdminAuthenticationModel extends ChangeNotifier {
  ...
  Future<void> login(
    ...
    unawaited(Services().firebase.loginFirebaseEmail(
  ...
  Future<void> facebookLogin(
    ...
    switch (result.status) {
      case LoginStatus.success:
        user = await _services.loginFacebook(
        ...
        unawaited(Services().firebase.loginFirebaseFacebook(
        ...
        case AuthorizationStatus.authorized:
          {
            ...
            unawaited(Services().firebase.loginFirebaseApple(

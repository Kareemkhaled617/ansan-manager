...
import '../../../widgets/common/slide_out_on_keyboard.dart';
    ...
    return Selector<CartModel, String?>(
      ...
      builder: (context, _, child) {
        return MediaQuery.removePadding(
          context: context,
          removeTop: widget.hasNewAppBar && isModal != true,
          child: Scaffold(
                ...
                builder: (context, selector, child) {
                  ...
                  return Column(
                    children: [
                      ...
                      SlideOutOnKeyboard(
                        child: renderTotalPrice(cartModel),
                      ),
                    ],
                  );
                }),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Row(
        children: [
          Text(
            PriceTools.getCurrencyFormatted(modelCart.getTotal()!, currencyRate,

...
//      print(e.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<CartModel,
        (Coupon?, Map<String, int?>, double, int, double?)>(
      selector: (p0, p1) => (
        p1.couponObj,
        p1.productsInCart,
        p1.rewardTotal,
      ...
      builder: (context,
          (Coupon?, Map<String, int?>, double, int, double?) selectorItem,
          child) {
        ...
        return Column(
          ...
          children: <Widget>[
            ...
            if (kLoyaltyConfig.enabled)
              Services().renderLoyaltyCouponSelection(),
            if (widget.showPrice)
              Padding(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Text(
                              PriceTools.getCurrencyFormatted(
                                  cartModel.getSubTotal() ?? 0, currencyRate,
                        ...
                        // Shipping cost
                        if (cartModel.getShippingCost() != null &&
                        ...
                        if (cartModel.taxesTotal > 0) ...[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                PriceTools.getCurrencyFormatted(
                                    cartModel.taxesTotal, currencyRate,
                                    currency: cartModel.isWalletCart()
                                        ? defaultCurrency?.currencyCode
                                        : currency)!,
                                style: smallAmountStyle,
                        ...
                        if (rewardTotal > 0) ...[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                '- ${PriceTools.getCurrencyFormatted(rewardTotal, currencyRate, currency: cartModel.isWalletCart() ? defaultCurrency?.currencyCode : currency)!}',
                            ...
                            children: [
                              ...
                              Text(
                                couponObj.discountType == 'percent'
                                    ? '-${couponObj.amount}%'
                                    : '- ${PriceTools.getCurrencyFormatted(couponObj.amount, currencyRate, currency: cartModel.isWalletCart() ? defaultCurrency?.currencyCode : currency)!}',
                                style: smallAmountStyle.copyWith(
                                  color: Colors.red,
                                ),
                              ),

...
class AdditionalInformation extends StatelessWidget {
  ...
  Widget renderItem({
    ...
    var options = [];
    final attributeOptions = attribute.options;
    if (attributeOptions is List<Map>) {
      options = attributeOptions.map((e) => e['name']).toList();
    } else {
            ...
            Expanded(
              ...
              child: attribute.name != 'color'
                  ? Align(
                      ...
                      child: Text(options.join(', ').unescape() ?? '',

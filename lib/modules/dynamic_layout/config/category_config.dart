...
class CategoryConfig {
  ...
  AnimatedItemListConfig? productListAnimationConfig;
  List<CategoryItemConfig> items = [];
  bool allowFilterMultipleCategory = false;
  ProductCategoryMenuStyle productCategoryMenuStyle =
      ProductCategoryMenuStyle.menu;
  ...
  CategoryConfig({
    ...
    this.productListAnimationConfig,
    this.allowFilterMultipleCategory = false,
    this.productCategoryMenuStyle = ProductCategoryMenuStyle.menu,
  });
  ...
  CategoryConfig.fromJson(dynamic json) {
    ...
    allowFilterMultipleCategory =
        bool.tryParse(json['allowFilterMultipleCategory'].toString()) ?? false;
    productCategoryMenuStyle =
        ProductCategoryMenuStyle.fromString(json['productCategoryMenuStyle']);
    if (json['items'] != null) {
      items = [];
    ...
    if (json['productListAnimationConfig'] != null) {
      productListAnimationConfig =
          AnimatedItemListConfig.tryParse(json['productListAnimationConfig']);
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    map['animationConfig'] = productListAnimationConfig?.toJson();
    map['allowFilterMultipleCategory'] = allowFilterMultipleCategory;
    map['productCategoryMenuStyle'] = productCategoryMenuStyle.name;
    return map;
  }
}

...
enum CardDesign {
  ...
  bool get isSimpleForWeb => this == CardDesign.simpleForWeb;
...
class ProductConfig {
  ...
  AnimatedItemListConfig? animationConfig;
  CardDesign cardDesign = kCardDesign;
  int? titleLine;
  ...
  /// show category in product card
  bool showProductCardCategory = false;

  /// show listing type in listing card
  ...
  //For Banner
  SliderListConfig? bannerSliderConfig;
  ...
  ProductConfig.empty() {
    ...
    cartButtonQuantitySize = kProductCard.cartButtonQuantitySize;
    cartIconRadius = kProductCard.cartIconRadius;
    ...
    showProductCardCategory = kProductCard.showProductCardCategory;
    showListingType = kProductCard.showListingType;
    openInWebview = kProductCard.openInWebview;
  }
  ...
  ProductConfig.fromJson(dynamic json) {
    ...
    showListingType = json['showListingType'] ?? false;
    ...
    if (json['animationConfig'] != null) {
      animationConfig =
          AnimatedItemListConfig.tryParse(json['animationConfig']);
    }

    if (json['border'] != null) {
      if (json['border']['all'] != null) {
        final borderSideAll =
            const BorderSideConverter().fromJson(json['border']['all']);

        border = Border.all(
          color: borderSideAll.color,
          width: borderSideAll.width,
          strokeAlign: borderSideAll.strokeAlign,
          style: borderSideAll.style,
        );
      } else {
        border = BorderDirectional(
          top: const BorderSideConverter().fromJson(json['border']['top']),
          start: const BorderSideConverter().fromJson(json['border']['start']),
          end: const BorderSideConverter().fromJson(json['border']['end']),
          bottom:
              const BorderSideConverter().fromJson(json['border']['bottom']),
        );
      }
    }
    ...
    advancedParams =
        json['advancedParams'] is Map ? json['advancedParams'] : {};
    ...
    if (json['slider'] is Map) {
      bannerSliderConfig = SliderListConfig.fromJson(json['slider']);
    }
    openInWebview = json['openInWebview'] ?? env.openInWebview;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    map['slider'] = bannerSliderConfig?.toJson();
    map['openInWebview'] = openInWebview;
  ...
  ProductConfig copyWith({
    ...
    bool? useSort,
    bool? showCategory,
    bool? showProductCardCategory,
    bool? showListingType,
    SliderListConfig? bannerSliderConfig,
    bool? showSeeAll,
    AnimatedItemListConfig? animationConfig,
    BoxBorder? border,
    ...
    return ProductConfig(
      ...
      showProductCardCategory:
          showProductCardCategory ?? this.showProductCardCategory,
      showListingType: showListingType ?? this.showListingType,
      ...
      cartButtonQuantitySize:
          cartButtonQuantitySize ?? this.cartButtonQuantitySize,
      ...
      bannerSliderConfig: bannerSliderConfig ?? this.bannerSliderConfig,

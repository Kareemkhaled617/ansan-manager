...
class Blog {
  ...
  factory Blog.fromJson(Map<String, dynamic>? json) {
    ...
    if ((ServerConfig().blog?.isNotEmpty ?? false) &&
        (ServerConfig().blog != ServerConfig().url)) {
      return Blog.fromWordpressJson(json);
    }
  ...
  factory Blog.fromWordpressJson(Map json) {
    String? imageFeature;
    ...
    final id = json['id'];
    final title = json['title']?['rendered']?.toString().unescape();
    final subTitle = json['excerpt']?['rendered']?.toString().unescape();
    ...
    final excerpt = json['excerpt']?['rendered']?.toString().unescape();
  ...
  factory Blog.fromNotionJson(Map json) {
    ...
    try {
      var id = json['id'];
      var title =
          NotionDataTools.fromTitle(json['properties']?['Name']).unescape();
  ...
  factory Blog.fromBigCommerceJson(Map json) {
    try {
      var id = json['id'];
      var title = json['title']?.toString().unescape() ?? '';
      var subTitle = json['subTitle'] ?? '';
